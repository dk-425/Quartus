	agilex_hps u0 (
		...
		.f2h_WDATA            (_connected_to_f2h_WDATA_),            //   input,   width = 128,                 .wdata
		.f2h_WSTRB            (_connected_to_f2h_WSTRB_),            //   input,    width = 16,                 .wstrb
		...
		.f2h_RDATA            (_connected_to_f2h_RDATA_),            //  output,   width = 128,                 .rdata

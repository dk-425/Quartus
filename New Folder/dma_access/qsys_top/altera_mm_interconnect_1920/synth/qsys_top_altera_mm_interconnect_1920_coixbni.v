// qsys_top_altera_mm_interconnect_1920_coixbni.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_coixbni (
	...
	wire  [130:0] rsp_mux_src_data;                                        // rsp_mux:src_data -> agilex_hps_h2f_axi_master_agent:write_rp_data
	...
	wire  [130:0] rsp_mux_001_src_data;                                    // rsp_mux_001:src_data -> agilex_hps_h2f_axi_master_agent:read_rp_data
	...
	wire  [131:0] onchip_memory2_0_s1_agent_rf_source_data;                // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [131:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;             // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire  [130:0] onchip_memory2_0_s1_agent_rp_data;                       // onchip_memory2_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [130:0] cmd_mux_src_data;                                        // cmd_mux:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [130:0] onchip_memory2_0_s1_burst_adapter_source0_data;          // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                                          //  output,  width = 131,                .data
		...
		.cp_data                 (onchip_memory2_0_s1_burst_adapter_source0_data),                             //   input,  width = 131,                .data
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),                                //   input,  width = 132,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),                                   //  output,  width = 132,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),             //   input,  width = 132,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),          //  output,  width = 132,       out.data
	...
	qsys_top_altera_merlin_router_1921_e4p6dtq router (
	...
	qsys_top_altera_merlin_router_1921_e4p6dtq router_001 (
	...
	qsys_top_altera_merlin_router_1921_gojpxbi router_002 (
		...
		.sink_data          (onchip_memory2_0_s1_agent_rp_data),                                          //   input,  width = 131,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1923_au4lvyi #(
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),                             //  output,  width = 131,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_g3jn33y rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_g3jn33y rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset

// qsys_top_altera_mm_interconnect_1920_iptzvwa.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_iptzvwa (
	...
	wire  [153:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> axi_conduit_merger_0_altera_axi_master_1_agent:write_rp_data
	...
	wire  [153:0] rsp_mux_001_src_data;                                                  // rsp_mux_001:src_data -> axi_conduit_merger_0_altera_axi_master_1_agent:read_rp_data
	...
	wire  [153:0] axi_conduit_merger_0_altera_axi_master_1_agent_write_cp_data;          // axi_conduit_merger_0_altera_axi_master_1_agent:write_cp_data -> router:sink_data
	...
	wire  [153:0] axi_conduit_merger_0_altera_axi_master_1_agent_read_cp_data;           // axi_conduit_merger_0_altera_axi_master_1_agent:read_cp_data -> router_001:sink_data
	...
	wire  [261:0] agilex_hps_f2h_axi_slave_agent_write_rp_data;                          // agilex_hps_f2h_axi_slave_agent:write_rp_data -> router_002:sink_data
	...
	wire  [261:0] agilex_hps_f2h_axi_slave_agent_read_rp_data;                           // agilex_hps_f2h_axi_slave_agent:read_rp_data -> router_003:sink_data
	...
	wire  [153:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:in_data
	...
	wire  [261:0] agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data;                // agilex_hps_f2h_axi_slave_wr_cmd_width_adapter:out_data -> agilex_hps_f2h_axi_slave_agent:write_cp_data
	...
	wire  [153:0] cmd_mux_001_src_data;                                                  // cmd_mux_001:src_data -> agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:in_data
	...
	wire  [261:0] agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data;                // agilex_hps_f2h_axi_slave_rd_cmd_width_adapter:out_data -> agilex_hps_f2h_axi_slave_agent:read_cp_data
	...
	wire  [261:0] router_002_src_data;                                                   // router_002:src_data -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_data
	...
	wire  [153:0] agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_data;                // agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [261:0] router_003_src_data;                                                   // router_003:src_data -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_data
	...
	wire  [153:0] agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_data;                // agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	qsys_top_altera_merlin_axi_translator_1921_rzjdxdi #(
		.USE_S0_AWID                       (1),
		.USE_S0_AWREGION                   (0),
		.USE_M0_AWREGION                   (1),
		.USE_S0_AWLEN                      (1),
	...
	qsys_top_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_cp_data          (axi_conduit_merger_0_altera_axi_master_1_agent_write_cp_data),               //  output,  width = 154,                 .data
		...
		.read_cp_data           (axi_conduit_merger_0_altera_axi_master_1_agent_read_cp_data),                //  output,  width = 154,                 .data
	...
	qsys_top_altera_merlin_axi_slave_ni_1941_5n2xbba #(
		...
		.read_cp_data           (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data),                     //   input,  width = 262,                  .data
		...
		.write_cp_data          (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data),                     //   input,  width = 262,                  .data
	...
	qsys_top_altera_merlin_router_1921_3ulduai router (
		...
		.sink_data          (axi_conduit_merger_0_altera_axi_master_1_agent_write_cp_data),              //   input,  width = 154,          .data
	...
	qsys_top_altera_merlin_router_1921_jq3g7ni router_001 (
		...
		.sink_data          (axi_conduit_merger_0_altera_axi_master_1_agent_read_cp_data),               //   input,  width = 154,          .data
	...
	qsys_top_altera_merlin_router_1921_gksrcgq router_002 (
	...
	qsys_top_altera_merlin_router_1921_kdwuqsq router_003 (
	...
	qsys_top_altera_merlin_demultiplexer_1921_cbjo7sq cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                       //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_f2h_axi_slave_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_cbjo7sq cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                       //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_f2h_axi_slave_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_57ub5cy cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                                       //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_f2h_axi_slave_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_57ub5cy cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                       //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_f2h_axi_slave_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_cbjo7sq rsp_demux (
		.clk                (clk_100_out_clk_clk),                                                       //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_f2h_axi_slave_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_data),                    //   input,  width = 154,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_cbjo7sq rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                       //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_f2h_axi_slave_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_data),                    //   input,  width = 154,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_b44jf7q rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                       //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_f2h_axi_slave_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_b44jf7q rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                       //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_f2h_axi_slave_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_width_adapter_1920_td55exi #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (cmd_mux_src_data),                                                          //   input,  width = 154,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_endofpacket),             //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_wr_cmd_width_adapter_src_data),                    //  output,  width = 262,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_td55exi #(
		...
		.in_data              (cmd_mux_001_src_data),                                                      //   input,  width = 154,          .data
		.out_endofpacket      (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_endofpacket),             //  output,    width = 1,       src.endofpacket
		.out_data             (agilex_hps_f2h_axi_slave_rd_cmd_width_adapter_src_data),                    //  output,  width = 262,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_juef5uq #(
		.IN_PKT_ADDR_H                 (175),
		.IN_PKT_ADDR_L                 (144),
		.IN_PKT_DATA_H                 (127),
		.IN_PKT_DATA_L                 (0),
		...
		.out_data             (agilex_hps_f2h_axi_slave_wr_rsp_width_adapter_src_data),                    //  output,  width = 154,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_juef5uq #(
		...
		.out_data             (agilex_hps_f2h_axi_slave_rd_rsp_width_adapter_src_data),                    //  output,  width = 154,          .data

...
//    output_name             qsys_top_altera_merlin_router_1921_t5znvwq
//    pkt_addr_h              67
//    pkt_addr_l              36
//    pkt_dest_id_h           109
//    pkt_dest_id_l           108
...
//    pkt_trans_read          71
//    pkt_trans_write         70
//    slaves_info             2:100:0x3000:0x4000:both:1:0:0:1,0:001:0x4000:0x4020:both:1:0:0:1,1:010:0x5000:0x5010:write:1:0:0:1
//    st_channel_w            3
//    st_data_w               135
// ------------------------------------------

module qsys_top_altera_merlin_router_1921_t5znvwq_default_decode
  #(
...
module qsys_top_altera_merlin_router_1921_t5znvwq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    qsys_top_altera_merlin_router_1921_t5znvwq_default_decode the_default_decode(
    ...
    always @* begin
        ...
        // slave 0: [0x3000, 0x4000) : sel [14:12]
        if ( {address[14:12],{12 {1'b0}}} == 15'h3000   ) begin
            src_channel = 3'b100;

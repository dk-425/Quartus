...
module qsys_top_msgdma_0 (
	...
	qsys_top_msgdma_0_altera_msgdma_1922_sddidjq msgdma_0 (
		...
		.mm_read_byteenable           (mm_read_byteenable),           //  output,   width = 16,                 .byteenable
		...
		.st_source_data               (st_source_data),               //  output,  width = 128,        st_source.data
		...
		.st_source_empty              (st_source_empty)               //  output,    width = 4,                 .empty
	);

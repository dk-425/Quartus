	qsys_top_msgdma_0 u0 (
		...
		.mm_read_byteenable           (_connected_to_mm_read_byteenable_),           //  output,   width = 16,                 .byteenable
		...
		.st_source_data               (_connected_to_st_source_data_),               //  output,  width = 128,        st_source.data
		...
		.st_source_empty              (_connected_to_st_source_empty_)               //  output,    width = 4,                 .empty
	);

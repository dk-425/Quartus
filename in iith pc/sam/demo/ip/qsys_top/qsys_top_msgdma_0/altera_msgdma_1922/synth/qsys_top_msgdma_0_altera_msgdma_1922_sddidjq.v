// qsys_top_msgdma_0_altera_msgdma_1922_sddidjq.v
...
`timescale 1 ps / 1 ps
module qsys_top_msgdma_0_altera_msgdma_1922_sddidjq (
	...
	dispatcher #(
		...
		.DATA_FIFO_DEPTH_DERIVED       (3),
		.MAX_BYTE_DERIVED              (0),
		.TRANSFER_TYPE_DERIVED         (1),
		.BURST_ENABLE                  (0),
		.MAX_BURST_COUNT_DERIVED       (4),
		...
		.PACKET_ENABLE                 (1),
		.DESCRIPTOR_FIFO_DEPTH_DERIVED (0)
	) dispatcher_internal (
	...
	read_master #(
		...
		.master_byteenable    (mm_read_byteenable),                            //  output,   width = 16,                 .byteenable
		.master_readdata      (mm_read_readdata),                              //   input,  width = 128,                 .readdata
		...
		.src_data             (st_source_data),                                //  output,  width = 128,      Data_Source.data
		...
		.src_empty            (st_source_empty),                               //  output,    width = 4,                 .empty

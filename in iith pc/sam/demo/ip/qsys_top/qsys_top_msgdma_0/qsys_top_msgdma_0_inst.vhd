	component qsys_top_msgdma_0 is
		port (
			...
			mm_read_byteenable           : out std_logic_vector(15 downto 0);                     -- byteenable
			mm_read_readdata             : in  std_logic_vector(127 downto 0) := (others => 'X'); -- readdata
			mm_read_waitrequest          : in  std_logic                      := 'X';             -- waitrequest
			mm_read_readdatavalid        : in  std_logic                      := 'X';             -- readdatavalid
			st_source_data               : out std_logic_vector(127 downto 0);                    -- data
			...
			st_source_empty              : out std_logic_vector(3 downto 0)                       -- empty
		);
	end component qsys_top_msgdma_0;

	u0 : component qsys_top_msgdma_0
		port map (

// qsys_top_altera_mm_interconnect_1920_la4q6qq.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_la4q6qq (
		input  wire [31:0]  msgdma_0_mm_read_address,                     //                       msgdma_0_mm_read.address
		output wire         msgdma_0_mm_read_waitrequest,                 //                                       .waitrequest
		input  wire [15:0]  msgdma_0_mm_read_byteenable,                  //                                       .byteenable
		input  wire         msgdma_0_mm_read_read,                        //                                       .read
		output wire [127:0] msgdma_0_mm_read_readdata,                    //                                       .readdata
	...
	wire  [127:0] msgdma_0_mm_read_translator_avalon_universal_master_0_readdata;      // msgdma_0_mm_read_agent:av_readdata -> msgdma_0_mm_read_translator:uav_readdata
	...
	wire   [15:0] msgdma_0_mm_read_translator_avalon_universal_master_0_byteenable;    // msgdma_0_mm_read_translator:uav_byteenable -> msgdma_0_mm_read_agent:av_byteenable
	...
	wire  [127:0] msgdma_0_mm_read_translator_avalon_universal_master_0_writedata;     // msgdma_0_mm_read_translator:uav_writedata -> msgdma_0_mm_read_agent:av_writedata
	wire    [4:0] msgdma_0_mm_read_translator_avalon_universal_master_0_burstcount;    // msgdma_0_mm_read_translator:uav_burstcount -> msgdma_0_mm_read_agent:av_burstcount
	...
	wire  [261:0] msgdma_0_mm_read_agent_cp_data;                                      // msgdma_0_mm_read_agent:cp_data -> router:sink_data
	...
	wire  [261:0] router_src_data;                                                     // router:src_data -> msgdma_0_mm_read_limiter:cmd_sink_data
	...
	wire  [261:0] msgdma_0_mm_read_limiter_cmd_src_data;                               // msgdma_0_mm_read_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [261:0] rsp_mux_src_data;                                                    // rsp_mux:src_data -> msgdma_0_mm_read_limiter:rsp_sink_data
	...
	wire  [261:0] msgdma_0_mm_read_limiter_rsp_src_data;                               // msgdma_0_mm_read_limiter:rsp_src_data -> msgdma_0_mm_read_agent:rp_data
	...
	qsys_top_altera_merlin_master_translator_191_g7h47bq #(
		...
		.uav_burstcount         (msgdma_0_mm_read_translator_avalon_universal_master_0_burstcount),                                                                      //  output,    width = 5,                          .burstcount
		...
		.uav_byteenable         (msgdma_0_mm_read_translator_avalon_universal_master_0_byteenable),                                                                      //  output,   width = 16,                          .byteenable
		.uav_readdata           (msgdma_0_mm_read_translator_avalon_universal_master_0_readdata),                                                                        //   input,  width = 128,                          .readdata
		.uav_writedata          (msgdma_0_mm_read_translator_avalon_universal_master_0_writedata),                                                                       //  output,  width = 128,                          .writedata
		...
		.av_byteenable          (msgdma_0_mm_read_byteenable),                                                                                                           //   input,   width = 16,                          .byteenable
		.av_read                (msgdma_0_mm_read_read),                                                                                                                 //   input,    width = 1,                          .read
		.av_readdata            (msgdma_0_mm_read_readdata),                                                                                                             //  output,  width = 128,                          .readdata
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.av_writedata          (msgdma_0_mm_read_translator_avalon_universal_master_0_writedata),     //   input,  width = 128,          .writedata
		.av_readdata           (msgdma_0_mm_read_translator_avalon_universal_master_0_readdata),      //  output,  width = 128,          .readdata
		...
		.av_byteenable         (msgdma_0_mm_read_translator_avalon_universal_master_0_byteenable),    //   input,   width = 16,          .byteenable
		.av_burstcount         (msgdma_0_mm_read_translator_avalon_universal_master_0_burstcount),    //   input,    width = 5,          .burstcount
		...
		.cp_data               (msgdma_0_mm_read_agent_cp_data),                                      //  output,  width = 262,          .data
		...
		.rp_data               (msgdma_0_mm_read_limiter_rsp_src_data),                               //   input,  width = 262,          .data
	...
	qsys_top_altera_merlin_router_1921_nf2zqzy router (
		...
		.sink_data          (msgdma_0_mm_read_agent_cp_data),               //   input,  width = 262,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_data           (msgdma_0_mm_read_limiter_cmd_src_data),          //  output,  width = 262,          .data
		...
		.rsp_src_data           (msgdma_0_mm_read_limiter_rsp_src_data),          //  output,  width = 262,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_yzrtgpi cmd_demux (
		...
		.sink_data          (msgdma_0_mm_read_limiter_cmd_src_data),          //   input,  width = 262,           .data

// qsys_top_altera_mm_interconnect_1920_2qh6ouq.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_2qh6ouq (
		...
		output wire [2:0]   msgdma_mm2s_csr_address,                              //                                msgdma_mm2s_csr.address
		output wire         msgdma_mm2s_csr_write,                                //                                               .write
		output wire         msgdma_mm2s_csr_read,                                 //                                               .read
		input  wire [31:0]  msgdma_mm2s_csr_readdata,                             //                                               .readdata
		output wire [31:0]  msgdma_mm2s_csr_writedata,                            //                                               .writedata
		output wire [3:0]   msgdma_mm2s_csr_byteenable,                           //                                               .byteenable
		output wire         msgdma_mm2s_descriptor_slave_write,                   //                   msgdma_mm2s_descriptor_slave.write
		output wire [127:0] msgdma_mm2s_descriptor_slave_writedata,               //                                               .writedata
		output wire [15:0]  msgdma_mm2s_descriptor_slave_byteenable,              //                                               .byteenable
		input  wire         msgdma_mm2s_descriptor_slave_waitrequest,             //                                               .waitrequest
	...
	wire   [31:0] msgdma_mm2s_csr_agent_m0_readdata;                                // msgdma_mm2s_csr_translator:uav_readdata -> msgdma_mm2s_csr_agent:m0_readdata
	wire          msgdma_mm2s_csr_agent_m0_waitrequest;                             // msgdma_mm2s_csr_translator:uav_waitrequest -> msgdma_mm2s_csr_agent:m0_waitrequest
	wire          msgdma_mm2s_csr_agent_m0_debugaccess;                             // msgdma_mm2s_csr_agent:m0_debugaccess -> msgdma_mm2s_csr_translator:uav_debugaccess
	wire   [31:0] msgdma_mm2s_csr_agent_m0_address;                                 // msgdma_mm2s_csr_agent:m0_address -> msgdma_mm2s_csr_translator:uav_address
	wire    [3:0] msgdma_mm2s_csr_agent_m0_byteenable;                              // msgdma_mm2s_csr_agent:m0_byteenable -> msgdma_mm2s_csr_translator:uav_byteenable
	wire          msgdma_mm2s_csr_agent_m0_read;                                    // msgdma_mm2s_csr_agent:m0_read -> msgdma_mm2s_csr_translator:uav_read
	wire          msgdma_mm2s_csr_agent_m0_readdatavalid;                           // msgdma_mm2s_csr_translator:uav_readdatavalid -> msgdma_mm2s_csr_agent:m0_readdatavalid
	wire          msgdma_mm2s_csr_agent_m0_lock;                                    // msgdma_mm2s_csr_agent:m0_lock -> msgdma_mm2s_csr_translator:uav_lock
	wire   [31:0] msgdma_mm2s_csr_agent_m0_writedata;                               // msgdma_mm2s_csr_agent:m0_writedata -> msgdma_mm2s_csr_translator:uav_writedata
	wire          msgdma_mm2s_csr_agent_m0_write;                                   // msgdma_mm2s_csr_agent:m0_write -> msgdma_mm2s_csr_translator:uav_write
	wire    [2:0] msgdma_mm2s_csr_agent_m0_burstcount;                              // msgdma_mm2s_csr_agent:m0_burstcount -> msgdma_mm2s_csr_translator:uav_burstcount
	wire          msgdma_mm2s_csr_agent_rf_source_valid;                            // msgdma_mm2s_csr_agent:rf_source_valid -> msgdma_mm2s_csr_agent_rsp_fifo:in_valid
	wire  [135:0] msgdma_mm2s_csr_agent_rf_source_data;                             // msgdma_mm2s_csr_agent:rf_source_data -> msgdma_mm2s_csr_agent_rsp_fifo:in_data
	wire          msgdma_mm2s_csr_agent_rf_source_ready;                            // msgdma_mm2s_csr_agent_rsp_fifo:in_ready -> msgdma_mm2s_csr_agent:rf_source_ready
	wire          msgdma_mm2s_csr_agent_rf_source_startofpacket;                    // msgdma_mm2s_csr_agent:rf_source_startofpacket -> msgdma_mm2s_csr_agent_rsp_fifo:in_startofpacket
	wire          msgdma_mm2s_csr_agent_rf_source_endofpacket;                      // msgdma_mm2s_csr_agent:rf_source_endofpacket -> msgdma_mm2s_csr_agent_rsp_fifo:in_endofpacket
	wire          msgdma_mm2s_csr_agent_rsp_fifo_out_valid;                         // msgdma_mm2s_csr_agent_rsp_fifo:out_valid -> msgdma_mm2s_csr_agent:rf_sink_valid
	wire  [135:0] msgdma_mm2s_csr_agent_rsp_fifo_out_data;                          // msgdma_mm2s_csr_agent_rsp_fifo:out_data -> msgdma_mm2s_csr_agent:rf_sink_data
	wire          msgdma_mm2s_csr_agent_rsp_fifo_out_ready;                         // msgdma_mm2s_csr_agent:rf_sink_ready -> msgdma_mm2s_csr_agent_rsp_fifo:out_ready
	wire          msgdma_mm2s_csr_agent_rsp_fifo_out_startofpacket;                 // msgdma_mm2s_csr_agent_rsp_fifo:out_startofpacket -> msgdma_mm2s_csr_agent:rf_sink_startofpacket
	wire          msgdma_mm2s_csr_agent_rsp_fifo_out_endofpacket;                   // msgdma_mm2s_csr_agent_rsp_fifo:out_endofpacket -> msgdma_mm2s_csr_agent:rf_sink_endofpacket
	wire          msgdma_mm2s_csr_agent_rdata_fifo_src_valid;                       // msgdma_mm2s_csr_agent:rdata_fifo_src_valid -> msgdma_mm2s_csr_agent_rdata_fifo:in_valid
	wire   [33:0] msgdma_mm2s_csr_agent_rdata_fifo_src_data;                        // msgdma_mm2s_csr_agent:rdata_fifo_src_data -> msgdma_mm2s_csr_agent_rdata_fifo:in_data
	wire          msgdma_mm2s_csr_agent_rdata_fifo_src_ready;                       // msgdma_mm2s_csr_agent_rdata_fifo:in_ready -> msgdma_mm2s_csr_agent:rdata_fifo_src_ready
	wire          msgdma_mm2s_csr_agent_rdata_fifo_out_valid;                       // msgdma_mm2s_csr_agent_rdata_fifo:out_valid -> msgdma_mm2s_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] msgdma_mm2s_csr_agent_rdata_fifo_out_data;                        // msgdma_mm2s_csr_agent_rdata_fifo:out_data -> msgdma_mm2s_csr_agent:rdata_fifo_sink_data
	wire          msgdma_mm2s_csr_agent_rdata_fifo_out_ready;                       // msgdma_mm2s_csr_agent:rdata_fifo_sink_ready -> msgdma_mm2s_csr_agent_rdata_fifo:out_ready
	wire  [127:0] msgdma_mm2s_descriptor_slave_agent_m0_readdata;                   // msgdma_mm2s_descriptor_slave_translator:uav_readdata -> msgdma_mm2s_descriptor_slave_agent:m0_readdata
	wire          msgdma_mm2s_descriptor_slave_agent_m0_waitrequest;                // msgdma_mm2s_descriptor_slave_translator:uav_waitrequest -> msgdma_mm2s_descriptor_slave_agent:m0_waitrequest
	wire          msgdma_mm2s_descriptor_slave_agent_m0_debugaccess;                // msgdma_mm2s_descriptor_slave_agent:m0_debugaccess -> msgdma_mm2s_descriptor_slave_translator:uav_debugaccess
	wire   [31:0] msgdma_mm2s_descriptor_slave_agent_m0_address;                    // msgdma_mm2s_descriptor_slave_agent:m0_address -> msgdma_mm2s_descriptor_slave_translator:uav_address
	wire   [15:0] msgdma_mm2s_descriptor_slave_agent_m0_byteenable;                 // msgdma_mm2s_descriptor_slave_agent:m0_byteenable -> msgdma_mm2s_descriptor_slave_translator:uav_byteenable
	wire          msgdma_mm2s_descriptor_slave_agent_m0_read;                       // msgdma_mm2s_descriptor_slave_agent:m0_read -> msgdma_mm2s_descriptor_slave_translator:uav_read
	wire          msgdma_mm2s_descriptor_slave_agent_m0_readdatavalid;              // msgdma_mm2s_descriptor_slave_translator:uav_readdatavalid -> msgdma_mm2s_descriptor_slave_agent:m0_readdatavalid
	wire          msgdma_mm2s_descriptor_slave_agent_m0_lock;                       // msgdma_mm2s_descriptor_slave_agent:m0_lock -> msgdma_mm2s_descriptor_slave_translator:uav_lock
	wire  [127:0] msgdma_mm2s_descriptor_slave_agent_m0_writedata;                  // msgdma_mm2s_descriptor_slave_agent:m0_writedata -> msgdma_mm2s_descriptor_slave_translator:uav_writedata
	wire          msgdma_mm2s_descriptor_slave_agent_m0_write;                      // msgdma_mm2s_descriptor_slave_agent:m0_write -> msgdma_mm2s_descriptor_slave_translator:uav_write
	wire    [4:0] msgdma_mm2s_descriptor_slave_agent_m0_burstcount;                 // msgdma_mm2s_descriptor_slave_agent:m0_burstcount -> msgdma_mm2s_descriptor_slave_translator:uav_burstcount
	wire          msgdma_mm2s_descriptor_slave_agent_rf_source_valid;               // msgdma_mm2s_descriptor_slave_agent:rf_source_valid -> msgdma_mm2s_descriptor_slave_agent_rsp_fifo:in_valid
	wire  [243:0] msgdma_mm2s_descriptor_slave_agent_rf_source_data;                // msgdma_mm2s_descriptor_slave_agent:rf_source_data -> msgdma_mm2s_descriptor_slave_agent_rsp_fifo:in_data
	wire          msgdma_mm2s_descriptor_slave_agent_rf_source_ready;               // msgdma_mm2s_descriptor_slave_agent_rsp_fifo:in_ready -> msgdma_mm2s_descriptor_slave_agent:rf_source_ready
	wire          msgdma_mm2s_descriptor_slave_agent_rf_source_startofpacket;       // msgdma_mm2s_descriptor_slave_agent:rf_source_startofpacket -> msgdma_mm2s_descriptor_slave_agent_rsp_fifo:in_startofpacket
	wire          msgdma_mm2s_descriptor_slave_agent_rf_source_endofpacket;         // msgdma_mm2s_descriptor_slave_agent:rf_source_endofpacket -> msgdma_mm2s_descriptor_slave_agent_rsp_fifo:in_endofpacket
	wire          msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_valid;            // msgdma_mm2s_descriptor_slave_agent_rsp_fifo:out_valid -> msgdma_mm2s_descriptor_slave_agent:rf_sink_valid
	wire  [243:0] msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_data;             // msgdma_mm2s_descriptor_slave_agent_rsp_fifo:out_data -> msgdma_mm2s_descriptor_slave_agent:rf_sink_data
	wire          msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_ready;            // msgdma_mm2s_descriptor_slave_agent:rf_sink_ready -> msgdma_mm2s_descriptor_slave_agent_rsp_fifo:out_ready
	wire          msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_startofpacket;    // msgdma_mm2s_descriptor_slave_agent_rsp_fifo:out_startofpacket -> msgdma_mm2s_descriptor_slave_agent:rf_sink_startofpacket
	wire          msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_endofpacket;      // msgdma_mm2s_descriptor_slave_agent_rsp_fifo:out_endofpacket -> msgdma_mm2s_descriptor_slave_agent:rf_sink_endofpacket
	wire          msgdma_mm2s_descriptor_slave_agent_rdata_fifo_src_valid;          // msgdma_mm2s_descriptor_slave_agent:rdata_fifo_src_valid -> msgdma_mm2s_descriptor_slave_agent_rdata_fifo:in_valid
	wire  [129:0] msgdma_mm2s_descriptor_slave_agent_rdata_fifo_src_data;           // msgdma_mm2s_descriptor_slave_agent:rdata_fifo_src_data -> msgdma_mm2s_descriptor_slave_agent_rdata_fifo:in_data
	wire          msgdma_mm2s_descriptor_slave_agent_rdata_fifo_src_ready;          // msgdma_mm2s_descriptor_slave_agent_rdata_fifo:in_ready -> msgdma_mm2s_descriptor_slave_agent:rdata_fifo_src_ready
	wire          msgdma_mm2s_descriptor_slave_agent_rdata_fifo_out_valid;          // msgdma_mm2s_descriptor_slave_agent_rdata_fifo:out_valid -> msgdma_mm2s_descriptor_slave_agent:rdata_fifo_sink_valid
	wire  [129:0] msgdma_mm2s_descriptor_slave_agent_rdata_fifo_out_data;           // msgdma_mm2s_descriptor_slave_agent_rdata_fifo:out_data -> msgdma_mm2s_descriptor_slave_agent:rdata_fifo_sink_data
	wire          msgdma_mm2s_descriptor_slave_agent_rdata_fifo_out_ready;          // msgdma_mm2s_descriptor_slave_agent:rdata_fifo_sink_ready -> msgdma_mm2s_descriptor_slave_agent_rdata_fifo:out_ready
	...
	wire  [135:0] onchip_memory2_0_s1_agent_rf_source_data;                         // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [135:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;                      // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire  [134:0] agilex_hps_h2f_axi_master_agent_write_cp_data;                    // agilex_hps_h2f_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [134:0] agilex_hps_h2f_axi_master_agent_read_cp_data;                     // agilex_hps_h2f_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire          msgdma_mm2s_csr_agent_rp_valid;                                   // msgdma_mm2s_csr_agent:rp_valid -> router_002:sink_valid
	wire  [134:0] msgdma_mm2s_csr_agent_rp_data;                                    // msgdma_mm2s_csr_agent:rp_data -> router_002:sink_data
	wire          msgdma_mm2s_csr_agent_rp_ready;                                   // router_002:sink_ready -> msgdma_mm2s_csr_agent:rp_ready
	wire          msgdma_mm2s_csr_agent_rp_startofpacket;                           // msgdma_mm2s_csr_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          msgdma_mm2s_csr_agent_rp_endofpacket;                             // msgdma_mm2s_csr_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire          router_002_src_valid;                                             // router_002:src_valid -> rsp_demux:sink_valid
	wire  [134:0] router_002_src_data;                                              // router_002:src_data -> rsp_demux:sink_data
	...
	wire          msgdma_mm2s_descriptor_slave_agent_rp_valid;                      // msgdma_mm2s_descriptor_slave_agent:rp_valid -> router_003:sink_valid
	wire  [242:0] msgdma_mm2s_descriptor_slave_agent_rp_data;                       // msgdma_mm2s_descriptor_slave_agent:rp_data -> router_003:sink_data
	wire          msgdma_mm2s_descriptor_slave_agent_rp_ready;                      // router_003:sink_ready -> msgdma_mm2s_descriptor_slave_agent:rp_ready
	wire          msgdma_mm2s_descriptor_slave_agent_rp_startofpacket;              // msgdma_mm2s_descriptor_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          msgdma_mm2s_descriptor_slave_agent_rp_endofpacket;                // msgdma_mm2s_descriptor_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	wire          onchip_memory2_0_s1_agent_rp_valid;                               // onchip_memory2_0_s1_agent:rp_valid -> router_004:sink_valid
	wire  [134:0] onchip_memory2_0_s1_agent_rp_data;                                // onchip_memory2_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [134:0] router_004_src_data;                                              // router_004:src_data -> rsp_demux_002:sink_data
	...
	wire  [134:0] router_src_data;                                                  // router:src_data -> agilex_hps_h2f_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [134:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data;                // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [134:0] rsp_mux_src_data;                                                 // rsp_mux:src_data -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [134:0] agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data;                // agilex_hps_h2f_axi_master_wr_limiter:rsp_src_data -> agilex_hps_h2f_axi_master_agent:write_rp_data
	...
	wire  [134:0] router_001_src_data;                                              // router_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [134:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data;                // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [134:0] rsp_mux_001_src_data;                                             // rsp_mux_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [134:0] agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data;                // agilex_hps_h2f_axi_master_rd_limiter:rsp_src_data -> agilex_hps_h2f_axi_master_agent:read_rp_data
	...
	wire          cmd_mux_src_valid;                                                // cmd_mux:src_valid -> msgdma_mm2s_csr_burst_adapter:sink0_valid
	wire  [134:0] cmd_mux_src_data;                                                 // cmd_mux:src_data -> msgdma_mm2s_csr_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                // msgdma_mm2s_csr_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                              // cmd_mux:src_channel -> msgdma_mm2s_csr_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                        // cmd_mux:src_startofpacket -> msgdma_mm2s_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                          // cmd_mux:src_endofpacket -> msgdma_mm2s_csr_burst_adapter:sink0_endofpacket
	wire          msgdma_mm2s_csr_burst_adapter_source0_valid;                      // msgdma_mm2s_csr_burst_adapter:source0_valid -> msgdma_mm2s_csr_agent:cp_valid
	wire  [134:0] msgdma_mm2s_csr_burst_adapter_source0_data;                       // msgdma_mm2s_csr_burst_adapter:source0_data -> msgdma_mm2s_csr_agent:cp_data
	wire          msgdma_mm2s_csr_burst_adapter_source0_ready;                      // msgdma_mm2s_csr_agent:cp_ready -> msgdma_mm2s_csr_burst_adapter:source0_ready
	wire    [2:0] msgdma_mm2s_csr_burst_adapter_source0_channel;                    // msgdma_mm2s_csr_burst_adapter:source0_channel -> msgdma_mm2s_csr_agent:cp_channel
	wire          msgdma_mm2s_csr_burst_adapter_source0_startofpacket;              // msgdma_mm2s_csr_burst_adapter:source0_startofpacket -> msgdma_mm2s_csr_agent:cp_startofpacket
	wire          msgdma_mm2s_csr_burst_adapter_source0_endofpacket;                // msgdma_mm2s_csr_burst_adapter:source0_endofpacket -> msgdma_mm2s_csr_agent:cp_endofpacket
	wire          msgdma_mm2s_descriptor_slave_burst_adapter_source0_valid;         // msgdma_mm2s_descriptor_slave_burst_adapter:source0_valid -> msgdma_mm2s_descriptor_slave_agent:cp_valid
	wire  [242:0] msgdma_mm2s_descriptor_slave_burst_adapter_source0_data;          // msgdma_mm2s_descriptor_slave_burst_adapter:source0_data -> msgdma_mm2s_descriptor_slave_agent:cp_data
	wire          msgdma_mm2s_descriptor_slave_burst_adapter_source0_ready;         // msgdma_mm2s_descriptor_slave_agent:cp_ready -> msgdma_mm2s_descriptor_slave_burst_adapter:source0_ready
	wire    [2:0] msgdma_mm2s_descriptor_slave_burst_adapter_source0_channel;       // msgdma_mm2s_descriptor_slave_burst_adapter:source0_channel -> msgdma_mm2s_descriptor_slave_agent:cp_channel
	wire          msgdma_mm2s_descriptor_slave_burst_adapter_source0_startofpacket; // msgdma_mm2s_descriptor_slave_burst_adapter:source0_startofpacket -> msgdma_mm2s_descriptor_slave_agent:cp_startofpacket
	wire          msgdma_mm2s_descriptor_slave_burst_adapter_source0_endofpacket;   // msgdma_mm2s_descriptor_slave_burst_adapter:source0_endofpacket -> msgdma_mm2s_descriptor_slave_agent:cp_endofpacket
	wire          cmd_mux_002_src_valid;                                            // cmd_mux_002:src_valid -> onchip_memory2_0_s1_burst_adapter:sink0_valid
	wire  [134:0] cmd_mux_002_src_data;                                             // cmd_mux_002:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [134:0] onchip_memory2_0_s1_burst_adapter_source0_data;                   // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [134:0] cmd_demux_001_src0_data;                                          // cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	wire  [134:0] cmd_demux_001_src1_data;                                          // cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [134:0] cmd_demux_001_src2_data;                                          // cmd_demux_001:src2_data -> cmd_mux_002:sink1_data
	...
	wire  [134:0] rsp_demux_src1_data;                                              // rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	wire  [134:0] rsp_demux_001_src1_data;                                          // rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [134:0] rsp_demux_002_src1_data;                                          // rsp_demux_002:src1_data -> rsp_mux_001:sink2_data
	...
	wire          router_003_src_valid;                                             // router_003:src_valid -> msgdma_mm2s_descriptor_slave_rsp_width_adapter:in_valid
	wire  [242:0] router_003_src_data;                                              // router_003:src_data -> msgdma_mm2s_descriptor_slave_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                             // msgdma_mm2s_descriptor_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [2:0] router_003_src_channel;                                           // router_003:src_channel -> msgdma_mm2s_descriptor_slave_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                     // router_003:src_startofpacket -> msgdma_mm2s_descriptor_slave_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                       // router_003:src_endofpacket -> msgdma_mm2s_descriptor_slave_rsp_width_adapter:in_endofpacket
	wire          msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_valid;         // msgdma_mm2s_descriptor_slave_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [134:0] msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_data;          // msgdma_mm2s_descriptor_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_ready;         // rsp_demux_001:sink_ready -> msgdma_mm2s_descriptor_slave_rsp_width_adapter:out_ready
	wire    [2:0] msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_channel;       // msgdma_mm2s_descriptor_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_startofpacket; // msgdma_mm2s_descriptor_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_endofpacket;   // msgdma_mm2s_descriptor_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          cmd_mux_001_src_valid;                                            // cmd_mux_001:src_valid -> msgdma_mm2s_descriptor_slave_cmd_width_adapter:in_valid
	wire  [134:0] cmd_mux_001_src_data;                                             // cmd_mux_001:src_data -> msgdma_mm2s_descriptor_slave_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                            // msgdma_mm2s_descriptor_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                          // cmd_mux_001:src_channel -> msgdma_mm2s_descriptor_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                                    // cmd_mux_001:src_startofpacket -> msgdma_mm2s_descriptor_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                      // cmd_mux_001:src_endofpacket -> msgdma_mm2s_descriptor_slave_cmd_width_adapter:in_endofpacket
	wire          msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_valid;         // msgdma_mm2s_descriptor_slave_cmd_width_adapter:out_valid -> msgdma_mm2s_descriptor_slave_burst_adapter:sink0_valid
	wire  [242:0] msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_data;          // msgdma_mm2s_descriptor_slave_cmd_width_adapter:out_data -> msgdma_mm2s_descriptor_slave_burst_adapter:sink0_data
	wire          msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_ready;         // msgdma_mm2s_descriptor_slave_burst_adapter:sink0_ready -> msgdma_mm2s_descriptor_slave_cmd_width_adapter:out_ready
	wire    [2:0] msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_channel;       // msgdma_mm2s_descriptor_slave_cmd_width_adapter:out_channel -> msgdma_mm2s_descriptor_slave_burst_adapter:sink0_channel
	wire          msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_startofpacket; // msgdma_mm2s_descriptor_slave_cmd_width_adapter:out_startofpacket -> msgdma_mm2s_descriptor_slave_burst_adapter:sink0_startofpacket
	wire          msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_endofpacket;   // msgdma_mm2s_descriptor_slave_cmd_width_adapter:out_endofpacket -> msgdma_mm2s_descriptor_slave_burst_adapter:sink0_endofpacket
	...
	qsys_top_altera_merlin_slave_translator_191_x56fcki #(
		...
		.uav_address            (msgdma_mm2s_csr_agent_m0_address),                //   input,  width = 32, avalon_universal_slave_0.address
		.uav_burstcount         (msgdma_mm2s_csr_agent_m0_burstcount),             //   input,   width = 3,                         .burstcount
		.uav_read               (msgdma_mm2s_csr_agent_m0_read),                   //   input,   width = 1,                         .read
		.uav_write              (msgdma_mm2s_csr_agent_m0_write),                  //   input,   width = 1,                         .write
		.uav_waitrequest        (msgdma_mm2s_csr_agent_m0_waitrequest),            //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (msgdma_mm2s_csr_agent_m0_readdatavalid),          //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (msgdma_mm2s_csr_agent_m0_byteenable),             //   input,   width = 4,                         .byteenable
		.uav_readdata           (msgdma_mm2s_csr_agent_m0_readdata),               //  output,  width = 32,                         .readdata
		.uav_writedata          (msgdma_mm2s_csr_agent_m0_writedata),              //   input,  width = 32,                         .writedata
		.uav_lock               (msgdma_mm2s_csr_agent_m0_lock),                   //   input,   width = 1,                         .lock
		.uav_debugaccess        (msgdma_mm2s_csr_agent_m0_debugaccess),            //   input,   width = 1,                         .debugaccess
		.av_address             (msgdma_mm2s_csr_address),                         //  output,   width = 3,      avalon_anti_slave_0.address
		.av_write               (msgdma_mm2s_csr_write),                           //  output,   width = 1,                         .write
		.av_read                (msgdma_mm2s_csr_read),                            //  output,   width = 1,                         .read
		.av_readdata            (msgdma_mm2s_csr_readdata),                        //   input,  width = 32,                         .readdata
		.av_writedata           (msgdma_mm2s_csr_writedata),                       //  output,  width = 32,                         .writedata
		.av_byteenable          (msgdma_mm2s_csr_byteenable),                      //  output,   width = 4,                         .byteenable
	...
	qsys_top_altera_merlin_slave_translator_191_x56fcki #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (1)
	) msgdma_mm2s_descriptor_slave_translator (
		.clk                    (clk_100_out_clk_clk),                                                                                                                   //   input,    width = 1,                      clk.clk
		.reset                  (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),                                                                                       //   input,    width = 1,                    reset.reset
		.uav_address            (msgdma_mm2s_descriptor_slave_agent_m0_address),                                                                                         //   input,   width = 32, avalon_universal_slave_0.address
		.uav_burstcount         (msgdma_mm2s_descriptor_slave_agent_m0_burstcount),                                                                                      //   input,    width = 5,                         .burstcount
		.uav_read               (msgdma_mm2s_descriptor_slave_agent_m0_read),                                                                                            //   input,    width = 1,                         .read
		.uav_write              (msgdma_mm2s_descriptor_slave_agent_m0_write),                                                                                           //   input,    width = 1,                         .write
		.uav_waitrequest        (msgdma_mm2s_descriptor_slave_agent_m0_waitrequest),                                                                                     //  output,    width = 1,                         .waitrequest
		.uav_readdatavalid      (msgdma_mm2s_descriptor_slave_agent_m0_readdatavalid),                                                                                   //  output,    width = 1,                         .readdatavalid
		.uav_byteenable         (msgdma_mm2s_descriptor_slave_agent_m0_byteenable),                                                                                      //   input,   width = 16,                         .byteenable
		.uav_readdata           (msgdma_mm2s_descriptor_slave_agent_m0_readdata),                                                                                        //  output,  width = 128,                         .readdata
		.uav_writedata          (msgdma_mm2s_descriptor_slave_agent_m0_writedata),                                                                                       //   input,  width = 128,                         .writedata
		.uav_lock               (msgdma_mm2s_descriptor_slave_agent_m0_lock),                                                                                            //   input,    width = 1,                         .lock
		.uav_debugaccess        (msgdma_mm2s_descriptor_slave_agent_m0_debugaccess),                                                                                     //   input,    width = 1,                         .debugaccess
		.av_write               (msgdma_mm2s_descriptor_slave_write),                                                                                                    //  output,    width = 1,      avalon_anti_slave_0.write
		.av_writedata           (msgdma_mm2s_descriptor_slave_writedata),                                                                                                //  output,  width = 128,                         .writedata
		.av_byteenable          (msgdma_mm2s_descriptor_slave_byteenable),                                                                                               //  output,   width = 16,                         .byteenable
		.av_waitrequest         (msgdma_mm2s_descriptor_slave_waitrequest),                                                                                              //   input,    width = 1,                         .waitrequest
	...
	qsys_top_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_cp_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),              //  output,  width = 135,                 .data
		...
		.write_rp_data          (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data),          //   input,  width = 135,                 .data
		...
		.read_cp_data           (agilex_hps_h2f_axi_master_agent_read_cp_data),               //  output,  width = 135,                 .data
		...
		.read_rp_data           (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data),          //   input,  width = 135,                 .data
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.ECC_ENABLE                (0),
		.SYNC_RESET                (1)
	) msgdma_mm2s_csr_agent (
		.clk                     (clk_100_out_clk_clk),                                 //   input,    width = 1,             clk.clk
		.reset                   (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),     //   input,    width = 1,       clk_reset.reset
		.m0_address              (msgdma_mm2s_csr_agent_m0_address),                    //  output,   width = 32,              m0.address
		.m0_burstcount           (msgdma_mm2s_csr_agent_m0_burstcount),                 //  output,    width = 3,                .burstcount
		.m0_byteenable           (msgdma_mm2s_csr_agent_m0_byteenable),                 //  output,    width = 4,                .byteenable
		.m0_debugaccess          (msgdma_mm2s_csr_agent_m0_debugaccess),                //  output,    width = 1,                .debugaccess
		.m0_lock                 (msgdma_mm2s_csr_agent_m0_lock),                       //  output,    width = 1,                .lock
		.m0_readdata             (msgdma_mm2s_csr_agent_m0_readdata),                   //   input,   width = 32,                .readdata
		.m0_readdatavalid        (msgdma_mm2s_csr_agent_m0_readdatavalid),              //   input,    width = 1,                .readdatavalid
		.m0_read                 (msgdma_mm2s_csr_agent_m0_read),                       //  output,    width = 1,                .read
		.m0_waitrequest          (msgdma_mm2s_csr_agent_m0_waitrequest),                //   input,    width = 1,                .waitrequest
		.m0_writedata            (msgdma_mm2s_csr_agent_m0_writedata),                  //  output,   width = 32,                .writedata
		.m0_write                (msgdma_mm2s_csr_agent_m0_write),                      //  output,    width = 1,                .write
		.rp_endofpacket          (msgdma_mm2s_csr_agent_rp_endofpacket),                //  output,    width = 1,              rp.endofpacket
		.rp_ready                (msgdma_mm2s_csr_agent_rp_ready),                      //   input,    width = 1,                .ready
		.rp_valid                (msgdma_mm2s_csr_agent_rp_valid),                      //  output,    width = 1,                .valid
		.rp_data                 (msgdma_mm2s_csr_agent_rp_data),                       //  output,  width = 135,                .data
		.rp_startofpacket        (msgdma_mm2s_csr_agent_rp_startofpacket),              //  output,    width = 1,                .startofpacket
		.cp_ready                (msgdma_mm2s_csr_burst_adapter_source0_ready),         //  output,    width = 1,              cp.ready
		.cp_valid                (msgdma_mm2s_csr_burst_adapter_source0_valid),         //   input,    width = 1,                .valid
		.cp_data                 (msgdma_mm2s_csr_burst_adapter_source0_data),          //   input,  width = 135,                .data
		.cp_startofpacket        (msgdma_mm2s_csr_burst_adapter_source0_startofpacket), //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (msgdma_mm2s_csr_burst_adapter_source0_endofpacket),   //   input,    width = 1,                .endofpacket
		.cp_channel              (msgdma_mm2s_csr_burst_adapter_source0_channel),       //   input,    width = 3,                .channel
		.rf_sink_ready           (msgdma_mm2s_csr_agent_rsp_fifo_out_ready),            //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (msgdma_mm2s_csr_agent_rsp_fifo_out_valid),            //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (msgdma_mm2s_csr_agent_rsp_fifo_out_startofpacket),    //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (msgdma_mm2s_csr_agent_rsp_fifo_out_endofpacket),      //   input,    width = 1,                .endofpacket
		.rf_sink_data            (msgdma_mm2s_csr_agent_rsp_fifo_out_data),             //   input,  width = 136,                .data
		.rf_source_ready         (msgdma_mm2s_csr_agent_rf_source_ready),               //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (msgdma_mm2s_csr_agent_rf_source_valid),               //  output,    width = 1,                .valid
		.rf_source_startofpacket (msgdma_mm2s_csr_agent_rf_source_startofpacket),       //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (msgdma_mm2s_csr_agent_rf_source_endofpacket),         //  output,    width = 1,                .endofpacket
		.rf_source_data          (msgdma_mm2s_csr_agent_rf_source_data),                //  output,  width = 136,                .data
		.rdata_fifo_sink_ready   (msgdma_mm2s_csr_agent_rdata_fifo_out_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (msgdma_mm2s_csr_agent_rdata_fifo_out_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (msgdma_mm2s_csr_agent_rdata_fifo_out_data),           //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (msgdma_mm2s_csr_agent_rdata_fifo_src_ready),          //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (msgdma_mm2s_csr_agent_rdata_fifo_src_valid),          //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (msgdma_mm2s_csr_agent_rdata_fifo_src_data),           //  output,   width = 34,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (1)
	) msgdma_mm2s_csr_agent_rsp_fifo (
		.clk               (clk_100_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (msgdma_mm2s_csr_agent_rf_source_data),                 //   input,  width = 136,        in.data
		.in_valid          (msgdma_mm2s_csr_agent_rf_source_valid),                //   input,    width = 1,          .valid
		.in_ready          (msgdma_mm2s_csr_agent_rf_source_ready),                //  output,    width = 1,          .ready
		.in_startofpacket  (msgdma_mm2s_csr_agent_rf_source_startofpacket),        //   input,    width = 1,          .startofpacket
		.in_endofpacket    (msgdma_mm2s_csr_agent_rf_source_endofpacket),          //   input,    width = 1,          .endofpacket
		.out_data          (msgdma_mm2s_csr_agent_rsp_fifo_out_data),              //  output,  width = 136,       out.data
		.out_valid         (msgdma_mm2s_csr_agent_rsp_fifo_out_valid),             //  output,    width = 1,          .valid
		.out_ready         (msgdma_mm2s_csr_agent_rsp_fifo_out_ready),             //   input,    width = 1,          .ready
		.out_startofpacket (msgdma_mm2s_csr_agent_rsp_fifo_out_startofpacket),     //  output,    width = 1,          .startofpacket
		.out_endofpacket   (msgdma_mm2s_csr_agent_rsp_fifo_out_endofpacket),       //  output,    width = 1,          .endofpacket
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (1)
	) msgdma_mm2s_csr_agent_rdata_fifo (
		.clk               (clk_100_out_clk_clk),                                  //   input,   width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset), //   input,   width = 1, clk_reset.reset
		.in_data           (msgdma_mm2s_csr_agent_rdata_fifo_src_data),            //   input,  width = 34,        in.data
		.in_valid          (msgdma_mm2s_csr_agent_rdata_fifo_src_valid),           //   input,   width = 1,          .valid
		.in_ready          (msgdma_mm2s_csr_agent_rdata_fifo_src_ready),           //  output,   width = 1,          .ready
		.out_data          (msgdma_mm2s_csr_agent_rdata_fifo_out_data),            //  output,  width = 34,       out.data
		.out_valid         (msgdma_mm2s_csr_agent_rdata_fifo_out_valid),           //  output,   width = 1,          .valid
		.out_ready         (msgdma_mm2s_csr_agent_rdata_fifo_out_ready),           //   input,   width = 1,          .ready
		.csr_address       (2'b00),                                                // (terminated),                        
		.csr_read          (1'b0),                                                 // (terminated),                        
		.csr_write         (1'b0),                                                 // (terminated),                        
		.csr_readdata      (),                                                     // (terminated),                        
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.ECC_ENABLE                (0),
		.SYNC_RESET                (1)
	) msgdma_mm2s_descriptor_slave_agent (
		.clk                     (clk_100_out_clk_clk),                                              //   input,    width = 1,             clk.clk
		.reset                   (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),                  //   input,    width = 1,       clk_reset.reset
		.m0_address              (msgdma_mm2s_descriptor_slave_agent_m0_address),                    //  output,   width = 32,              m0.address
		.m0_burstcount           (msgdma_mm2s_descriptor_slave_agent_m0_burstcount),                 //  output,    width = 5,                .burstcount
		.m0_byteenable           (msgdma_mm2s_descriptor_slave_agent_m0_byteenable),                 //  output,   width = 16,                .byteenable
		.m0_debugaccess          (msgdma_mm2s_descriptor_slave_agent_m0_debugaccess),                //  output,    width = 1,                .debugaccess
		.m0_lock                 (msgdma_mm2s_descriptor_slave_agent_m0_lock),                       //  output,    width = 1,                .lock
		.m0_readdata             (msgdma_mm2s_descriptor_slave_agent_m0_readdata),                   //   input,  width = 128,                .readdata
		.m0_readdatavalid        (msgdma_mm2s_descriptor_slave_agent_m0_readdatavalid),              //   input,    width = 1,                .readdatavalid
		.m0_read                 (msgdma_mm2s_descriptor_slave_agent_m0_read),                       //  output,    width = 1,                .read
		.m0_waitrequest          (msgdma_mm2s_descriptor_slave_agent_m0_waitrequest),                //   input,    width = 1,                .waitrequest
		.m0_writedata            (msgdma_mm2s_descriptor_slave_agent_m0_writedata),                  //  output,  width = 128,                .writedata
		.m0_write                (msgdma_mm2s_descriptor_slave_agent_m0_write),                      //  output,    width = 1,                .write
		.rp_endofpacket          (msgdma_mm2s_descriptor_slave_agent_rp_endofpacket),                //  output,    width = 1,              rp.endofpacket
		.rp_ready                (msgdma_mm2s_descriptor_slave_agent_rp_ready),                      //   input,    width = 1,                .ready
		.rp_valid                (msgdma_mm2s_descriptor_slave_agent_rp_valid),                      //  output,    width = 1,                .valid
		.rp_data                 (msgdma_mm2s_descriptor_slave_agent_rp_data),                       //  output,  width = 243,                .data
		.rp_startofpacket        (msgdma_mm2s_descriptor_slave_agent_rp_startofpacket),              //  output,    width = 1,                .startofpacket
		.cp_ready                (msgdma_mm2s_descriptor_slave_burst_adapter_source0_ready),         //  output,    width = 1,              cp.ready
		.cp_valid                (msgdma_mm2s_descriptor_slave_burst_adapter_source0_valid),         //   input,    width = 1,                .valid
		.cp_data                 (msgdma_mm2s_descriptor_slave_burst_adapter_source0_data),          //   input,  width = 243,                .data
		.cp_startofpacket        (msgdma_mm2s_descriptor_slave_burst_adapter_source0_startofpacket), //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (msgdma_mm2s_descriptor_slave_burst_adapter_source0_endofpacket),   //   input,    width = 1,                .endofpacket
		.cp_channel              (msgdma_mm2s_descriptor_slave_burst_adapter_source0_channel),       //   input,    width = 3,                .channel
		.rf_sink_ready           (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_ready),            //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_valid),            //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_startofpacket),    //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_endofpacket),      //   input,    width = 1,                .endofpacket
		.rf_sink_data            (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_data),             //   input,  width = 244,                .data
		.rf_source_ready         (msgdma_mm2s_descriptor_slave_agent_rf_source_ready),               //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (msgdma_mm2s_descriptor_slave_agent_rf_source_valid),               //  output,    width = 1,                .valid
		.rf_source_startofpacket (msgdma_mm2s_descriptor_slave_agent_rf_source_startofpacket),       //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (msgdma_mm2s_descriptor_slave_agent_rf_source_endofpacket),         //  output,    width = 1,                .endofpacket
		.rf_source_data          (msgdma_mm2s_descriptor_slave_agent_rf_source_data),                //  output,  width = 244,                .data
		.rdata_fifo_sink_ready   (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_out_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_out_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_out_data),           //   input,  width = 130,                .data
		.rdata_fifo_src_ready    (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_src_ready),          //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_src_valid),          //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_src_data),           //  output,  width = 130,                .data
		.m0_response             (2'b00),                                                            // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                                             // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                              // (terminated),                               
	);
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (1)
	) msgdma_mm2s_descriptor_slave_agent_rsp_fifo (
		.clk               (clk_100_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset),          //   input,    width = 1, clk_reset.reset
		.in_data           (msgdma_mm2s_descriptor_slave_agent_rf_source_data),             //   input,  width = 244,        in.data
		.in_valid          (msgdma_mm2s_descriptor_slave_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (msgdma_mm2s_descriptor_slave_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (msgdma_mm2s_descriptor_slave_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (msgdma_mm2s_descriptor_slave_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_data),          //  output,  width = 244,       out.data
		.out_valid         (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (msgdma_mm2s_descriptor_slave_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                                         // (terminated),                         
		.csr_read          (1'b0),                                                          // (terminated),                         
		.csr_write         (1'b0),                                                          // (terminated),                         
		.csr_readdata      (),                                                              // (terminated),                         
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.EMPTY_WIDTH         (1),
		.SYNC_RESET          (1)
	) msgdma_mm2s_descriptor_slave_agent_rdata_fifo (
		.clk               (clk_100_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset),    //   input,    width = 1, clk_reset.reset
		.in_data           (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_src_data),  //   input,  width = 130,        in.data
		.in_valid          (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_src_valid), //   input,    width = 1,          .valid
		.in_ready          (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_src_ready), //  output,    width = 1,          .ready
		.out_data          (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_out_data),  //  output,  width = 130,       out.data
		.out_valid         (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_out_valid), //  output,    width = 1,          .valid
		.out_ready         (msgdma_mm2s_descriptor_slave_agent_rdata_fifo_out_ready), //   input,    width = 1,          .ready
		.csr_address       (2'b00),                                                   // (terminated),                         
		.csr_read          (1'b0),                                                    // (terminated),                         
		.csr_write         (1'b0),                                                    // (terminated),                         
		.csr_readdata      (),                                                        // (terminated),                         
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                       //  output,  width = 135,                .data
		...
		.cp_data                 (onchip_memory2_0_s1_burst_adapter_source0_data),          //   input,  width = 135,                .data
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),             //   input,  width = 136,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),                //  output,  width = 136,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),             //   input,  width = 136,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),          //  output,  width = 136,       out.data
	...
	qsys_top_altera_merlin_router_1921_yheedri router (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),          //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_router_1921_yheedri router_001 (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_read_cp_data),          //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_router_1921_ah6c3va router_002 (
		.sink_ready         (msgdma_mm2s_csr_agent_rp_ready),                  //  output,    width = 1,      sink.ready
		.sink_valid         (msgdma_mm2s_csr_agent_rp_valid),                  //   input,    width = 1,          .valid
		.sink_data          (msgdma_mm2s_csr_agent_rp_data),                   //   input,  width = 135,          .data
		.sink_startofpacket (msgdma_mm2s_csr_agent_rp_startofpacket),          //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (msgdma_mm2s_csr_agent_rp_endofpacket),            //   input,    width = 1,          .endofpacket
		.clk                (clk_100_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_router_1921_knzvu7i router_003 (
		.sink_ready         (msgdma_mm2s_descriptor_slave_agent_rp_ready),         //  output,    width = 1,      sink.ready
		.sink_valid         (msgdma_mm2s_descriptor_slave_agent_rp_valid),         //   input,    width = 1,          .valid
		.sink_data          (msgdma_mm2s_descriptor_slave_agent_rp_data),          //   input,  width = 243,          .data
		.sink_startofpacket (msgdma_mm2s_descriptor_slave_agent_rp_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (msgdma_mm2s_descriptor_slave_agent_rp_endofpacket),   //   input,    width = 1,          .endofpacket
		.clk                (clk_100_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset              (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),     //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_router_1921_ah6c3va router_004 (
		...
		.sink_data          (onchip_memory2_0_s1_agent_rp_data),               //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_data           (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),          //  output,  width = 135,          .data
		...
		.rsp_src_data           (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data),          //  output,  width = 135,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_data           (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),          //  output,  width = 135,          .data
		...
		.rsp_sink_data          (rsp_mux_001_src_data),                                       //   input,  width = 135,          .data
		...
		.rsp_src_data           (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data),          //  output,  width = 135,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1923_rregqry #(
		...
		.SYNC_RESET                (1)
	) msgdma_mm2s_csr_burst_adapter (
		.clk                   (clk_100_out_clk_clk),                                 //   input,    width = 1,       cr0.clk
		.reset                 (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),     //   input,    width = 1, cr0_reset.reset
		...
		.source0_valid         (msgdma_mm2s_csr_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (msgdma_mm2s_csr_burst_adapter_source0_data),          //  output,  width = 135,          .data
		.source0_channel       (msgdma_mm2s_csr_burst_adapter_source0_channel),       //  output,    width = 3,          .channel
		.source0_startofpacket (msgdma_mm2s_csr_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (msgdma_mm2s_csr_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (msgdma_mm2s_csr_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
	...
	qsys_top_altera_merlin_burst_adapter_1923_k4taf2q #(
		...
		.ADAPTER_VERSION           ("13.1"),
		.SYNC_RESET                (1)
	) msgdma_mm2s_descriptor_slave_burst_adapter (
		.clk                   (clk_100_out_clk_clk),                                              //   input,    width = 1,       cr0.clk
		.reset                 (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),                  //   input,    width = 1, cr0_reset.reset
		.sink0_valid           (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_valid),         //   input,    width = 1,     sink0.valid
		.sink0_data            (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_data),          //   input,  width = 243,          .data
		.sink0_channel         (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_channel),       //   input,    width = 3,          .channel
		.sink0_startofpacket   (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink0_endofpacket     (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink0_ready           (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_ready),         //  output,    width = 1,          .ready
		.source0_valid         (msgdma_mm2s_descriptor_slave_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (msgdma_mm2s_descriptor_slave_burst_adapter_source0_data),          //  output,  width = 243,          .data
		.source0_channel       (msgdma_mm2s_descriptor_slave_burst_adapter_source0_channel),       //  output,    width = 3,          .channel
		.source0_startofpacket (msgdma_mm2s_descriptor_slave_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (msgdma_mm2s_descriptor_slave_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (msgdma_mm2s_descriptor_slave_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
	...
	qsys_top_altera_merlin_burst_adapter_1923_rregqry #(
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),          //  output,  width = 135,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_odw5gvy cmd_demux (
		.clk                (clk_100_out_clk_clk),                                        //   input,    width = 1,        clk.clk
		.reset              (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),          //   input,  width = 135,           .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_odw5gvy cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                        //   input,    width = 1,        clk.clk
		.reset              (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),            //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),          //   input,  width = 135,           .data
	...
	qsys_top_altera_merlin_multiplexer_1921_yxwngua cmd_mux (
		.clk                 (clk_100_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_data          (cmd_demux_001_src0_data),                         //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_yxwngua cmd_mux_001 (
		...
		.sink1_data          (cmd_demux_001_src1_data),                         //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_yxwngua cmd_mux_002 (
		.clk                 (clk_100_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_data          (cmd_demux_001_src2_data),                         //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_ur5itvq rsp_demux (
		.clk                (clk_100_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_ur5itvq rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset              (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),                  //   input,    width = 1, clk_reset.reset
		.sink_ready         (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_channel),       //   input,    width = 3,          .channel
		.sink_data          (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_data),          //   input,  width = 135,          .data
		.sink_startofpacket (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_valid),         //   input,    width = 1,          .valid
	...
	qsys_top_altera_merlin_demultiplexer_1921_ur5itvq rsp_demux_002 (
		.clk                (clk_100_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset              (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_mq2iztq rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (rsp_demux_src1_data),                             //   input,  width = 135,          .data
		...
		.sink1_data          (rsp_demux_001_src1_data),                         //   input,  width = 135,          .data
		...
		.sink2_data          (rsp_demux_002_src1_data),                         //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_pbpa2vy #(
		...
		.SYNC_RESET                    (1)
	) msgdma_mm2s_descriptor_slave_rsp_width_adapter (
		.clk                  (clk_100_out_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset                (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),                  //   input,    width = 1, clk_reset.reset
		...
		.in_data              (router_003_src_data),                                              //   input,  width = 243,          .data
		.out_endofpacket      (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_data),          //  output,  width = 135,          .data
		.out_channel          (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_channel),       //  output,    width = 3,          .channel
		.out_valid            (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (msgdma_mm2s_descriptor_slave_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
	...
	qsys_top_altera_merlin_width_adapter_1920_kfhpo5a #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (1),
		.SYNC_RESET                    (1)
	) msgdma_mm2s_descriptor_slave_cmd_width_adapter (
		.clk                  (clk_100_out_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset                (msgdma_mm2s_reset_n_reset_bridge_in_reset_reset),                  //   input,    width = 1, clk_reset.reset
		...
		.in_data              (cmd_mux_001_src_data),                                             //   input,  width = 135,          .data
		.out_endofpacket      (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_data),          //  output,  width = 243,          .data
		.out_channel          (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_channel),       //  output,    width = 3,          .channel
		.out_valid            (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (msgdma_mm2s_descriptor_slave_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                            // (terminated),                         
	);

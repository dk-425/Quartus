// qsys_top_altera_mm_interconnect_1920_tdrxr2q.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_tdrxr2q (
	...
	wire  [153:0] msgdma_0_mm_read_agent_cp_data;                                      // msgdma_0_mm_read_agent:cp_data -> router:sink_data
	...
	wire  [153:0] router_src_data;                                                     // router:src_data -> msgdma_0_mm_read_limiter:cmd_sink_data
	...
	wire  [153:0] msgdma_0_mm_read_limiter_cmd_src_data;                               // msgdma_0_mm_read_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [153:0] rsp_mux_src_data;                                                    // rsp_mux:src_data -> msgdma_0_mm_read_limiter:rsp_sink_data
	...
	wire  [153:0] msgdma_0_mm_read_limiter_rsp_src_data;                               // msgdma_0_mm_read_limiter:rsp_src_data -> msgdma_0_mm_read_agent:rp_data
	...
	wire  [261:0] router_001_src_data;                                                 // router_001:src_data -> agilex_hps_f2h_axi_slave_wr_rsp_width_adapter:in_data
	...
	wire  [261:0] router_002_src_data;                                                 // router_002:src_data -> agilex_hps_f2h_axi_slave_rd_rsp_width_adapter:in_data
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (msgdma_0_mm_read_agent_cp_data),                                      //  output,  width = 154,          .data
		...
		.rp_data               (msgdma_0_mm_read_limiter_rsp_src_data),                               //   input,  width = 154,          .data
	...
	qsys_top_altera_merlin_router_1921_nrzckeq router (
		...
		.sink_data          (msgdma_0_mm_read_agent_cp_data),               //   input,  width = 154,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_data           (msgdma_0_mm_read_limiter_cmd_src_data),          //  output,  width = 154,          .data
		...
		.rsp_src_data           (msgdma_0_mm_read_limiter_rsp_src_data),          //  output,  width = 154,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_5fn6dry cmd_demux (
		.clk                (clk_100_out_clk_clk),                            //   input,    width = 1,        clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset),   //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (msgdma_0_mm_read_limiter_cmd_src_data),          //   input,  width = 154,           .data
	...
	qsys_top_altera_merlin_multiplexer_1921_lo5s2ni rsp_mux (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_width_adapter_1920_juef5uq #(
		...
		.in_data              (router_001_src_data),                                             //   input,  width = 262,          .data

...
module agilex_hps_intel_agilex_interface_generator_191_lsv6t5y #(
...
// emac1
 ,output wire [2 - 1 : 0 ] emac1_phy_mac_speed_o
 ...
 ,output wire [1 - 1 : 0 ] s2f_emac1_ptp_tstmp_data
 ,output wire [1 - 1 : 0 ] s2f_emac1_ptp_tstmp_en
// emac1_md_clk
...
,.s2f_emac1_ptp_tstmp_en({
    s2f_emac1_ptp_tstmp_en[0:0] // 0:0
  })
,.lwsoc2fpga_aw_burst({
...
,.s2f_emac1_ptp_tstmp_data({
    s2f_emac1_ptp_tstmp_data[0:0] // 0:0
  })
,.emac1_rst_clk_rx_n_o({

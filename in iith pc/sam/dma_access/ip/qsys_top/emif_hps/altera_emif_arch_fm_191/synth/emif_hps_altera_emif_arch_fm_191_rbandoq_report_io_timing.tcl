...
source "$script_dir/emif_hps_altera_emif_arch_fm_191_rbandoq_report_timing_core.tcl"


if [ info exists ddr_db ] {
   unset ddr_db
}
emif_hps_altera_emif_arch_fm_191_rbandoq_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_emif_hps_altera_emif_arch_fm_191_rbandoq_corename}"
   } else {
      set fbasename "${::GLOBAL_emif_hps_altera_emif_arch_fm_191_rbandoq_corename}_${inst_id}"
   }
   ...
   emif_hps_altera_emif_arch_fm_191_rbandoq_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance

   set summary [lsort -command emif_hps_altera_emif_arch_fm_191_rbandoq_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_emif_hps_altera_emif_arch_fm_191_rbandoq_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ emif_hps_altera_emif_arch_fm_191_rbandoq_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ emif_hps_altera_emif_arch_fm_191_rbandoq_round_3dp $hold]
      }

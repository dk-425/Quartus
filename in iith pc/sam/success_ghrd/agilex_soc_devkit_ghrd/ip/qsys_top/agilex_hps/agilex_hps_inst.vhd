	component agilex_hps is
		port (
			...
			s2f_emac1_ptp_tstmp_data : out   std_logic;                                          -- ptp_tstmp_data
			s2f_emac1_ptp_tstmp_en   : out   std_logic;                                          -- ptp_tstmp_en
	...
	u0 : component agilex_hps
		port map (
			...
			s2f_emac1_ptp_tstmp_data => CONNECTED_TO_s2f_emac1_ptp_tstmp_data, --                   .ptp_tstmp_data
			s2f_emac1_ptp_tstmp_en   => CONNECTED_TO_s2f_emac1_ptp_tstmp_en,   --                   .ptp_tstmp_en

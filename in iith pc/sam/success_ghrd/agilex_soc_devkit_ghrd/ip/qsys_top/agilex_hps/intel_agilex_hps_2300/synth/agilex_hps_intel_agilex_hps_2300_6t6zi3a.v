// agilex_hps_intel_agilex_hps_2300_6t6zi3a.v
...
`timescale 1 ps / 1 ps
module agilex_hps_intel_agilex_hps_2300_6t6zi3a (
	...
	agilex_hps_intel_agilex_interface_generator_191_lsv6t5y #(
		.F2S_DATA_WIDTH      (512),
		...
		.emac_ptp_ref_clk         (emac_ptp_ref_clk),         //   input,     width = 1, emac_ptp_ref_clock.clk
		.emac1_phy_mac_speed_o    (emac1_phy_mac_speed_o),    //  output,     width = 2,              emac1.phy_mac_speed_o
		.emac1_phy_txd_o          (emac1_phy_txd_o),          //  output,     width = 8,                   .phy_txd_o
		.emac1_phy_txen_o         (emac1_phy_txen_o),         //  output,     width = 1,                   .phy_txen_o
		.emac1_phy_txer_o         (emac1_phy_txer_o),         //  output,     width = 1,                   .phy_txer_o
		.emac1_phy_rxdv_i         (emac1_phy_rxdv_i),         //   input,     width = 1,                   .phy_rxdv_i
		.emac1_phy_rxer_i         (emac1_phy_rxer_i),         //   input,     width = 1,                   .phy_rxer_i
		.emac1_phy_rxd_i          (emac1_phy_rxd_i),          //   input,     width = 8,                   .phy_rxd_i
		.emac1_phy_col_i          (emac1_phy_col_i),          //   input,     width = 1,                   .phy_col_i
		.emac1_phy_crs_i          (emac1_phy_crs_i),          //   input,     width = 1,                   .phy_crs_i
		.emac1_gmii_mdo_o         (emac1_gmii_mdo_o),         //  output,     width = 1,                   .gmii_mdo_o
		.emac1_gmii_mdo_o_e       (emac1_gmii_mdo_o_e),       //  output,     width = 1,                   .gmii_mdo_o_e
		.emac1_gmii_mdi_i         (emac1_gmii_mdi_i),         //   input,     width = 1,                   .gmii_mdi_i
		.emac1_ptp_pps_o          (emac1_ptp_pps_o),          //  output,     width = 1,                   .ptp_pps_o
		.emac1_ptp_aux_ts_trig_i  (emac1_ptp_aux_ts_trig_i),  //   input,     width = 1,                   .ptp_aux_ts_trig_i
		.s2f_emac1_ptp_tstmp_data (s2f_emac1_ptp_tstmp_data), //  output,     width = 1,                   .ptp_tstmp_data
		.s2f_emac1_ptp_tstmp_en   (s2f_emac1_ptp_tstmp_en),   //  output,     width = 1,                   .ptp_tstmp_en
		.emac1_gmii_mdc_o         (emac1_gmii_mdc_o),         //  output,     width = 1,       emac1_md_clk.clk
		.emac1_clk_rx_i           (emac1_clk_rx_i),           //   input,     width = 1,    emac1_rx_clk_in.clk
		.emac1_clk_tx_i           (emac1_clk_tx_i),           //   input,     width = 1,    emac1_tx_clk_in.clk
		.emac1_phy_txclk_o        (emac1_phy_txclk_o),        //  output,     width = 1,      emac1_gtx_clk.clk
		.emac1_rst_clk_tx_n_o     (emac1_rst_clk_tx_n_o),     //  output,     width = 1,     emac1_tx_reset.reset_n
		.emac1_rst_clk_rx_n_o     (emac1_rst_clk_rx_n_o),     //  output,     width = 1,     emac1_rx_reset.reset_n

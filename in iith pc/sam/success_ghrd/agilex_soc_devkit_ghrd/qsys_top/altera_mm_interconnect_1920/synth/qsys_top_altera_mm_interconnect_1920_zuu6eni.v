// qsys_top_altera_mm_interconnect_1920_zuu6eni.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_zuu6eni (
		...
		output wire [6:0]   subsys_sgmii_emac1_csr_address,                          //                            subsys_sgmii_emac1_csr.address
		output wire         subsys_sgmii_emac1_csr_write,                            //                                                  .write
		output wire         subsys_sgmii_emac1_csr_read,                             //                                                  .read
		input  wire [31:0]  subsys_sgmii_emac1_csr_readdata,                         //                                                  .readdata
		output wire [31:0]  subsys_sgmii_emac1_csr_writedata,                        //                                                  .writedata
		output wire [0:0]   subsys_sgmii_emac1_csr_burstcount,                       //                                                  .burstcount
		output wire [3:0]   subsys_sgmii_emac1_csr_byteenable,                       //                                                  .byteenable
		input  wire         subsys_sgmii_emac1_csr_readdatavalid,                    //                                                  .readdatavalid
		input  wire         subsys_sgmii_emac1_csr_waitrequest,                      //                                                  .waitrequest
		output wire         subsys_sgmii_emac1_csr_debugaccess,                      //                                                  .debugaccess
	...
	wire  [135:0] sysid_control_slave_agent_rf_source_data;                                 // sysid_control_slave_agent:rf_source_data -> sysid_control_slave_agent_rsp_fifo:in_data
	...
	wire  [135:0] sysid_control_slave_agent_rsp_fifo_out_data;                              // sysid_control_slave_agent_rsp_fifo:out_data -> sysid_control_slave_agent:rf_sink_data
	...
	wire   [31:0] subsys_sgmii_emac1_csr_agent_m0_readdata;                                 // subsys_sgmii_emac1_csr_translator:uav_readdata -> subsys_sgmii_emac1_csr_agent:m0_readdata
	wire          subsys_sgmii_emac1_csr_agent_m0_waitrequest;                              // subsys_sgmii_emac1_csr_translator:uav_waitrequest -> subsys_sgmii_emac1_csr_agent:m0_waitrequest
	wire          subsys_sgmii_emac1_csr_agent_m0_debugaccess;                              // subsys_sgmii_emac1_csr_agent:m0_debugaccess -> subsys_sgmii_emac1_csr_translator:uav_debugaccess
	wire   [31:0] subsys_sgmii_emac1_csr_agent_m0_address;                                  // subsys_sgmii_emac1_csr_agent:m0_address -> subsys_sgmii_emac1_csr_translator:uav_address
	wire    [3:0] subsys_sgmii_emac1_csr_agent_m0_byteenable;                               // subsys_sgmii_emac1_csr_agent:m0_byteenable -> subsys_sgmii_emac1_csr_translator:uav_byteenable
	wire          subsys_sgmii_emac1_csr_agent_m0_read;                                     // subsys_sgmii_emac1_csr_agent:m0_read -> subsys_sgmii_emac1_csr_translator:uav_read
	wire          subsys_sgmii_emac1_csr_agent_m0_readdatavalid;                            // subsys_sgmii_emac1_csr_translator:uav_readdatavalid -> subsys_sgmii_emac1_csr_agent:m0_readdatavalid
	wire          subsys_sgmii_emac1_csr_agent_m0_lock;                                     // subsys_sgmii_emac1_csr_agent:m0_lock -> subsys_sgmii_emac1_csr_translator:uav_lock
	wire   [31:0] subsys_sgmii_emac1_csr_agent_m0_writedata;                                // subsys_sgmii_emac1_csr_agent:m0_writedata -> subsys_sgmii_emac1_csr_translator:uav_writedata
	wire          subsys_sgmii_emac1_csr_agent_m0_write;                                    // subsys_sgmii_emac1_csr_agent:m0_write -> subsys_sgmii_emac1_csr_translator:uav_write
	wire    [2:0] subsys_sgmii_emac1_csr_agent_m0_burstcount;                               // subsys_sgmii_emac1_csr_agent:m0_burstcount -> subsys_sgmii_emac1_csr_translator:uav_burstcount
	wire          subsys_sgmii_emac1_csr_agent_rf_source_valid;                             // subsys_sgmii_emac1_csr_agent:rf_source_valid -> subsys_sgmii_emac1_csr_agent_rsp_fifo:in_valid
	wire  [135:0] subsys_sgmii_emac1_csr_agent_rf_source_data;                              // subsys_sgmii_emac1_csr_agent:rf_source_data -> subsys_sgmii_emac1_csr_agent_rsp_fifo:in_data
	wire          subsys_sgmii_emac1_csr_agent_rf_source_ready;                             // subsys_sgmii_emac1_csr_agent_rsp_fifo:in_ready -> subsys_sgmii_emac1_csr_agent:rf_source_ready
	wire          subsys_sgmii_emac1_csr_agent_rf_source_startofpacket;                     // subsys_sgmii_emac1_csr_agent:rf_source_startofpacket -> subsys_sgmii_emac1_csr_agent_rsp_fifo:in_startofpacket
	wire          subsys_sgmii_emac1_csr_agent_rf_source_endofpacket;                       // subsys_sgmii_emac1_csr_agent:rf_source_endofpacket -> subsys_sgmii_emac1_csr_agent_rsp_fifo:in_endofpacket
	wire          subsys_sgmii_emac1_csr_agent_rsp_fifo_out_valid;                          // subsys_sgmii_emac1_csr_agent_rsp_fifo:out_valid -> subsys_sgmii_emac1_csr_agent:rf_sink_valid
	wire  [135:0] subsys_sgmii_emac1_csr_agent_rsp_fifo_out_data;                           // subsys_sgmii_emac1_csr_agent_rsp_fifo:out_data -> subsys_sgmii_emac1_csr_agent:rf_sink_data
	wire          subsys_sgmii_emac1_csr_agent_rsp_fifo_out_ready;                          // subsys_sgmii_emac1_csr_agent:rf_sink_ready -> subsys_sgmii_emac1_csr_agent_rsp_fifo:out_ready
	wire          subsys_sgmii_emac1_csr_agent_rsp_fifo_out_startofpacket;                  // subsys_sgmii_emac1_csr_agent_rsp_fifo:out_startofpacket -> subsys_sgmii_emac1_csr_agent:rf_sink_startofpacket
	wire          subsys_sgmii_emac1_csr_agent_rsp_fifo_out_endofpacket;                    // subsys_sgmii_emac1_csr_agent_rsp_fifo:out_endofpacket -> subsys_sgmii_emac1_csr_agent:rf_sink_endofpacket
	wire          subsys_sgmii_emac1_csr_agent_rdata_fifo_src_valid;                        // subsys_sgmii_emac1_csr_agent:rdata_fifo_src_valid -> subsys_sgmii_emac1_csr_agent_rdata_fifo:in_valid
	wire   [33:0] subsys_sgmii_emac1_csr_agent_rdata_fifo_src_data;                         // subsys_sgmii_emac1_csr_agent:rdata_fifo_src_data -> subsys_sgmii_emac1_csr_agent_rdata_fifo:in_data
	wire          subsys_sgmii_emac1_csr_agent_rdata_fifo_src_ready;                        // subsys_sgmii_emac1_csr_agent_rdata_fifo:in_ready -> subsys_sgmii_emac1_csr_agent:rdata_fifo_src_ready
	wire          subsys_sgmii_emac1_csr_agent_rdata_fifo_out_valid;                        // subsys_sgmii_emac1_csr_agent_rdata_fifo:out_valid -> subsys_sgmii_emac1_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] subsys_sgmii_emac1_csr_agent_rdata_fifo_out_data;                         // subsys_sgmii_emac1_csr_agent_rdata_fifo:out_data -> subsys_sgmii_emac1_csr_agent:rdata_fifo_sink_data
	wire          subsys_sgmii_emac1_csr_agent_rdata_fifo_out_ready;                        // subsys_sgmii_emac1_csr_agent:rdata_fifo_sink_ready -> subsys_sgmii_emac1_csr_agent_rdata_fifo:out_ready
	...
	wire  [135:0] periph_pb_cpu_0_s0_agent_rf_source_data;                                  // periph_pb_cpu_0_s0_agent:rf_source_data -> periph_pb_cpu_0_s0_agent_rsp_fifo:in_data
	...
	wire  [135:0] periph_pb_cpu_0_s0_agent_rsp_fifo_out_data;                               // periph_pb_cpu_0_s0_agent_rsp_fifo:out_data -> periph_pb_cpu_0_s0_agent:rf_sink_data
	...
	wire  [243:0] fpga_m2ocm_pb_s0_agent_rf_source_data;                                    // fpga_m2ocm_pb_s0_agent:rf_source_data -> fpga_m2ocm_pb_s0_agent_rsp_fifo:in_data
	...
	wire  [243:0] fpga_m2ocm_pb_s0_agent_rsp_fifo_out_data;                                 // fpga_m2ocm_pb_s0_agent_rsp_fifo:out_data -> fpga_m2ocm_pb_s0_agent:rf_sink_data
	...
	wire  [134:0] jtg_mst_fpga_m_master_agent_cp_data;                                      // jtg_mst_fpga_m_master_agent:cp_data -> router:sink_data
	...
	wire          agilex_hps_h2f_lw_axi_master_agent_write_cp_valid;                        // agilex_hps_h2f_lw_axi_master_agent:write_cp_valid -> router_001:sink_valid
	wire  [134:0] agilex_hps_h2f_lw_axi_master_agent_write_cp_data;                         // agilex_hps_h2f_lw_axi_master_agent:write_cp_data -> router_001:sink_data
	wire          agilex_hps_h2f_lw_axi_master_agent_write_cp_ready;                        // router_001:sink_ready -> agilex_hps_h2f_lw_axi_master_agent:write_cp_ready
	wire          agilex_hps_h2f_lw_axi_master_agent_write_cp_startofpacket;                // agilex_hps_h2f_lw_axi_master_agent:write_cp_startofpacket -> router_001:sink_startofpacket
	wire          agilex_hps_h2f_lw_axi_master_agent_write_cp_endofpacket;                  // agilex_hps_h2f_lw_axi_master_agent:write_cp_endofpacket -> router_001:sink_endofpacket
	wire          agilex_hps_h2f_lw_axi_master_agent_read_cp_valid;                         // agilex_hps_h2f_lw_axi_master_agent:read_cp_valid -> router_002:sink_valid
	wire  [134:0] agilex_hps_h2f_lw_axi_master_agent_read_cp_data;                          // agilex_hps_h2f_lw_axi_master_agent:read_cp_data -> router_002:sink_data
	wire          agilex_hps_h2f_lw_axi_master_agent_read_cp_ready;                         // router_002:sink_ready -> agilex_hps_h2f_lw_axi_master_agent:read_cp_ready
	wire          agilex_hps_h2f_lw_axi_master_agent_read_cp_startofpacket;                 // agilex_hps_h2f_lw_axi_master_agent:read_cp_startofpacket -> router_002:sink_startofpacket
	wire          agilex_hps_h2f_lw_axi_master_agent_read_cp_endofpacket;                   // agilex_hps_h2f_lw_axi_master_agent:read_cp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [134:0] router_005_src_data;                                                      // router_005:src_data -> rsp_demux_002:sink_data
	...
	wire          router_src_valid;                                                         // router:src_valid -> jtg_mst_fpga_m_master_limiter:cmd_sink_valid
	wire  [134:0] router_src_data;                                                          // router:src_data -> jtg_mst_fpga_m_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                         // jtg_mst_fpga_m_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [3:0] router_src_channel;                                                       // router:src_channel -> jtg_mst_fpga_m_master_limiter:cmd_sink_channel
	wire          router_src_startofpacket;                                                 // router:src_startofpacket -> jtg_mst_fpga_m_master_limiter:cmd_sink_startofpacket
	wire          router_src_endofpacket;                                                   // router:src_endofpacket -> jtg_mst_fpga_m_master_limiter:cmd_sink_endofpacket
	...
	wire  [134:0] jtg_mst_fpga_m_master_limiter_rsp_src_data;                               // jtg_mst_fpga_m_master_limiter:rsp_src_data -> jtg_mst_fpga_m_master_agent:rp_data
	...
	wire    [3:0] jtg_mst_fpga_m_master_limiter_rsp_src_channel;                            // jtg_mst_fpga_m_master_limiter:rsp_src_channel -> jtg_mst_fpga_m_master_agent:rp_channel
	...
	wire          router_001_src_valid;                                                     // router_001:src_valid -> agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_sink_valid
	wire  [134:0] router_001_src_data;                                                      // router_001:src_data -> agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                     // agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [3:0] router_001_src_channel;                                                   // router_001:src_channel -> agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_sink_channel
	wire          router_001_src_startofpacket;                                             // router_001:src_startofpacket -> agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_sink_startofpacket
	wire          router_001_src_endofpacket;                                               // router_001:src_endofpacket -> agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_sink_endofpacket
	wire          agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_valid;                    // agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_src_valid -> agilex_hps_h2f_lw_axi_master_agent:write_rp_valid
	wire  [134:0] agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_data;                     // agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_src_data -> agilex_hps_h2f_lw_axi_master_agent:write_rp_data
	wire          agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_ready;                    // agilex_hps_h2f_lw_axi_master_agent:write_rp_ready -> agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_src_ready
	wire    [3:0] agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_channel;                  // agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_src_channel -> agilex_hps_h2f_lw_axi_master_agent:write_rp_channel
	wire          agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_startofpacket;            // agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_src_startofpacket -> agilex_hps_h2f_lw_axi_master_agent:write_rp_startofpacket
	wire          agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_endofpacket;              // agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_src_endofpacket -> agilex_hps_h2f_lw_axi_master_agent:write_rp_endofpacket
	wire          router_002_src_valid;                                                     // router_002:src_valid -> agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_sink_valid
	wire  [134:0] router_002_src_data;                                                      // router_002:src_data -> agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_sink_data
	wire          router_002_src_ready;                                                     // agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_sink_ready -> router_002:src_ready
	wire    [3:0] router_002_src_channel;                                                   // router_002:src_channel -> agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_sink_channel
	wire          router_002_src_startofpacket;                                             // router_002:src_startofpacket -> agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_sink_startofpacket
	wire          router_002_src_endofpacket;                                               // router_002:src_endofpacket -> agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_sink_endofpacket
	wire          agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_valid;                    // agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_src_valid -> agilex_hps_h2f_lw_axi_master_agent:read_rp_valid
	wire  [134:0] agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_data;                     // agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_src_data -> agilex_hps_h2f_lw_axi_master_agent:read_rp_data
	wire          agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_ready;                    // agilex_hps_h2f_lw_axi_master_agent:read_rp_ready -> agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_src_ready
	wire    [3:0] agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_channel;                  // agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_src_channel -> agilex_hps_h2f_lw_axi_master_agent:read_rp_channel
	wire          agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_startofpacket;            // agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_src_startofpacket -> agilex_hps_h2f_lw_axi_master_agent:read_rp_startofpacket
	wire          agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_endofpacket;              // agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_src_endofpacket -> agilex_hps_h2f_lw_axi_master_agent:read_rp_endofpacket
	wire          cmd_mux_src_valid;                                                        // cmd_mux:src_valid -> sysid_control_slave_burst_adapter:sink0_valid
	wire  [134:0] cmd_mux_src_data;                                                         // cmd_mux:src_data -> sysid_control_slave_burst_adapter:sink0_data
	...
	wire          cmd_mux_001_src_valid;                                                    // cmd_mux_001:src_valid -> subsys_sgmii_emac1_csr_burst_adapter:sink0_valid
	wire  [134:0] cmd_mux_001_src_data;                                                     // cmd_mux_001:src_data -> subsys_sgmii_emac1_csr_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                    // subsys_sgmii_emac1_csr_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                                  // cmd_mux_001:src_channel -> subsys_sgmii_emac1_csr_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                            // cmd_mux_001:src_startofpacket -> subsys_sgmii_emac1_csr_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                              // cmd_mux_001:src_endofpacket -> subsys_sgmii_emac1_csr_burst_adapter:sink0_endofpacket
	wire          cmd_mux_002_src_valid;                                                    // cmd_mux_002:src_valid -> periph_pb_cpu_0_s0_burst_adapter:sink0_valid
	wire  [134:0] cmd_mux_002_src_data;                                                     // cmd_mux_002:src_data -> periph_pb_cpu_0_s0_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                    // periph_pb_cpu_0_s0_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                                  // cmd_mux_002:src_channel -> periph_pb_cpu_0_s0_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                            // cmd_mux_002:src_startofpacket -> periph_pb_cpu_0_s0_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                              // cmd_mux_002:src_endofpacket -> periph_pb_cpu_0_s0_burst_adapter:sink0_endofpacket
	wire          router_006_src_valid;                                                     // router_006:src_valid -> fpga_m2ocm_pb_s0_rsp_width_adapter:in_valid
	wire  [242:0] router_006_src_data;                                                      // router_006:src_data -> fpga_m2ocm_pb_s0_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                     // fpga_m2ocm_pb_s0_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [3:0] router_006_src_channel;                                                   // router_006:src_channel -> fpga_m2ocm_pb_s0_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                             // router_006:src_startofpacket -> fpga_m2ocm_pb_s0_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                               // router_006:src_endofpacket -> fpga_m2ocm_pb_s0_rsp_width_adapter:in_endofpacket
	wire          fpga_m2ocm_pb_s0_rsp_width_adapter_src_valid;                             // fpga_m2ocm_pb_s0_rsp_width_adapter:out_valid -> rsp_demux_003:sink_valid
	wire  [134:0] fpga_m2ocm_pb_s0_rsp_width_adapter_src_data;                              // fpga_m2ocm_pb_s0_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          fpga_m2ocm_pb_s0_rsp_width_adapter_src_ready;                             // rsp_demux_003:sink_ready -> fpga_m2ocm_pb_s0_rsp_width_adapter:out_ready
	wire    [3:0] fpga_m2ocm_pb_s0_rsp_width_adapter_src_channel;                           // fpga_m2ocm_pb_s0_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	wire          fpga_m2ocm_pb_s0_rsp_width_adapter_src_startofpacket;                     // fpga_m2ocm_pb_s0_rsp_width_adapter:out_startofpacket -> rsp_demux_003:sink_startofpacket
	wire          fpga_m2ocm_pb_s0_rsp_width_adapter_src_endofpacket;                       // fpga_m2ocm_pb_s0_rsp_width_adapter:out_endofpacket -> rsp_demux_003:sink_endofpacket
	wire          cmd_mux_003_src_valid;                                                    // cmd_mux_003:src_valid -> fpga_m2ocm_pb_s0_cmd_width_adapter:in_valid
	wire  [134:0] cmd_mux_003_src_data;                                                     // cmd_mux_003:src_data -> fpga_m2ocm_pb_s0_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                    // fpga_m2ocm_pb_s0_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                                  // cmd_mux_003:src_channel -> fpga_m2ocm_pb_s0_cmd_width_adapter:in_channel
	wire          cmd_mux_003_src_startofpacket;                                            // cmd_mux_003:src_startofpacket -> fpga_m2ocm_pb_s0_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                              // cmd_mux_003:src_endofpacket -> fpga_m2ocm_pb_s0_cmd_width_adapter:in_endofpacket
	wire          fpga_m2ocm_pb_s0_cmd_width_adapter_src_valid;                             // fpga_m2ocm_pb_s0_cmd_width_adapter:out_valid -> fpga_m2ocm_pb_s0_burst_adapter:sink0_valid
	wire  [242:0] fpga_m2ocm_pb_s0_cmd_width_adapter_src_data;                              // fpga_m2ocm_pb_s0_cmd_width_adapter:out_data -> fpga_m2ocm_pb_s0_burst_adapter:sink0_data
	wire          fpga_m2ocm_pb_s0_cmd_width_adapter_src_ready;                             // fpga_m2ocm_pb_s0_burst_adapter:sink0_ready -> fpga_m2ocm_pb_s0_cmd_width_adapter:out_ready
	wire    [3:0] fpga_m2ocm_pb_s0_cmd_width_adapter_src_channel;                           // fpga_m2ocm_pb_s0_cmd_width_adapter:out_channel -> fpga_m2ocm_pb_s0_burst_adapter:sink0_channel
	wire          fpga_m2ocm_pb_s0_cmd_width_adapter_src_startofpacket;                     // fpga_m2ocm_pb_s0_cmd_width_adapter:out_startofpacket -> fpga_m2ocm_pb_s0_burst_adapter:sink0_startofpacket
	wire          fpga_m2ocm_pb_s0_cmd_width_adapter_src_endofpacket;                       // fpga_m2ocm_pb_s0_cmd_width_adapter:out_endofpacket -> fpga_m2ocm_pb_s0_burst_adapter:sink0_endofpacket
	wire    [0:0] jtg_mst_fpga_m_master_limiter_cmd_src_valid;                              // jtg_mst_fpga_m_master_limiter:cmd_src_valid -> limiter_pipeline:in_valid
	wire  [134:0] jtg_mst_fpga_m_master_limiter_cmd_src_data;                               // jtg_mst_fpga_m_master_limiter:cmd_src_data -> limiter_pipeline:in_data
	wire          jtg_mst_fpga_m_master_limiter_cmd_src_ready;                              // limiter_pipeline:in_ready -> jtg_mst_fpga_m_master_limiter:cmd_src_ready
	wire    [3:0] jtg_mst_fpga_m_master_limiter_cmd_src_channel;                            // jtg_mst_fpga_m_master_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	wire          jtg_mst_fpga_m_master_limiter_cmd_src_startofpacket;                      // jtg_mst_fpga_m_master_limiter:cmd_src_startofpacket -> limiter_pipeline:in_startofpacket
	wire          jtg_mst_fpga_m_master_limiter_cmd_src_endofpacket;                        // jtg_mst_fpga_m_master_limiter:cmd_src_endofpacket -> limiter_pipeline:in_endofpacket
	wire          limiter_pipeline_source0_valid;                                           // limiter_pipeline:out_valid -> cmd_demux:sink_valid
	wire  [134:0] limiter_pipeline_source0_data;                                            // limiter_pipeline:out_data -> cmd_demux:sink_data
	...
	wire  [134:0] rsp_mux_src_data;                                                         // rsp_mux:src_data -> limiter_pipeline_001:in_data
	...
	wire          limiter_pipeline_001_source0_valid;                                       // limiter_pipeline_001:out_valid -> jtg_mst_fpga_m_master_limiter:rsp_sink_valid
	wire  [134:0] limiter_pipeline_001_source0_data;                                        // limiter_pipeline_001:out_data -> jtg_mst_fpga_m_master_limiter:rsp_sink_data
	wire          limiter_pipeline_001_source0_ready;                                       // jtg_mst_fpga_m_master_limiter:rsp_sink_ready -> limiter_pipeline_001:out_ready
	wire    [3:0] limiter_pipeline_001_source0_channel;                                     // limiter_pipeline_001:out_channel -> jtg_mst_fpga_m_master_limiter:rsp_sink_channel
	wire          limiter_pipeline_001_source0_startofpacket;                               // limiter_pipeline_001:out_startofpacket -> jtg_mst_fpga_m_master_limiter:rsp_sink_startofpacket
	wire          limiter_pipeline_001_source0_endofpacket;                                 // limiter_pipeline_001:out_endofpacket -> jtg_mst_fpga_m_master_limiter:rsp_sink_endofpacket
	wire    [0:0] agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_valid;                    // agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_src_valid -> limiter_pipeline_002:in_valid
	wire  [134:0] agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_data;                     // agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_src_data -> limiter_pipeline_002:in_data
	wire          agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_ready;                    // limiter_pipeline_002:in_ready -> agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_src_ready
	wire    [3:0] agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel;                  // agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_src_channel -> limiter_pipeline_002:in_channel
	wire          agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_startofpacket;            // agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_src_startofpacket -> limiter_pipeline_002:in_startofpacket
	wire          agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_endofpacket;              // agilex_hps_h2f_lw_axi_master_wr_limiter:cmd_src_endofpacket -> limiter_pipeline_002:in_endofpacket
	wire          limiter_pipeline_002_source0_valid;                                       // limiter_pipeline_002:out_valid -> cmd_demux_001:sink_valid
	wire  [134:0] limiter_pipeline_002_source0_data;                                        // limiter_pipeline_002:out_data -> cmd_demux_001:sink_data
	...
	wire  [134:0] rsp_mux_001_src_data;                                                     // rsp_mux_001:src_data -> limiter_pipeline_003:in_data
	...
	wire          limiter_pipeline_003_source0_valid;                                       // limiter_pipeline_003:out_valid -> agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_sink_valid
	wire  [134:0] limiter_pipeline_003_source0_data;                                        // limiter_pipeline_003:out_data -> agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_sink_data
	wire          limiter_pipeline_003_source0_ready;                                       // agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_sink_ready -> limiter_pipeline_003:out_ready
	wire    [3:0] limiter_pipeline_003_source0_channel;                                     // limiter_pipeline_003:out_channel -> agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_sink_channel
	wire          limiter_pipeline_003_source0_startofpacket;                               // limiter_pipeline_003:out_startofpacket -> agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_sink_startofpacket
	wire          limiter_pipeline_003_source0_endofpacket;                                 // limiter_pipeline_003:out_endofpacket -> agilex_hps_h2f_lw_axi_master_wr_limiter:rsp_sink_endofpacket
	wire    [0:0] agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_valid;                    // agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_src_valid -> limiter_pipeline_004:in_valid
	wire  [134:0] agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_data;                     // agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_src_data -> limiter_pipeline_004:in_data
	wire          agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_ready;                    // limiter_pipeline_004:in_ready -> agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_src_ready
	wire    [3:0] agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel;                  // agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_src_channel -> limiter_pipeline_004:in_channel
	wire          agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_startofpacket;            // agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_src_startofpacket -> limiter_pipeline_004:in_startofpacket
	wire          agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_endofpacket;              // agilex_hps_h2f_lw_axi_master_rd_limiter:cmd_src_endofpacket -> limiter_pipeline_004:in_endofpacket
	...
	wire          limiter_pipeline_005_source0_valid;                                       // limiter_pipeline_005:out_valid -> agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_sink_valid
	wire  [134:0] limiter_pipeline_005_source0_data;                                        // limiter_pipeline_005:out_data -> agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_sink_data
	wire          limiter_pipeline_005_source0_ready;                                       // agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_sink_ready -> limiter_pipeline_005:out_ready
	wire    [3:0] limiter_pipeline_005_source0_channel;                                     // limiter_pipeline_005:out_channel -> agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_sink_channel
	wire          limiter_pipeline_005_source0_startofpacket;                               // limiter_pipeline_005:out_startofpacket -> agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_sink_startofpacket
	wire          limiter_pipeline_005_source0_endofpacket;                                 // limiter_pipeline_005:out_endofpacket -> agilex_hps_h2f_lw_axi_master_rd_limiter:rsp_sink_endofpacket
	wire          sysid_control_slave_burst_adapter_source0_valid;                          // sysid_control_slave_burst_adapter:source0_valid -> agent_pipeline:in_valid
	wire  [134:0] sysid_control_slave_burst_adapter_source0_data;                           // sysid_control_slave_burst_adapter:source0_data -> agent_pipeline:in_data
	wire          sysid_control_slave_burst_adapter_source0_ready;                          // agent_pipeline:in_ready -> sysid_control_slave_burst_adapter:source0_ready
	wire    [3:0] sysid_control_slave_burst_adapter_source0_channel;                        // sysid_control_slave_burst_adapter:source0_channel -> agent_pipeline:in_channel
	wire          sysid_control_slave_burst_adapter_source0_startofpacket;                  // sysid_control_slave_burst_adapter:source0_startofpacket -> agent_pipeline:in_startofpacket
	wire          sysid_control_slave_burst_adapter_source0_endofpacket;                    // sysid_control_slave_burst_adapter:source0_endofpacket -> agent_pipeline:in_endofpacket
	wire          agent_pipeline_source0_valid;                                             // agent_pipeline:out_valid -> sysid_control_slave_agent:cp_valid
	wire  [134:0] agent_pipeline_source0_data;                                              // agent_pipeline:out_data -> sysid_control_slave_agent:cp_data
	wire          agent_pipeline_source0_ready;                                             // sysid_control_slave_agent:cp_ready -> agent_pipeline:out_ready
	wire    [3:0] agent_pipeline_source0_channel;                                           // agent_pipeline:out_channel -> sysid_control_slave_agent:cp_channel
	...
	wire  [134:0] sysid_control_slave_agent_rp_data;                                        // sysid_control_slave_agent:rp_data -> agent_pipeline_001:in_data
	...
	wire          subsys_sgmii_emac1_csr_burst_adapter_source0_valid;                       // subsys_sgmii_emac1_csr_burst_adapter:source0_valid -> agent_pipeline_002:in_valid
	wire  [134:0] subsys_sgmii_emac1_csr_burst_adapter_source0_data;                        // subsys_sgmii_emac1_csr_burst_adapter:source0_data -> agent_pipeline_002:in_data
	wire          subsys_sgmii_emac1_csr_burst_adapter_source0_ready;                       // agent_pipeline_002:in_ready -> subsys_sgmii_emac1_csr_burst_adapter:source0_ready
	wire    [3:0] subsys_sgmii_emac1_csr_burst_adapter_source0_channel;                     // subsys_sgmii_emac1_csr_burst_adapter:source0_channel -> agent_pipeline_002:in_channel
	wire          subsys_sgmii_emac1_csr_burst_adapter_source0_startofpacket;               // subsys_sgmii_emac1_csr_burst_adapter:source0_startofpacket -> agent_pipeline_002:in_startofpacket
	wire          subsys_sgmii_emac1_csr_burst_adapter_source0_endofpacket;                 // subsys_sgmii_emac1_csr_burst_adapter:source0_endofpacket -> agent_pipeline_002:in_endofpacket
	wire          agent_pipeline_002_source0_valid;                                         // agent_pipeline_002:out_valid -> subsys_sgmii_emac1_csr_agent:cp_valid
	wire  [134:0] agent_pipeline_002_source0_data;                                          // agent_pipeline_002:out_data -> subsys_sgmii_emac1_csr_agent:cp_data
	wire          agent_pipeline_002_source0_ready;                                         // subsys_sgmii_emac1_csr_agent:cp_ready -> agent_pipeline_002:out_ready
	wire    [3:0] agent_pipeline_002_source0_channel;                                       // agent_pipeline_002:out_channel -> subsys_sgmii_emac1_csr_agent:cp_channel
	wire          agent_pipeline_002_source0_startofpacket;                                 // agent_pipeline_002:out_startofpacket -> subsys_sgmii_emac1_csr_agent:cp_startofpacket
	wire          agent_pipeline_002_source0_endofpacket;                                   // agent_pipeline_002:out_endofpacket -> subsys_sgmii_emac1_csr_agent:cp_endofpacket
	wire          subsys_sgmii_emac1_csr_agent_rp_valid;                                    // subsys_sgmii_emac1_csr_agent:rp_valid -> agent_pipeline_003:in_valid
	wire  [134:0] subsys_sgmii_emac1_csr_agent_rp_data;                                     // subsys_sgmii_emac1_csr_agent:rp_data -> agent_pipeline_003:in_data
	wire          subsys_sgmii_emac1_csr_agent_rp_ready;                                    // agent_pipeline_003:in_ready -> subsys_sgmii_emac1_csr_agent:rp_ready
	wire          subsys_sgmii_emac1_csr_agent_rp_startofpacket;                            // subsys_sgmii_emac1_csr_agent:rp_startofpacket -> agent_pipeline_003:in_startofpacket
	wire          subsys_sgmii_emac1_csr_agent_rp_endofpacket;                              // subsys_sgmii_emac1_csr_agent:rp_endofpacket -> agent_pipeline_003:in_endofpacket
	...
	wire          periph_pb_cpu_0_s0_burst_adapter_source0_valid;                           // periph_pb_cpu_0_s0_burst_adapter:source0_valid -> agent_pipeline_004:in_valid
	wire  [134:0] periph_pb_cpu_0_s0_burst_adapter_source0_data;                            // periph_pb_cpu_0_s0_burst_adapter:source0_data -> agent_pipeline_004:in_data
	wire          periph_pb_cpu_0_s0_burst_adapter_source0_ready;                           // agent_pipeline_004:in_ready -> periph_pb_cpu_0_s0_burst_adapter:source0_ready
	wire    [3:0] periph_pb_cpu_0_s0_burst_adapter_source0_channel;                         // periph_pb_cpu_0_s0_burst_adapter:source0_channel -> agent_pipeline_004:in_channel
	wire          periph_pb_cpu_0_s0_burst_adapter_source0_startofpacket;                   // periph_pb_cpu_0_s0_burst_adapter:source0_startofpacket -> agent_pipeline_004:in_startofpacket
	wire          periph_pb_cpu_0_s0_burst_adapter_source0_endofpacket;                     // periph_pb_cpu_0_s0_burst_adapter:source0_endofpacket -> agent_pipeline_004:in_endofpacket
	wire          agent_pipeline_004_source0_valid;                                         // agent_pipeline_004:out_valid -> periph_pb_cpu_0_s0_agent:cp_valid
	wire  [134:0] agent_pipeline_004_source0_data;                                          // agent_pipeline_004:out_data -> periph_pb_cpu_0_s0_agent:cp_data
	wire          agent_pipeline_004_source0_ready;                                         // periph_pb_cpu_0_s0_agent:cp_ready -> agent_pipeline_004:out_ready
	wire    [3:0] agent_pipeline_004_source0_channel;                                       // agent_pipeline_004:out_channel -> periph_pb_cpu_0_s0_agent:cp_channel
	wire          agent_pipeline_004_source0_startofpacket;                                 // agent_pipeline_004:out_startofpacket -> periph_pb_cpu_0_s0_agent:cp_startofpacket
	wire          agent_pipeline_004_source0_endofpacket;                                   // agent_pipeline_004:out_endofpacket -> periph_pb_cpu_0_s0_agent:cp_endofpacket
	wire          periph_pb_cpu_0_s0_agent_rp_valid;                                        // periph_pb_cpu_0_s0_agent:rp_valid -> agent_pipeline_005:in_valid
	wire  [134:0] periph_pb_cpu_0_s0_agent_rp_data;                                         // periph_pb_cpu_0_s0_agent:rp_data -> agent_pipeline_005:in_data
	wire          periph_pb_cpu_0_s0_agent_rp_ready;                                        // agent_pipeline_005:in_ready -> periph_pb_cpu_0_s0_agent:rp_ready
	wire          periph_pb_cpu_0_s0_agent_rp_startofpacket;                                // periph_pb_cpu_0_s0_agent:rp_startofpacket -> agent_pipeline_005:in_startofpacket
	wire          periph_pb_cpu_0_s0_agent_rp_endofpacket;                                  // periph_pb_cpu_0_s0_agent:rp_endofpacket -> agent_pipeline_005:in_endofpacket
	wire          agent_pipeline_005_source0_valid;                                         // agent_pipeline_005:out_valid -> router_005:sink_valid
	wire  [134:0] agent_pipeline_005_source0_data;                                          // agent_pipeline_005:out_data -> router_005:sink_data
	...
	wire          fpga_m2ocm_pb_s0_burst_adapter_source0_valid;                             // fpga_m2ocm_pb_s0_burst_adapter:source0_valid -> agent_pipeline_006:in_valid
	wire  [242:0] fpga_m2ocm_pb_s0_burst_adapter_source0_data;                              // fpga_m2ocm_pb_s0_burst_adapter:source0_data -> agent_pipeline_006:in_data
	wire          fpga_m2ocm_pb_s0_burst_adapter_source0_ready;                             // agent_pipeline_006:in_ready -> fpga_m2ocm_pb_s0_burst_adapter:source0_ready
	wire    [3:0] fpga_m2ocm_pb_s0_burst_adapter_source0_channel;                           // fpga_m2ocm_pb_s0_burst_adapter:source0_channel -> agent_pipeline_006:in_channel
	wire          fpga_m2ocm_pb_s0_burst_adapter_source0_startofpacket;                     // fpga_m2ocm_pb_s0_burst_adapter:source0_startofpacket -> agent_pipeline_006:in_startofpacket
	wire          fpga_m2ocm_pb_s0_burst_adapter_source0_endofpacket;                       // fpga_m2ocm_pb_s0_burst_adapter:source0_endofpacket -> agent_pipeline_006:in_endofpacket
	wire          agent_pipeline_006_source0_valid;                                         // agent_pipeline_006:out_valid -> fpga_m2ocm_pb_s0_agent:cp_valid
	wire  [242:0] agent_pipeline_006_source0_data;                                          // agent_pipeline_006:out_data -> fpga_m2ocm_pb_s0_agent:cp_data
	wire          agent_pipeline_006_source0_ready;                                         // fpga_m2ocm_pb_s0_agent:cp_ready -> agent_pipeline_006:out_ready
	wire    [3:0] agent_pipeline_006_source0_channel;                                       // agent_pipeline_006:out_channel -> fpga_m2ocm_pb_s0_agent:cp_channel
	wire          agent_pipeline_006_source0_startofpacket;                                 // agent_pipeline_006:out_startofpacket -> fpga_m2ocm_pb_s0_agent:cp_startofpacket
	wire          agent_pipeline_006_source0_endofpacket;                                   // agent_pipeline_006:out_endofpacket -> fpga_m2ocm_pb_s0_agent:cp_endofpacket
	wire          fpga_m2ocm_pb_s0_agent_rp_valid;                                          // fpga_m2ocm_pb_s0_agent:rp_valid -> agent_pipeline_007:in_valid
	wire  [242:0] fpga_m2ocm_pb_s0_agent_rp_data;                                           // fpga_m2ocm_pb_s0_agent:rp_data -> agent_pipeline_007:in_data
	wire          fpga_m2ocm_pb_s0_agent_rp_ready;                                          // agent_pipeline_007:in_ready -> fpga_m2ocm_pb_s0_agent:rp_ready
	wire          fpga_m2ocm_pb_s0_agent_rp_startofpacket;                                  // fpga_m2ocm_pb_s0_agent:rp_startofpacket -> agent_pipeline_007:in_startofpacket
	wire          fpga_m2ocm_pb_s0_agent_rp_endofpacket;                                    // fpga_m2ocm_pb_s0_agent:rp_endofpacket -> agent_pipeline_007:in_endofpacket
	wire          agent_pipeline_007_source0_valid;                                         // agent_pipeline_007:out_valid -> router_006:sink_valid
	wire  [242:0] agent_pipeline_007_source0_data;                                          // agent_pipeline_007:out_data -> router_006:sink_data
	...
	wire  [134:0] cmd_demux_src2_data;                                                      // cmd_demux:src2_data -> mux_pipeline_006:in_data
	...
	wire  [134:0] mux_pipeline_006_source0_data;                                            // mux_pipeline_006:out_data -> cmd_mux_002:sink0_data
	...
	wire  [134:0] cmd_demux_001_src2_data;                                                  // cmd_demux_001:src2_data -> mux_pipeline_007:in_data
	...
	wire  [134:0] mux_pipeline_007_source0_data;                                            // mux_pipeline_007:out_data -> cmd_mux_002:sink1_data
	...
	wire  [134:0] cmd_demux_002_src2_data;                                                  // cmd_demux_002:src2_data -> mux_pipeline_008:in_data
	...
	wire  [134:0] mux_pipeline_008_source0_data;                                            // mux_pipeline_008:out_data -> cmd_mux_002:sink2_data
	...
	wire  [134:0] cmd_demux_src3_data;                                                      // cmd_demux:src3_data -> mux_pipeline_009:in_data
	...
	wire  [134:0] mux_pipeline_009_source0_data;                                            // mux_pipeline_009:out_data -> cmd_mux_003:sink0_data
	...
	wire  [134:0] rsp_demux_src0_data;                                                      // rsp_demux:src0_data -> mux_pipeline_010:in_data
	...
	wire  [134:0] mux_pipeline_010_source0_data;                                            // mux_pipeline_010:out_data -> rsp_mux:sink0_data
	...
	wire  [134:0] rsp_demux_001_src0_data;                                                  // rsp_demux_001:src0_data -> mux_pipeline_011:in_data
	...
	wire  [134:0] mux_pipeline_011_source0_data;                                            // mux_pipeline_011:out_data -> rsp_mux:sink1_data
	...
	wire  [134:0] rsp_demux_002_src0_data;                                                  // rsp_demux_002:src0_data -> mux_pipeline_012:in_data
	...
	wire  [134:0] mux_pipeline_012_source0_data;                                            // mux_pipeline_012:out_data -> rsp_mux:sink2_data
	...
	wire  [134:0] rsp_demux_003_src0_data;                                                  // rsp_demux_003:src0_data -> mux_pipeline_013:in_data
	wire          rsp_demux_003_src0_ready;                                                 // mux_pipeline_013:in_ready -> rsp_demux_003:src0_ready
	wire    [3:0] rsp_demux_003_src0_channel;                                               // rsp_demux_003:src0_channel -> mux_pipeline_013:in_channel
	...
	wire  [134:0] mux_pipeline_013_source0_data;                                            // mux_pipeline_013:out_data -> rsp_mux:sink3_data
	wire          mux_pipeline_013_source0_ready;                                           // rsp_mux:sink3_ready -> mux_pipeline_013:out_ready
	wire    [3:0] mux_pipeline_013_source0_channel;                                         // mux_pipeline_013:out_channel -> rsp_mux:sink3_channel
	...
	wire  [134:0] rsp_demux_src1_data;                                                      // rsp_demux:src1_data -> mux_pipeline_014:in_data
	wire          rsp_demux_src1_ready;                                                     // mux_pipeline_014:in_ready -> rsp_demux:src1_ready
	wire    [3:0] rsp_demux_src1_channel;                                                   // rsp_demux:src1_channel -> mux_pipeline_014:in_channel
	...
	wire  [134:0] mux_pipeline_014_source0_data;                                            // mux_pipeline_014:out_data -> rsp_mux_001:sink0_data
	wire          mux_pipeline_014_source0_ready;                                           // rsp_mux_001:sink0_ready -> mux_pipeline_014:out_ready
	wire    [3:0] mux_pipeline_014_source0_channel;                                         // mux_pipeline_014:out_channel -> rsp_mux_001:sink0_channel
	...
	wire  [134:0] rsp_demux_001_src1_data;                                                  // rsp_demux_001:src1_data -> mux_pipeline_015:in_data
	wire          rsp_demux_001_src1_ready;                                                 // mux_pipeline_015:in_ready -> rsp_demux_001:src1_ready
	wire    [3:0] rsp_demux_001_src1_channel;                                               // rsp_demux_001:src1_channel -> mux_pipeline_015:in_channel
	...
	wire  [134:0] mux_pipeline_015_source0_data;                                            // mux_pipeline_015:out_data -> rsp_mux_001:sink1_data
	wire          mux_pipeline_015_source0_ready;                                           // rsp_mux_001:sink1_ready -> mux_pipeline_015:out_ready
	wire    [3:0] mux_pipeline_015_source0_channel;                                         // mux_pipeline_015:out_channel -> rsp_mux_001:sink1_channel
	...
	wire  [134:0] rsp_demux_002_src1_data;                                                  // rsp_demux_002:src1_data -> mux_pipeline_016:in_data
	wire          rsp_demux_002_src1_ready;                                                 // mux_pipeline_016:in_ready -> rsp_demux_002:src1_ready
	wire    [3:0] rsp_demux_002_src1_channel;                                               // rsp_demux_002:src1_channel -> mux_pipeline_016:in_channel
	...
	wire  [134:0] mux_pipeline_016_source0_data;                                            // mux_pipeline_016:out_data -> rsp_mux_001:sink2_data
	wire          mux_pipeline_016_source0_ready;                                           // rsp_mux_001:sink2_ready -> mux_pipeline_016:out_ready
	wire    [3:0] mux_pipeline_016_source0_channel;                                         // mux_pipeline_016:out_channel -> rsp_mux_001:sink2_channel
	...
	wire  [134:0] rsp_demux_src2_data;                                                      // rsp_demux:src2_data -> mux_pipeline_017:in_data
	wire          rsp_demux_src2_ready;                                                     // mux_pipeline_017:in_ready -> rsp_demux:src2_ready
	wire    [3:0] rsp_demux_src2_channel;                                                   // rsp_demux:src2_channel -> mux_pipeline_017:in_channel
	...
	wire  [134:0] mux_pipeline_017_source0_data;                                            // mux_pipeline_017:out_data -> rsp_mux_002:sink0_data
	wire          mux_pipeline_017_source0_ready;                                           // rsp_mux_002:sink0_ready -> mux_pipeline_017:out_ready
	wire    [3:0] mux_pipeline_017_source0_channel;                                         // mux_pipeline_017:out_channel -> rsp_mux_002:sink0_channel
	...
	wire  [134:0] rsp_demux_001_src2_data;                                                  // rsp_demux_001:src2_data -> mux_pipeline_018:in_data
	wire          rsp_demux_001_src2_ready;                                                 // mux_pipeline_018:in_ready -> rsp_demux_001:src2_ready
	wire    [3:0] rsp_demux_001_src2_channel;                                               // rsp_demux_001:src2_channel -> mux_pipeline_018:in_channel
	...
	wire  [134:0] mux_pipeline_018_source0_data;                                            // mux_pipeline_018:out_data -> rsp_mux_002:sink1_data
	wire          mux_pipeline_018_source0_ready;                                           // rsp_mux_002:sink1_ready -> mux_pipeline_018:out_ready
	wire    [3:0] mux_pipeline_018_source0_channel;                                         // mux_pipeline_018:out_channel -> rsp_mux_002:sink1_channel
	...
	wire  [134:0] rsp_demux_002_src2_data;                                                  // rsp_demux_002:src2_data -> mux_pipeline_019:in_data
	wire          rsp_demux_002_src2_ready;                                                 // mux_pipeline_019:in_ready -> rsp_demux_002:src2_ready
	wire    [3:0] rsp_demux_002_src2_channel;                                               // rsp_demux_002:src2_channel -> mux_pipeline_019:in_channel
	...
	wire  [134:0] mux_pipeline_019_source0_data;                                            // mux_pipeline_019:out_data -> rsp_mux_002:sink2_data
	wire          mux_pipeline_019_source0_ready;                                           // rsp_mux_002:sink2_ready -> mux_pipeline_019:out_ready
	wire    [3:0] mux_pipeline_019_source0_channel;                                         // mux_pipeline_019:out_channel -> rsp_mux_002:sink2_channel
	...
	qsys_top_altera_merlin_slave_translator_191_x56fcki #(
		...
		.clk                    (clk_100_out_clk_clk),                        //   input,   width = 1,                      clk.clk
		.reset                  (jtg_mst_reset_reset_bridge_in_reset_reset),  //   input,   width = 1,                    reset.reset
		.uav_address            (sysid_control_slave_agent_m0_address),       //   input,  width = 32, avalon_universal_slave_0.address
	...
	qsys_top_altera_merlin_slave_translator_191_x56fcki #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (1)
	) subsys_sgmii_emac1_csr_translator (
		.clk                    (clk_100_out_clk_clk),                           //   input,   width = 1,                      clk.clk
		.reset                  (jtg_mst_reset_reset_bridge_in_reset_reset),     //   input,   width = 1,                    reset.reset
		.uav_address            (subsys_sgmii_emac1_csr_agent_m0_address),       //   input,  width = 32, avalon_universal_slave_0.address
		.uav_burstcount         (subsys_sgmii_emac1_csr_agent_m0_burstcount),    //   input,   width = 3,                         .burstcount
		.uav_read               (subsys_sgmii_emac1_csr_agent_m0_read),          //   input,   width = 1,                         .read
		.uav_write              (subsys_sgmii_emac1_csr_agent_m0_write),         //   input,   width = 1,                         .write
		.uav_waitrequest        (subsys_sgmii_emac1_csr_agent_m0_waitrequest),   //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (subsys_sgmii_emac1_csr_agent_m0_readdatavalid), //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (subsys_sgmii_emac1_csr_agent_m0_byteenable),    //   input,   width = 4,                         .byteenable
		.uav_readdata           (subsys_sgmii_emac1_csr_agent_m0_readdata),      //  output,  width = 32,                         .readdata
		.uav_writedata          (subsys_sgmii_emac1_csr_agent_m0_writedata),     //   input,  width = 32,                         .writedata
		.uav_lock               (subsys_sgmii_emac1_csr_agent_m0_lock),          //   input,   width = 1,                         .lock
		.uav_debugaccess        (subsys_sgmii_emac1_csr_agent_m0_debugaccess),   //   input,   width = 1,                         .debugaccess
		.av_address             (subsys_sgmii_emac1_csr_address),                //  output,   width = 7,      avalon_anti_slave_0.address
		.av_write               (subsys_sgmii_emac1_csr_write),                  //  output,   width = 1,                         .write
		.av_read                (subsys_sgmii_emac1_csr_read),                   //  output,   width = 1,                         .read
		.av_readdata            (subsys_sgmii_emac1_csr_readdata),               //   input,  width = 32,                         .readdata
		.av_writedata           (subsys_sgmii_emac1_csr_writedata),              //  output,  width = 32,                         .writedata
		.av_burstcount          (subsys_sgmii_emac1_csr_burstcount),             //  output,   width = 1,                         .burstcount
		.av_byteenable          (subsys_sgmii_emac1_csr_byteenable),             //  output,   width = 4,                         .byteenable
		.av_readdatavalid       (subsys_sgmii_emac1_csr_readdatavalid),          //   input,   width = 1,                         .readdatavalid
		.av_waitrequest         (subsys_sgmii_emac1_csr_waitrequest),            //   input,   width = 1,                         .waitrequest
		.av_debugaccess         (subsys_sgmii_emac1_csr_debugaccess),            //  output,   width = 1,                         .debugaccess
		.av_begintransfer       (),                                              // (terminated),                                       
		.av_beginbursttransfer  (),                                              // (terminated),                                       
		.av_writebyteenable     (),                                              // (terminated),                                       
		.av_lock                (),                                              // (terminated),                                       
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.cp_data               (jtg_mst_fpga_m_master_agent_cp_data),                                      //  output,  width = 135,          .data
		...
		.rp_data               (jtg_mst_fpga_m_master_limiter_rsp_src_data),                               //   input,  width = 135,          .data
		.rp_channel            (jtg_mst_fpga_m_master_limiter_rsp_src_channel),                            //   input,    width = 4,          .channel
	...
	qsys_top_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_cp_data          (agilex_hps_h2f_lw_axi_master_agent_write_cp_data),              //  output,  width = 135,                 .data
		...
		.write_rp_valid         (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_valid),         //   input,    width = 1,         write_rp.valid
		.write_rp_data          (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_data),          //   input,  width = 135,                 .data
		.write_rp_channel       (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_channel),       //   input,    width = 4,                 .channel
		.write_rp_startofpacket (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_startofpacket), //   input,    width = 1,                 .startofpacket
		.write_rp_endofpacket   (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_endofpacket),   //   input,    width = 1,                 .endofpacket
		.write_rp_ready         (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_ready),         //  output,    width = 1,                 .ready
		.read_cp_valid          (agilex_hps_h2f_lw_axi_master_agent_read_cp_valid),              //  output,    width = 1,          read_cp.valid
		.read_cp_data           (agilex_hps_h2f_lw_axi_master_agent_read_cp_data),               //  output,  width = 135,                 .data
		...
		.read_rp_valid          (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_valid),         //   input,    width = 1,          read_rp.valid
		.read_rp_data           (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_data),          //   input,  width = 135,                 .data
		.read_rp_channel        (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_channel),       //   input,    width = 4,                 .channel
		.read_rp_startofpacket  (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_startofpacket), //   input,    width = 1,                 .startofpacket
		.read_rp_endofpacket    (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_endofpacket),   //   input,    width = 1,                 .endofpacket
		.read_rp_ready          (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_ready),         //  output,    width = 1,                 .ready
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.clk                     (clk_100_out_clk_clk),                                  //   input,    width = 1,             clk.clk
		.reset                   (jtg_mst_reset_reset_bridge_in_reset_reset),            //   input,    width = 1,       clk_reset.reset
		.m0_address              (sysid_control_slave_agent_m0_address),                 //  output,   width = 32,              m0.address
		...
		.rp_data                 (sysid_control_slave_agent_rp_data),                    //  output,  width = 135,                .data
		...
		.rf_sink_data            (sysid_control_slave_agent_rsp_fifo_out_data),          //   input,  width = 136,                .data
		...
		.rf_source_data          (sysid_control_slave_agent_rf_source_data),             //  output,  width = 136,                .data
		.rdata_fifo_sink_ready   (sysid_control_slave_agent_rdata_fifo_out_ready),       //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (sysid_control_slave_agent_rdata_fifo_out_valid),       //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (sysid_control_slave_agent_rdata_fifo_out_data),        //   input,   width = 34,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (sysid_control_slave_agent_rf_source_data),                //   input,  width = 136,        in.data
		...
		.out_data          (sysid_control_slave_agent_rsp_fifo_out_data),             //  output,  width = 136,       out.data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                     //   input,   width = 1,       clk.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,   width = 1, clk_reset.reset
		.in_data           (sysid_control_slave_agent_rdata_fifo_src_data),           //   input,  width = 34,        in.data
		.in_valid          (sysid_control_slave_agent_rdata_fifo_src_valid),          //   input,   width = 1,          .valid
		.in_ready          (sysid_control_slave_agent_rdata_fifo_src_ready),          //  output,   width = 1,          .ready
		.out_data          (sysid_control_slave_agent_rdata_fifo_out_data),           //  output,  width = 34,       out.data
		.out_valid         (sysid_control_slave_agent_rdata_fifo_out_valid),          //  output,   width = 1,          .valid
		.out_ready         (sysid_control_slave_agent_rdata_fifo_out_ready),          //   input,   width = 1,          .ready
		.csr_address       (2'b00),                                                   // (terminated),                        
		.csr_read          (1'b0),                                                    // (terminated),                        
		.csr_write         (1'b0),                                                    // (terminated),                        
		.csr_readdata      (),                                                        // (terminated),                        
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.clk                     (clk_100_out_clk_clk),                                     //   input,    width = 1,             clk.clk
		.reset                   (jtg_mst_reset_reset_bridge_in_reset_reset),               //   input,    width = 1,       clk_reset.reset
		.m0_address              (subsys_sgmii_emac1_csr_agent_m0_address),                 //  output,   width = 32,              m0.address
		.m0_burstcount           (subsys_sgmii_emac1_csr_agent_m0_burstcount),              //  output,    width = 3,                .burstcount
		.m0_byteenable           (subsys_sgmii_emac1_csr_agent_m0_byteenable),              //  output,    width = 4,                .byteenable
		.m0_debugaccess          (subsys_sgmii_emac1_csr_agent_m0_debugaccess),             //  output,    width = 1,                .debugaccess
		.m0_lock                 (subsys_sgmii_emac1_csr_agent_m0_lock),                    //  output,    width = 1,                .lock
		.m0_readdata             (subsys_sgmii_emac1_csr_agent_m0_readdata),                //   input,   width = 32,                .readdata
		.m0_readdatavalid        (subsys_sgmii_emac1_csr_agent_m0_readdatavalid),           //   input,    width = 1,                .readdatavalid
		.m0_read                 (subsys_sgmii_emac1_csr_agent_m0_read),                    //  output,    width = 1,                .read
		.m0_waitrequest          (subsys_sgmii_emac1_csr_agent_m0_waitrequest),             //   input,    width = 1,                .waitrequest
		.m0_writedata            (subsys_sgmii_emac1_csr_agent_m0_writedata),               //  output,   width = 32,                .writedata
		.m0_write                (subsys_sgmii_emac1_csr_agent_m0_write),                   //  output,    width = 1,                .write
		.rp_endofpacket          (subsys_sgmii_emac1_csr_agent_rp_endofpacket),             //  output,    width = 1,              rp.endofpacket
		.rp_ready                (subsys_sgmii_emac1_csr_agent_rp_ready),                   //   input,    width = 1,                .ready
		.rp_valid                (subsys_sgmii_emac1_csr_agent_rp_valid),                   //  output,    width = 1,                .valid
		.rp_data                 (subsys_sgmii_emac1_csr_agent_rp_data),                    //  output,  width = 135,                .data
		.rp_startofpacket        (subsys_sgmii_emac1_csr_agent_rp_startofpacket),           //  output,    width = 1,                .startofpacket
		...
		.rf_sink_ready           (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_ready),         //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_valid),         //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_startofpacket), //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_endofpacket),   //   input,    width = 1,                .endofpacket
		.rf_sink_data            (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_data),          //   input,  width = 136,                .data
		.rf_source_ready         (subsys_sgmii_emac1_csr_agent_rf_source_ready),            //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (subsys_sgmii_emac1_csr_agent_rf_source_valid),            //  output,    width = 1,                .valid
		.rf_source_startofpacket (subsys_sgmii_emac1_csr_agent_rf_source_startofpacket),    //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (subsys_sgmii_emac1_csr_agent_rf_source_endofpacket),      //  output,    width = 1,                .endofpacket
		.rf_source_data          (subsys_sgmii_emac1_csr_agent_rf_source_data),             //  output,  width = 136,                .data
		.rdata_fifo_sink_ready   (subsys_sgmii_emac1_csr_agent_rdata_fifo_out_ready),       //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (subsys_sgmii_emac1_csr_agent_rdata_fifo_out_valid),       //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (subsys_sgmii_emac1_csr_agent_rdata_fifo_out_data),        //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (subsys_sgmii_emac1_csr_agent_rdata_fifo_src_ready),       //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (subsys_sgmii_emac1_csr_agent_rdata_fifo_src_valid),       //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (subsys_sgmii_emac1_csr_agent_rdata_fifo_src_data),        //  output,   width = 34,                .data
		.m0_response             (2'b00),                                                   // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                                    // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                     // (terminated),                               
	);
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (subsys_sgmii_emac1_csr_agent_rf_source_data),             //   input,  width = 136,        in.data
		.in_valid          (subsys_sgmii_emac1_csr_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (subsys_sgmii_emac1_csr_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (subsys_sgmii_emac1_csr_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (subsys_sgmii_emac1_csr_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_data),          //  output,  width = 136,       out.data
		.out_valid         (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (subsys_sgmii_emac1_csr_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                                   // (terminated),                         
		.csr_read          (1'b0),                                                    // (terminated),                         
		.csr_write         (1'b0),                                                    // (terminated),                         
		.csr_readdata      (),                                                        // (terminated),                         
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                     //   input,   width = 1,       clk.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,   width = 1, clk_reset.reset
		.in_data           (subsys_sgmii_emac1_csr_agent_rdata_fifo_src_data),        //   input,  width = 34,        in.data
		.in_valid          (subsys_sgmii_emac1_csr_agent_rdata_fifo_src_valid),       //   input,   width = 1,          .valid
		.in_ready          (subsys_sgmii_emac1_csr_agent_rdata_fifo_src_ready),       //  output,   width = 1,          .ready
		.out_data          (subsys_sgmii_emac1_csr_agent_rdata_fifo_out_data),        //  output,  width = 34,       out.data
		.out_valid         (subsys_sgmii_emac1_csr_agent_rdata_fifo_out_valid),       //  output,   width = 1,          .valid
		.out_ready         (subsys_sgmii_emac1_csr_agent_rdata_fifo_out_ready),       //   input,   width = 1,          .ready
		.csr_address       (2'b00),                                                   // (terminated),                        
		.csr_read          (1'b0),                                                    // (terminated),                        
		.csr_write         (1'b0),                                                    // (terminated),                        
		.csr_readdata      (),                                                        // (terminated),                        
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (periph_pb_cpu_0_s0_agent_rp_data),                    //  output,  width = 135,                .data
		...
		.cp_data                 (agent_pipeline_004_source0_data),                     //   input,  width = 135,                .data
		...
		.rf_sink_data            (periph_pb_cpu_0_s0_agent_rsp_fifo_out_data),          //   input,  width = 136,                .data
		...
		.rf_source_data          (periph_pb_cpu_0_s0_agent_rf_source_data),             //  output,  width = 136,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (periph_pb_cpu_0_s0_agent_rf_source_data),                 //   input,  width = 136,        in.data
		...
		.out_data          (periph_pb_cpu_0_s0_agent_rsp_fifo_out_data),              //  output,  width = 136,       out.data
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (fpga_m2ocm_pb_s0_agent_rp_data),                    //  output,  width = 243,                .data
		...
		.cp_data                 (agent_pipeline_006_source0_data),                   //   input,  width = 243,                .data
		...
		.rf_sink_data            (fpga_m2ocm_pb_s0_agent_rsp_fifo_out_data),          //   input,  width = 244,                .data
		...
		.rf_source_data          (fpga_m2ocm_pb_s0_agent_rf_source_data),             //  output,  width = 244,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                     //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (fpga_m2ocm_pb_s0_agent_rf_source_data),                   //   input,  width = 244,        in.data
		...
		.out_data          (fpga_m2ocm_pb_s0_agent_rsp_fifo_out_data),                //  output,  width = 244,       out.data
	...
	qsys_top_altera_merlin_router_1921_z4qlfra router (
		...
		.sink_data          (jtg_mst_fpga_m_master_agent_cp_data),          //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_router_1921_ppuzg3q router_001 (
		...
		.sink_data          (agilex_hps_h2f_lw_axi_master_agent_write_cp_data),          //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_router_1921_ppuzg3q router_002 (
		...
		.sink_data          (agilex_hps_h2f_lw_axi_master_agent_read_cp_data),          //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_router_1921_maa2rba router_003 (
	...
	qsys_top_altera_merlin_router_1921_maa2rba router_004 (
	...
	qsys_top_altera_merlin_router_1921_maa2rba router_005 (
		...
		.sink_data          (agent_pipeline_005_source0_data),           //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_router_1921_2jolsdq router_006 (
		...
		.sink_data          (agent_pipeline_007_source0_data),           //   input,  width = 243,          .data
		...
		.src_data           (router_006_src_data),                       //  output,  width = 243,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_data           (jtg_mst_fpga_m_master_limiter_cmd_src_data),          //  output,  width = 135,          .data
		.cmd_src_channel        (jtg_mst_fpga_m_master_limiter_cmd_src_channel),       //  output,    width = 4,          .channel
		...
		.rsp_sink_data          (limiter_pipeline_001_source0_data),                   //   input,  width = 135,          .data
		...
		.rsp_src_data           (jtg_mst_fpga_m_master_limiter_rsp_src_data),          //  output,  width = 135,          .data
		.rsp_src_channel        (jtg_mst_fpga_m_master_limiter_rsp_src_channel),       //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_ready          (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_ready),         //   input,    width = 1,   cmd_src.ready
		.cmd_src_data           (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_data),          //  output,  width = 135,          .data
		.cmd_src_channel        (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel),       //  output,    width = 4,          .channel
		.cmd_src_startofpacket  (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_startofpacket), //  output,    width = 1,          .startofpacket
		.cmd_src_endofpacket    (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_endofpacket),   //  output,    width = 1,          .endofpacket
		.cmd_src_valid          (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_valid),         //  output,    width = 1,          .valid
		...
		.rsp_sink_data          (limiter_pipeline_003_source0_data),                             //   input,  width = 135,          .data
		...
		.rsp_src_ready          (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_ready),         //   input,    width = 1,   rsp_src.ready
		.rsp_src_valid          (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_valid),         //  output,    width = 1,          .valid
		.rsp_src_data           (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_data),          //  output,  width = 135,          .data
		.rsp_src_channel        (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_channel),       //  output,    width = 4,          .channel
		.rsp_src_startofpacket  (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_startofpacket), //  output,    width = 1,          .startofpacket
		.rsp_src_endofpacket    (agilex_hps_h2f_lw_axi_master_wr_limiter_rsp_src_endofpacket)    //  output,    width = 1,          .endofpacket
	);
	...
	qsys_top_altera_merlin_traffic_limiter_191_6blplji #(
		...
		.cmd_src_ready          (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_ready),         //   input,    width = 1,   cmd_src.ready
		.cmd_src_data           (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_data),          //  output,  width = 135,          .data
		.cmd_src_channel        (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel),       //  output,    width = 4,          .channel
		.cmd_src_startofpacket  (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_startofpacket), //  output,    width = 1,          .startofpacket
		.cmd_src_endofpacket    (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_endofpacket),   //  output,    width = 1,          .endofpacket
		.cmd_src_valid          (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_valid),         //  output,    width = 1,          .valid
		...
		.rsp_src_ready          (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_ready),         //   input,    width = 1,   rsp_src.ready
		.rsp_src_valid          (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_valid),         //  output,    width = 1,          .valid
		.rsp_src_data           (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_data),          //  output,  width = 135,          .data
		.rsp_src_channel        (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_channel),       //  output,    width = 4,          .channel
		.rsp_src_startofpacket  (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_startofpacket), //  output,    width = 1,          .startofpacket
		.rsp_src_endofpacket    (agilex_hps_h2f_lw_axi_master_rd_limiter_rsp_src_endofpacket)    //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_burst_adapter_1923_rregqry #(
		.PKT_ADDR_H                (67),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (101),
		.PKT_BYTE_CNT_H            (86),
		...
		.source0_valid         (sysid_control_slave_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (sysid_control_slave_burst_adapter_source0_data),          //  output,  width = 135,          .data
		.source0_channel       (sysid_control_slave_burst_adapter_source0_channel),       //  output,    width = 4,          .channel
		.source0_startofpacket (sysid_control_slave_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (sysid_control_slave_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (sysid_control_slave_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
	...
	qsys_top_altera_merlin_burst_adapter_1923_rregqry #(
		...
		.ADAPTER_VERSION           ("new"),
		.SYNC_RESET                (1)
	) subsys_sgmii_emac1_csr_burst_adapter (
		.clk                   (clk_100_out_clk_clk),                                        //   input,    width = 1,       cr0.clk
		.reset                 (jtg_mst_reset_reset_bridge_in_reset_reset),                  //   input,    width = 1, cr0_reset.reset
		...
		.source0_valid         (subsys_sgmii_emac1_csr_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (subsys_sgmii_emac1_csr_burst_adapter_source0_data),          //  output,  width = 135,          .data
		.source0_channel       (subsys_sgmii_emac1_csr_burst_adapter_source0_channel),       //  output,    width = 4,          .channel
		.source0_startofpacket (subsys_sgmii_emac1_csr_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (subsys_sgmii_emac1_csr_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (subsys_sgmii_emac1_csr_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
	...
	qsys_top_altera_merlin_burst_adapter_1923_rregqry #(
		...
		.sink0_data            (cmd_mux_002_src_data),                                   //   input,  width = 135,          .data
		...
		.source0_data          (periph_pb_cpu_0_s0_burst_adapter_source0_data),          //  output,  width = 135,          .data
		.source0_channel       (periph_pb_cpu_0_s0_burst_adapter_source0_channel),       //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_burst_adapter_1923_k4taf2q #(
		.PKT_ADDR_H                (175),
		.PKT_ADDR_L                (144),
		.PKT_BEGIN_BURST           (209),
		.PKT_BYTE_CNT_H            (194),
		...
		.clk                   (clk_100_out_clk_clk),                                  //   input,    width = 1,       cr0.clk
		.reset                 (jtg_mst_reset_reset_bridge_in_reset_reset),            //   input,    width = 1, cr0_reset.reset
		.sink0_valid           (fpga_m2ocm_pb_s0_cmd_width_adapter_src_valid),         //   input,    width = 1,     sink0.valid
		.sink0_data            (fpga_m2ocm_pb_s0_cmd_width_adapter_src_data),          //   input,  width = 243,          .data
		.sink0_channel         (fpga_m2ocm_pb_s0_cmd_width_adapter_src_channel),       //   input,    width = 4,          .channel
		.sink0_startofpacket   (fpga_m2ocm_pb_s0_cmd_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink0_endofpacket     (fpga_m2ocm_pb_s0_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink0_ready           (fpga_m2ocm_pb_s0_cmd_width_adapter_src_ready),         //  output,    width = 1,          .ready
		.source0_valid         (fpga_m2ocm_pb_s0_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (fpga_m2ocm_pb_s0_burst_adapter_source0_data),          //  output,  width = 243,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_jd6le2i cmd_demux (
		.clk                (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (limiter_pipeline_source0_data),             //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_ovcm2wa cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                        //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset),  //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (limiter_pipeline_002_source0_data),          //   input,  width = 135,          .data
		...
		.src2_data          (cmd_demux_001_src2_data),                    //  output,  width = 135,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_ovcm2wa cmd_demux_002 (
		.clk                (clk_100_out_clk_clk),                        //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset),  //   input,    width = 1, clk_reset.reset
		...
		.src2_data          (cmd_demux_002_src2_data),                    //  output,  width = 135,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_4cgi5zq cmd_mux (
		.clk                 (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_4cgi5zq cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1921_4cgi5zq cmd_mux_002 (
		.clk                 (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_data          (mux_pipeline_008_source0_data),             //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_b3fhjwi cmd_mux_003 (
		.clk                 (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_ovcm2wa rsp_demux (
		.clk                (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_ovcm2wa rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_ovcm2wa rsp_demux_002 (
		.clk                (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src1_data          (rsp_demux_002_src1_data),                   //  output,  width = 135,          .data
		...
		.src2_data          (rsp_demux_002_src2_data),                   //  output,  width = 135,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_ocfjwla rsp_demux_003 (
		.clk                (clk_100_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset              (jtg_mst_reset_reset_bridge_in_reset_reset),            //   input,    width = 1, clk_reset.reset
		.sink_ready         (fpga_m2ocm_pb_s0_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (fpga_m2ocm_pb_s0_rsp_width_adapter_src_channel),       //   input,    width = 4,          .channel
		.sink_data          (fpga_m2ocm_pb_s0_rsp_width_adapter_src_data),          //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_hzj3svq rsp_mux (
		.clk                 (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_data          (mux_pipeline_012_source0_data),             //   input,  width = 135,          .data
		...
		.sink3_channel       (mux_pipeline_013_source0_channel),          //   input,    width = 4,          .channel
		.sink3_data          (mux_pipeline_013_source0_data),             //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_yxkt4ya rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (mux_pipeline_014_source0_channel),          //   input,    width = 4,          .channel
		.sink0_data          (mux_pipeline_014_source0_data),             //   input,  width = 135,          .data
		...
		.sink1_channel       (mux_pipeline_015_source0_channel),          //   input,    width = 4,          .channel
		.sink1_data          (mux_pipeline_015_source0_data),             //   input,  width = 135,          .data
		...
		.sink2_channel       (mux_pipeline_016_source0_channel),          //   input,    width = 4,          .channel
		.sink2_data          (mux_pipeline_016_source0_data),             //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_yxkt4ya rsp_mux_002 (
		.clk                 (clk_100_out_clk_clk),                       //   input,    width = 1,       clk.clk
		.reset               (jtg_mst_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (mux_pipeline_017_source0_channel),          //   input,    width = 4,          .channel
		.sink0_data          (mux_pipeline_017_source0_data),             //   input,  width = 135,          .data
		...
		.sink1_channel       (mux_pipeline_018_source0_channel),          //   input,    width = 4,          .channel
		.sink1_data          (mux_pipeline_018_source0_data),             //   input,  width = 135,          .data
		...
		.sink2_channel       (mux_pipeline_019_source0_channel),          //   input,    width = 4,          .channel
		.sink2_data          (mux_pipeline_019_source0_data),             //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_pbpa2vy #(
		.IN_PKT_ADDR_H                 (175),
		.IN_PKT_ADDR_L                 (144),
		.IN_PKT_DATA_H                 (127),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (router_006_src_data),                                  //   input,  width = 243,          .data
		.out_endofpacket      (fpga_m2ocm_pb_s0_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (fpga_m2ocm_pb_s0_rsp_width_adapter_src_data),          //  output,  width = 135,          .data
		.out_channel          (fpga_m2ocm_pb_s0_rsp_width_adapter_src_channel),       //  output,    width = 4,          .channel
	...
	qsys_top_altera_merlin_width_adapter_1920_kfhpo5a #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (cmd_mux_003_src_data),                                 //   input,  width = 135,          .data
		.out_endofpacket      (fpga_m2ocm_pb_s0_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (fpga_m2ocm_pb_s0_cmd_width_adapter_src_data),          //  output,  width = 243,          .data
		.out_channel          (fpga_m2ocm_pb_s0_cmd_width_adapter_src_channel),       //  output,    width = 4,          .channel
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                     //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, cr0_reset.reset
		...
		.in_data           (jtg_mst_fpga_m_master_limiter_cmd_src_data),              //   input,  width = 135,          .data
		.in_channel        (jtg_mst_fpga_m_master_limiter_cmd_src_channel),           //   input,    width = 4,          .channel
		...
		.out_data          (limiter_pipeline_source0_data),                           //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.out_data          (limiter_pipeline_001_source0_data),                       //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                           //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, cr0_reset.reset
		.in_ready          (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_ready),         //  output,    width = 1,     sink0.ready
		.in_valid          (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_valid),         //   input,    width = 1,          .valid
		.in_startofpacket  (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_startofpacket), //   input,    width = 1,          .startofpacket
		.in_endofpacket    (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.in_data           (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_data),          //   input,  width = 135,          .data
		.in_channel        (agilex_hps_h2f_lw_axi_master_wr_limiter_cmd_src_channel),       //   input,    width = 4,          .channel
		...
		.out_data          (limiter_pipeline_002_source0_data),                             //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.out_data          (limiter_pipeline_003_source0_data),                       //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                           //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, cr0_reset.reset
		.in_ready          (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_ready),         //  output,    width = 1,     sink0.ready
		.in_valid          (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_valid),         //   input,    width = 1,          .valid
		.in_startofpacket  (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_startofpacket), //   input,    width = 1,          .startofpacket
		.in_endofpacket    (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.in_data           (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_data),          //   input,  width = 135,          .data
		.in_channel        (agilex_hps_h2f_lw_axi_master_rd_limiter_cmd_src_channel),       //   input,    width = 4,          .channel
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                     //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, cr0_reset.reset
		.in_ready          (sysid_control_slave_burst_adapter_source0_ready),         //  output,    width = 1,     sink0.ready
		.in_valid          (sysid_control_slave_burst_adapter_source0_valid),         //   input,    width = 1,          .valid
		.in_startofpacket  (sysid_control_slave_burst_adapter_source0_startofpacket), //   input,    width = 1,          .startofpacket
		.in_endofpacket    (sysid_control_slave_burst_adapter_source0_endofpacket),   //   input,    width = 1,          .endofpacket
		.in_data           (sysid_control_slave_burst_adapter_source0_data),          //   input,  width = 135,          .data
		.in_channel        (sysid_control_slave_burst_adapter_source0_channel),       //   input,    width = 4,          .channel
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                     //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, cr0_reset.reset
		.in_ready          (sysid_control_slave_agent_rp_ready),                      //  output,    width = 1,     sink0.ready
		.in_valid          (sysid_control_slave_agent_rp_valid),                      //   input,    width = 1,          .valid
		.in_startofpacket  (sysid_control_slave_agent_rp_startofpacket),              //   input,    width = 1,          .startofpacket
		.in_endofpacket    (sysid_control_slave_agent_rp_endofpacket),                //   input,    width = 1,          .endofpacket
		.in_data           (sysid_control_slave_agent_rp_data),                       //   input,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                        //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset),    //   input,    width = 1, cr0_reset.reset
		.in_ready          (subsys_sgmii_emac1_csr_burst_adapter_source0_ready),         //  output,    width = 1,     sink0.ready
		.in_valid          (subsys_sgmii_emac1_csr_burst_adapter_source0_valid),         //   input,    width = 1,          .valid
		.in_startofpacket  (subsys_sgmii_emac1_csr_burst_adapter_source0_startofpacket), //   input,    width = 1,          .startofpacket
		.in_endofpacket    (subsys_sgmii_emac1_csr_burst_adapter_source0_endofpacket),   //   input,    width = 1,          .endofpacket
		.in_data           (subsys_sgmii_emac1_csr_burst_adapter_source0_data),          //   input,  width = 135,          .data
		.in_channel        (subsys_sgmii_emac1_csr_burst_adapter_source0_channel),       //   input,    width = 4,          .channel
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.clk               (clk_100_out_clk_clk),                                     //   input,    width = 1,       cr0.clk
		.reset             (agilex_hps_h2f_lw_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, cr0_reset.reset
		.in_ready          (subsys_sgmii_emac1_csr_agent_rp_ready),                   //  output,    width = 1,     sink0.ready
		.in_valid          (subsys_sgmii_emac1_csr_agent_rp_valid),                   //   input,    width = 1,          .valid
		.in_startofpacket  (subsys_sgmii_emac1_csr_agent_rp_startofpacket),           //   input,    width = 1,          .startofpacket
		.in_endofpacket    (subsys_sgmii_emac1_csr_agent_rp_endofpacket),             //   input,    width = 1,          .endofpacket
		.in_data           (subsys_sgmii_emac1_csr_agent_rp_data),                    //   input,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (periph_pb_cpu_0_s0_burst_adapter_source0_data),           //   input,  width = 135,          .data
		.in_channel        (periph_pb_cpu_0_s0_burst_adapter_source0_channel),        //   input,    width = 4,          .channel
		...
		.out_data          (agent_pipeline_004_source0_data),                         //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (periph_pb_cpu_0_s0_agent_rp_data),                        //   input,  width = 135,          .data
		...
		.out_data          (agent_pipeline_005_source0_data),                         //  output,  width = 135,          .data
		.in_empty          (1'b0),                                                    // (terminated),                         
		.out_empty         (),                                                        // (terminated),                         
		.out_error         (),                                                        // (terminated),                         
		.in_error          (1'b0),                                                    // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (fpga_m2ocm_pb_s0_burst_adapter_source0_data),             //   input,  width = 243,          .data
		...
		.out_data          (agent_pipeline_006_source0_data),                         //  output,  width = 243,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (fpga_m2ocm_pb_s0_agent_rp_data),                          //   input,  width = 243,          .data
		...
		.out_data          (agent_pipeline_007_source0_data),                         //  output,  width = 243,          .data
		.in_empty          (1'b0),                                                    // (terminated),                         
		.out_empty         (),                                                        // (terminated),                         
		.out_error         (),                                                        // (terminated),                         
		.in_error          (1'b0),                                                    // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_src2_data),                                     //   input,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_001_src2_data),                                 //   input,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_002_src2_data),                                 //   input,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_src3_data),                                     //   input,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_002_src0_data),                                 //   input,  width = 135,          .data
		...
		.out_data          (mux_pipeline_012_source0_data),                           //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_003_src0_data),                                 //   input,  width = 135,          .data
		...
		.out_data          (mux_pipeline_013_source0_data),                           //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.out_data          (mux_pipeline_014_source0_data),                           //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.out_data          (mux_pipeline_015_source0_data),                           //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_002_src1_data),                                 //   input,  width = 135,          .data
		...
		.out_data          (mux_pipeline_016_source0_data),                           //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.out_data          (mux_pipeline_017_source0_data),                           //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.out_data          (mux_pipeline_018_source0_data),                           //  output,  width = 135,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_002_src2_data),                                 //   input,  width = 135,          .data
		...
		.out_data          (mux_pipeline_019_source0_data),                           //  output,  width = 135,          .data

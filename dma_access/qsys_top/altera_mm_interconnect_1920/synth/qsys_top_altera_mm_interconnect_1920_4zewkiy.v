// qsys_top_altera_mm_interconnect_1920_4zewkiy.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_4zewkiy (
	...
	wire  [132:0] rsp_mux_src_data;                                       // rsp_mux:src_data -> agilex_hps_h2f_axi_master_agent:write_rp_data
	...
	wire  [132:0] rsp_mux_001_src_data;                                   // rsp_mux_001:src_data -> agilex_hps_h2f_axi_master_agent:read_rp_data
	...
	wire  [241:0] ocm_s1_agent_rf_source_data;                            // ocm_s1_agent:rf_source_data -> ocm_s1_agent_rsp_fifo:in_data
	...
	wire  [241:0] ocm_s1_agent_rsp_fifo_out_data;                         // ocm_s1_agent_rsp_fifo:out_data -> ocm_s1_agent:rf_sink_data
	...
	wire  [132:0] router_001_src_data;                                    // router_001:src_data -> cmd_demux_001:sink_data
	...
	wire  [240:0] router_002_src_data;                                    // router_002:src_data -> ocm_s1_rsp_width_adapter:in_data
	...
	wire  [132:0] ocm_s1_rsp_width_adapter_src_data;                      // ocm_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [132:0] cmd_mux_src_data;                                       // cmd_mux:src_data -> ocm_s1_cmd_width_adapter:in_data
	...
	wire  [240:0] ocm_s1_cmd_width_adapter_src_data;                      // ocm_s1_cmd_width_adapter:out_data -> ocm_s1_burst_adapter:sink0_data
	...
	wire  [240:0] ocm_s1_burst_adapter_source0_data;                      // ocm_s1_burst_adapter:source0_data -> agent_pipeline:in_data
	...
	wire  [240:0] agent_pipeline_source0_data;                            // agent_pipeline:out_data -> ocm_s1_agent:cp_data
	...
	wire  [240:0] ocm_s1_agent_rp_data;                                   // ocm_s1_agent:rp_data -> agent_pipeline_001:in_data
	...
	wire  [240:0] agent_pipeline_001_source0_data;                        // agent_pipeline_001:out_data -> router_002:sink_data
	...
	wire  [132:0] cmd_demux_src0_data;                                    // cmd_demux:src0_data -> mux_pipeline:in_data
	...
	wire  [132:0] mux_pipeline_source0_data;                              // mux_pipeline:out_data -> cmd_mux:sink0_data
	...
	wire  [132:0] cmd_demux_001_src0_data;                                // cmd_demux_001:src0_data -> mux_pipeline_001:in_data
	...
	wire  [132:0] mux_pipeline_001_source0_data;                          // mux_pipeline_001:out_data -> cmd_mux:sink1_data
	...
	wire  [132:0] rsp_demux_src0_data;                                    // rsp_demux:src0_data -> mux_pipeline_002:in_data
	...
	wire  [132:0] mux_pipeline_002_source0_data;                          // mux_pipeline_002:out_data -> rsp_mux:sink0_data
	...
	wire  [132:0] rsp_demux_src1_data;                                    // rsp_demux:src1_data -> mux_pipeline_003:in_data
	...
	wire  [132:0] mux_pipeline_003_source0_data;                          // mux_pipeline_003:out_data -> rsp_mux_001:sink0_data
	...
	qsys_top_altera_merlin_axi_master_ni_1941_dfsyzvi #(
		...
		.write_rp_data          (rsp_mux_src_data),                                                            //   input,  width = 133,                 .data
		...
		.read_rp_data           (rsp_mux_001_src_data),                                                        //   input,  width = 133,                 .data
	...
	qsys_top_altera_merlin_slave_agent_191_ncfkfri #(
		...
		.rp_data                 (ocm_s1_agent_rp_data),                                                       //  output,  width = 241,                .data
		...
		.cp_data                 (agent_pipeline_source0_data),                                                //   input,  width = 241,                .data
		...
		.rf_sink_data            (ocm_s1_agent_rsp_fifo_out_data),                                             //   input,  width = 242,                .data
		...
		.rf_source_data          (ocm_s1_agent_rf_source_data),                                                //  output,  width = 242,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (ocm_s1_agent_rf_source_data),                          //   input,  width = 242,        in.data
		...
		.out_data          (ocm_s1_agent_rsp_fifo_out_data),                       //  output,  width = 242,       out.data
	...
	qsys_top_altera_merlin_router_1921_lkuh5yi router (
	...
	qsys_top_altera_merlin_router_1921_lkuh5yi router_001 (
	...
	qsys_top_altera_merlin_router_1921_fr2l3gq router_002 (
		...
		.sink_data          (agent_pipeline_001_source0_data),                                            //   input,  width = 241,          .data
		...
		.src_data           (router_002_src_data),                                                        //  output,  width = 241,          .data
		.src_channel        (router_002_src_channel),                                                     //  output,    width = 2,          .channel
		.src_startofpacket  (router_002_src_startofpacket),                                               //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_002_src_endofpacket)                                                  //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_burst_adapter_1923_j5yayaa #(
		.PKT_ADDR_H                (175),
		.PKT_ADDR_L                (144),
		.PKT_BEGIN_BURST           (209),
		.PKT_BYTE_CNT_H            (194),
		...
		.sink0_data            (ocm_s1_cmd_width_adapter_src_data),                                          //   input,  width = 241,          .data
		...
		.source0_data          (ocm_s1_burst_adapter_source0_data),                                          //  output,  width = 241,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_32eezhy cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_001_src_ready),                                                       //  output,    width = 1,      sink.ready
		.sink_channel       (router_001_src_channel),                                                     //   input,    width = 2,          .channel
		.sink_data          (router_001_src_data),                                                        //   input,  width = 133,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_nte3bmq cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (mux_pipeline_source0_data),                                                  //   input,  width = 133,          .data
		...
		.sink1_data          (mux_pipeline_001_source0_data),                                              //   input,  width = 133,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_vnmpesq rsp_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (ocm_s1_rsp_width_adapter_src_data),                                          //   input,  width = 133,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_esvd2oi rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (mux_pipeline_002_source0_data),                                              //   input,  width = 133,          .data
	...
	qsys_top_altera_merlin_multiplexer_1921_esvd2oi rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (mux_pipeline_003_source0_data),                                              //   input,  width = 133,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_ez32rhq #(
		.IN_PKT_ADDR_H                 (175),
		.IN_PKT_ADDR_L                 (144),
		.IN_PKT_DATA_H                 (127),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (router_002_src_data),                                                        //   input,  width = 241,          .data
		.out_endofpacket      (ocm_s1_rsp_width_adapter_src_endofpacket),                                   //  output,    width = 1,       src.endofpacket
		.out_data             (ocm_s1_rsp_width_adapter_src_data),                                          //  output,  width = 133,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_b4akxqa #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (cmd_mux_src_data),                                                           //   input,  width = 133,          .data
		.out_endofpacket      (ocm_s1_cmd_width_adapter_src_endofpacket),                                   //  output,    width = 1,       src.endofpacket
		.out_data             (ocm_s1_cmd_width_adapter_src_data),                                          //  output,  width = 241,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (ocm_s1_burst_adapter_source0_data),                    //   input,  width = 241,          .data
		...
		.out_data          (agent_pipeline_source0_data),                          //  output,  width = 241,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (ocm_s1_agent_rp_data),                                 //   input,  width = 241,          .data
		...
		.out_data          (agent_pipeline_001_source0_data),                      //  output,  width = 241,          .data
		.in_empty          (1'b0),                                                 // (terminated),                         
		.out_empty         (),                                                     // (terminated),                         
		.out_error         (),                                                     // (terminated),                         
		.in_error          (1'b0),                                                 // (terminated),                         
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_src0_data),                                  //   input,  width = 133,          .data
		...
		.out_data          (mux_pipeline_source0_data),                            //  output,  width = 133,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (cmd_demux_001_src0_data),                              //   input,  width = 133,          .data
		...
		.out_data          (mux_pipeline_001_source0_data),                        //  output,  width = 133,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_src0_data),                                  //   input,  width = 133,          .data
		...
		.out_data          (mux_pipeline_002_source0_data),                        //  output,  width = 133,          .data
	...
	qsys_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (rsp_demux_src1_data),                                  //   input,  width = 133,          .data
		...
		.out_data          (mux_pipeline_003_source0_data),                        //  output,  width = 133,          .data

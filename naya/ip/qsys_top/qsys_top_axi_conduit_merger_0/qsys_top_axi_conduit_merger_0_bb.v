module qsys_top_axi_conduit_merger_0 #(
		...
		output wire                                  s_arready, //    altera_axi_slave.arready
		...
		input  wire [(((AXUSER_WIDTH-1)-0)+1)-1:0]   s_awuser,  //                    .awuser
		...
		input  wire [(((AXUSER_WIDTH-1)-0)+1)-1:0]   s_aruser,  //                    .aruser
		...
		input  wire [(((ADDRESS_WIDTH-1)-0)+1)-1:0]  s_awaddr,  //                    .awaddr
		input  wire [(((ADDRESS_WIDTH-1)-0)+1)-1:0]  s_araddr,  //                    .araddr
		input  wire [(((ID_WIDTH-1)-0)+1)-1:0]       s_awid,    //                    .awid
		input  wire [(((ID_WIDTH-1)-0)+1)-1:0]       s_arid,    //                    .arid
		output wire [(((DATA_WIDTH-1)-0)+1)-1:0]     s_rdata,   //                    .rdata
		input  wire [(((ID_WIDTH-1)-0)+1)-1:0]       s_wid,     //                    .wid
		output wire [(((ID_WIDTH-1)-0)+1)-1:0]       s_bid,     //                    .bid
		input  wire [(((DATA_WIDTH-1)-0)+1)-1:0]     s_wdata,   //                    .wdata
		output wire [(((ID_WIDTH-1)-0)+1)-1:0]       s_rid,     //                    .rid
		input  wire [((((DATA_WIDTH/8)-1)-0)+1)-1:0] s_wstrb,   //                    .wstrb
		output wire                                  m_awvalid, // altera_axi_master_1.awvalid
		...
		output wire [(((AXUSER_WIDTH-1)-0)+1)-1:0]   m_awuser,  //                    .awuser
		...
		output wire [(((AXUSER_WIDTH-1)-0)+1)-1:0]   m_aruser,  //                    .aruser
		...
		output wire [(((ADDRESS_WIDTH-1)-0)+1)-1:0]  m_awaddr,  //                    .awaddr
		output wire [(((ID_WIDTH-1)-0)+1)-1:0]       m_awid,    //                    .awid
		output wire [(((ADDRESS_WIDTH-1)-0)+1)-1:0]  m_araddr,  //                    .araddr
		output wire [(((ID_WIDTH-1)-0)+1)-1:0]       m_arid,    //                    .arid
		input  wire [(((DATA_WIDTH-1)-0)+1)-1:0]     m_rdata,   //                    .rdata
		input  wire [(((ID_WIDTH-1)-0)+1)-1:0]       m_rid,     //                    .rid
		output wire [(((DATA_WIDTH-1)-0)+1)-1:0]     m_wdata,   //                    .wdata
		output wire [((((DATA_WIDTH/8)-1)-0)+1)-1:0] m_wstrb,   //                    .wstrb
		output wire [(((ID_WIDTH-1)-0)+1)-1:0]       m_wid,     //                    .wid
		input  wire [(((ID_WIDTH-1)-0)+1)-1:0]       m_bid,     //                    .bid
		input  wire [(((AXUSER_WIDTH-1)-0)+1)-1:0]   c_awuser,  //         conduit_end.awuser
		input  wire [(((AXUSER_WIDTH-1)-0)+1)-1:0]   c_aruser,  //                    .aruser
		input  wire [2:0]                            c_arprot,  //                    .arprot
		input  wire [3:0]                            c_arcache, //                    .arcache
		input  wire [2:0]                            c_awprot,  //                    .awprot
		input  wire [3:0]                            c_awcache  //                    .awcache
	);
endmodule

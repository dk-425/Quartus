	component qsys_top_axi_conduit_merger_0 is
		...
		port (
			...
			s_awuser  : in  std_logic_vector((((AXUSER_WIDTH-1)-0)+1)-1 downto 0)   := (others => 'X'); -- awuser
			...
			s_aruser  : in  std_logic_vector((((AXUSER_WIDTH-1)-0)+1)-1 downto 0)   := (others => 'X'); -- aruser
			...
			s_awaddr  : in  std_logic_vector((((ADDRESS_WIDTH-1)-0)+1)-1 downto 0)  := (others => 'X'); -- awaddr
			s_araddr  : in  std_logic_vector((((ADDRESS_WIDTH-1)-0)+1)-1 downto 0)  := (others => 'X'); -- araddr
			s_awid    : in  std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0)       := (others => 'X'); -- awid
			s_arid    : in  std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0)       := (others => 'X'); -- arid
			s_rdata   : out std_logic_vector((((DATA_WIDTH-1)-0)+1)-1 downto 0);                        -- rdata
			s_wid     : in  std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0)       := (others => 'X'); -- wid
			s_bid     : out std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0);                          -- bid
			s_wdata   : in  std_logic_vector((((DATA_WIDTH-1)-0)+1)-1 downto 0)     := (others => 'X'); -- wdata
			s_rid     : out std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0);                          -- rid
			s_wstrb   : in  std_logic_vector(((((DATA_WIDTH/8)-1)-0)+1)-1 downto 0) := (others => 'X'); -- wstrb
			...
			m_awuser  : out std_logic_vector((((AXUSER_WIDTH-1)-0)+1)-1 downto 0);                      -- awuser
			...
			m_aruser  : out std_logic_vector((((AXUSER_WIDTH-1)-0)+1)-1 downto 0);                      -- aruser
			...
			m_awaddr  : out std_logic_vector((((ADDRESS_WIDTH-1)-0)+1)-1 downto 0);                     -- awaddr
			m_awid    : out std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0);                          -- awid
			m_araddr  : out std_logic_vector((((ADDRESS_WIDTH-1)-0)+1)-1 downto 0);                     -- araddr
			m_arid    : out std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0);                          -- arid
			m_rdata   : in  std_logic_vector((((DATA_WIDTH-1)-0)+1)-1 downto 0)     := (others => 'X'); -- rdata
			m_rid     : in  std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0)       := (others => 'X'); -- rid
			m_wdata   : out std_logic_vector((((DATA_WIDTH-1)-0)+1)-1 downto 0);                        -- wdata
			m_wstrb   : out std_logic_vector(((((DATA_WIDTH/8)-1)-0)+1)-1 downto 0);                    -- wstrb
			m_wid     : out std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0);                          -- wid
			m_bid     : in  std_logic_vector((((ID_WIDTH-1)-0)+1)-1 downto 0)       := (others => 'X'); -- bid
			c_awuser  : in  std_logic_vector((((AXUSER_WIDTH-1)-0)+1)-1 downto 0)   := (others => 'X'); -- awuser
			c_aruser  : in  std_logic_vector((((AXUSER_WIDTH-1)-0)+1)-1 downto 0)   := (others => 'X'); -- aruser
	...
	u0 : component qsys_top_axi_conduit_merger_0
		...
		port map (
			...
			m_awvalid => CONNECTED_TO_m_awvalid, -- altera_axi_master_1.awvalid
			...
			c_awuser  => CONNECTED_TO_c_awuser,  --         conduit_end.awuser
			...
			c_awcache => CONNECTED_TO_c_awcache  --                    .awcache
		);

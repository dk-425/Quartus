// qsys_top_altera_mm_interconnect_1920_rqm4h4y.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_rqm4h4y (
		...
		input  wire [31:0]  msgdma_0_mm_write_address,                            //                              msgdma_0_mm_write.address
	...
	wire  [134:0] rsp_mux_002_src_data;                                                 // rsp_mux_002:src_data -> msgdma_0_mm_write_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                // msgdma_0_mm_write_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                              // rsp_mux_002:src_channel -> msgdma_0_mm_write_agent:rp_channel
	...
	wire  [134:0] msgdma_0_mm_write_agent_cp_data;                                      // msgdma_0_mm_write_agent:cp_data -> router_002:sink_data
	...
	wire          msgdma_0_csr_agent_rp_valid;                                          // msgdma_0_csr_agent:rp_valid -> router_003:sink_valid
	wire  [134:0] msgdma_0_csr_agent_rp_data;                                           // msgdma_0_csr_agent:rp_data -> router_003:sink_data
	wire          msgdma_0_csr_agent_rp_ready;                                          // router_003:sink_ready -> msgdma_0_csr_agent:rp_ready
	wire          msgdma_0_csr_agent_rp_startofpacket;                                  // msgdma_0_csr_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          msgdma_0_csr_agent_rp_endofpacket;                                    // msgdma_0_csr_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [242:0] msgdma_0_descriptor_slave_agent_rp_data;                              // msgdma_0_descriptor_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [134:0] onchip_memory2_0_s1_agent_rp_data;                                    // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [134:0] cmd_demux_002_src0_data;                                              // cmd_demux_002:src0_data -> cmd_mux_002:sink2_data
	...
	wire  [134:0] rsp_demux_002_src2_data;                                              // rsp_demux_002:src2_data -> rsp_mux_002:sink0_data
	...
	wire  [242:0] router_004_src_data;                                                  // router_004:src_data -> msgdma_0_descriptor_slave_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                 // msgdma_0_descriptor_slave_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [2:0] router_004_src_channel;                                               // router_004:src_channel -> msgdma_0_descriptor_slave_rsp_width_adapter:in_channel
	...
	qsys_top_altera_merlin_master_translator_191_g7h47bq #(
		...
		.uav_address            (msgdma_0_mm_write_translator_avalon_universal_master_0_address),       //  output,  width = 32, avalon_universal_master_0.address
		.uav_burstcount         (msgdma_0_mm_write_translator_avalon_universal_master_0_burstcount),    //  output,   width = 3,                          .burstcount
		.uav_read               (msgdma_0_mm_write_translator_avalon_universal_master_0_read),          //  output,   width = 1,                          .read
		.uav_write              (msgdma_0_mm_write_translator_avalon_universal_master_0_write),         //  output,   width = 1,                          .write
		.uav_waitrequest        (msgdma_0_mm_write_translator_avalon_universal_master_0_waitrequest),   //   input,   width = 1,                          .waitrequest
		.uav_readdatavalid      (msgdma_0_mm_write_translator_avalon_universal_master_0_readdatavalid), //   input,   width = 1,                          .readdatavalid
		.uav_byteenable         (msgdma_0_mm_write_translator_avalon_universal_master_0_byteenable),    //  output,   width = 4,                          .byteenable
		.uav_readdata           (msgdma_0_mm_write_translator_avalon_universal_master_0_readdata),      //   input,  width = 32,                          .readdata
		.uav_writedata          (msgdma_0_mm_write_translator_avalon_universal_master_0_writedata),     //  output,  width = 32,                          .writedata
		.uav_lock               (msgdma_0_mm_write_translator_avalon_universal_master_0_lock),          //  output,   width = 1,                          .lock
		.uav_debugaccess        (msgdma_0_mm_write_translator_avalon_universal_master_0_debugaccess),   //  output,   width = 1,                          .debugaccess
		.av_address             (msgdma_0_mm_write_address),                                            //   input,  width = 32,      avalon_anti_master_0.address
		.av_waitrequest         (msgdma_0_mm_write_waitrequest),                                        //  output,   width = 1,                          .waitrequest
		.av_byteenable          (msgdma_0_mm_write_byteenable),                                         //   input,   width = 4,                          .byteenable
		.av_write               (msgdma_0_mm_write_write),                                              //   input,   width = 1,                          .write
		.av_writedata           (msgdma_0_mm_write_writedata),                                          //   input,  width = 32,                          .writedata
	...
	qsys_top_altera_merlin_master_agent_191_mpbm6tq #(
		...
		.av_address            (msgdma_0_mm_write_translator_avalon_universal_master_0_address),       //   input,   width = 32,        av.address
		.av_write              (msgdma_0_mm_write_translator_avalon_universal_master_0_write),         //   input,    width = 1,          .write
		.av_read               (msgdma_0_mm_write_translator_avalon_universal_master_0_read),          //   input,    width = 1,          .read
		.av_writedata          (msgdma_0_mm_write_translator_avalon_universal_master_0_writedata),     //   input,   width = 32,          .writedata
		.av_readdata           (msgdma_0_mm_write_translator_avalon_universal_master_0_readdata),      //  output,   width = 32,          .readdata
		.av_waitrequest        (msgdma_0_mm_write_translator_avalon_universal_master_0_waitrequest),   //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (msgdma_0_mm_write_translator_avalon_universal_master_0_readdatavalid), //  output,    width = 1,          .readdatavalid
		.av_byteenable         (msgdma_0_mm_write_translator_avalon_universal_master_0_byteenable),    //   input,    width = 4,          .byteenable
		.av_burstcount         (msgdma_0_mm_write_translator_avalon_universal_master_0_burstcount),    //   input,    width = 3,          .burstcount
		.av_debugaccess        (msgdma_0_mm_write_translator_avalon_universal_master_0_debugaccess),   //   input,    width = 1,          .debugaccess
		.av_lock               (msgdma_0_mm_write_translator_avalon_universal_master_0_lock),          //   input,    width = 1,          .lock
		.cp_valid              (msgdma_0_mm_write_agent_cp_valid),                                     //  output,    width = 1,        cp.valid
		.cp_data               (msgdma_0_mm_write_agent_cp_data),                                      //  output,  width = 135,          .data
		.cp_startofpacket      (msgdma_0_mm_write_agent_cp_startofpacket),                             //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (msgdma_0_mm_write_agent_cp_endofpacket),                               //  output,    width = 1,          .endofpacket
		.cp_ready              (msgdma_0_mm_write_agent_cp_ready),                                     //   input,    width = 1,          .ready
	...
	qsys_top_altera_merlin_router_1921_t5znvwq router (
	...
	qsys_top_altera_merlin_router_1921_t5znvwq router_001 (
	...
	qsys_top_altera_merlin_router_1921_377nrdy router_002 (
		.sink_ready         (msgdma_0_mm_write_agent_cp_ready),             //  output,    width = 1,      sink.ready
		.sink_valid         (msgdma_0_mm_write_agent_cp_valid),             //   input,    width = 1,          .valid
		.sink_data          (msgdma_0_mm_write_agent_cp_data),              //   input,  width = 135,          .data
		.sink_startofpacket (msgdma_0_mm_write_agent_cp_startofpacket),     //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (msgdma_0_mm_write_agent_cp_endofpacket),       //   input,    width = 1,          .endofpacket
		.clk                (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_router_1921_ah6c3va router_003 (
	...
	qsys_top_altera_merlin_router_1921_knzvu7i router_004 (
		...
		.src_data           (router_004_src_data),                              //  output,  width = 243,          .data
	...
	qsys_top_altera_merlin_router_1921_ph6qqra router_005 (
	...
	qsys_top_altera_merlin_multiplexer_1921_c2vhg3y cmd_mux_002 (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_data          (cmd_demux_002_src0_data),                      //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_l4jli4q rsp_demux_002 (
		.clk                (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_005_src_ready),                         //  output,    width = 1,      sink.ready
		.sink_channel       (router_005_src_channel),                       //   input,    width = 3,          .channel
		...
		.src2_channel       (rsp_demux_002_src2_channel),                   //  output,    width = 3,          .channel
	...
	qsys_top_altera_merlin_multiplexer_1921_zpzkjtq rsp_mux_002 (
		...
		.sink0_channel       (rsp_demux_002_src2_channel),                   //   input,    width = 3,          .channel
		.sink0_data          (rsp_demux_002_src2_data),                      //   input,  width = 135,          .data
	...
	qsys_top_altera_merlin_width_adapter_1920_pbpa2vy #(
		...
		.in_data              (router_004_src_data),                                           //   input,  width = 243,          .data

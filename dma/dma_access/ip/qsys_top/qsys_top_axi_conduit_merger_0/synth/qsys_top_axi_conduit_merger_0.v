...
module qsys_top_axi_conduit_merger_0 #(
	...
	axi_conduit_merger #(
		...
		.s_arready (s_arready), //  output,                           width = 1,    altera_axi_slave.arready
		...
		.s_awuser  (s_awuser),  //   input,    width = (((AXUSER_WIDTH-1)-0)+1),                    .awuser
		...
		.s_aruser  (s_aruser),  //   input,    width = (((AXUSER_WIDTH-1)-0)+1),                    .aruser
		...
		.s_awaddr  (s_awaddr),  //   input,   width = (((ADDRESS_WIDTH-1)-0)+1),                    .awaddr
		.s_araddr  (s_araddr),  //   input,   width = (((ADDRESS_WIDTH-1)-0)+1),                    .araddr
		.s_awid    (s_awid),    //   input,        width = (((ID_WIDTH-1)-0)+1),                    .awid
		.s_arid    (s_arid),    //   input,        width = (((ID_WIDTH-1)-0)+1),                    .arid
		.s_rdata   (s_rdata),   //  output,      width = (((DATA_WIDTH-1)-0)+1),                    .rdata
		.s_wid     (s_wid),     //   input,        width = (((ID_WIDTH-1)-0)+1),                    .wid
		.s_bid     (s_bid),     //  output,        width = (((ID_WIDTH-1)-0)+1),                    .bid
		.s_wdata   (s_wdata),   //   input,      width = (((DATA_WIDTH-1)-0)+1),                    .wdata
		.s_rid     (s_rid),     //  output,        width = (((ID_WIDTH-1)-0)+1),                    .rid
		.s_wstrb   (s_wstrb),   //   input,  width = ((((DATA_WIDTH/8)-1)-0)+1),                    .wstrb
		.m_awvalid (m_awvalid), //  output,                           width = 1, altera_axi_master_1.awvalid
		...
		.m_awuser  (m_awuser),  //  output,    width = (((AXUSER_WIDTH-1)-0)+1),                    .awuser
		...
		.m_aruser  (m_aruser),  //  output,    width = (((AXUSER_WIDTH-1)-0)+1),                    .aruser
		...
		.m_awaddr  (m_awaddr),  //  output,   width = (((ADDRESS_WIDTH-1)-0)+1),                    .awaddr
		.m_awid    (m_awid),    //  output,        width = (((ID_WIDTH-1)-0)+1),                    .awid
		.m_araddr  (m_araddr),  //  output,   width = (((ADDRESS_WIDTH-1)-0)+1),                    .araddr
		.m_arid    (m_arid),    //  output,        width = (((ID_WIDTH-1)-0)+1),                    .arid
		.m_rdata   (m_rdata),   //   input,      width = (((DATA_WIDTH-1)-0)+1),                    .rdata
		.m_rid     (m_rid),     //   input,        width = (((ID_WIDTH-1)-0)+1),                    .rid
		.m_wdata   (m_wdata),   //  output,      width = (((DATA_WIDTH-1)-0)+1),                    .wdata
		.m_wstrb   (m_wstrb),   //  output,  width = ((((DATA_WIDTH/8)-1)-0)+1),                    .wstrb
		.m_wid     (m_wid),     //  output,        width = (((ID_WIDTH-1)-0)+1),                    .wid
		.m_bid     (m_bid),     //   input,        width = (((ID_WIDTH-1)-0)+1),                    .bid
		.c_awuser  (c_awuser),  //   input,    width = (((AXUSER_WIDTH-1)-0)+1),         conduit_end.awuser
		.c_aruser  (c_aruser),  //   input,    width = (((AXUSER_WIDTH-1)-0)+1),                    .aruser
		.c_arprot  (c_arprot),  //   input,                           width = 3,                    .arprot
		.c_arcache (c_arcache), //   input,                           width = 4,                    .arcache
		.c_awprot  (c_awprot),  //   input,                           width = 3,                    .awprot
		.c_awcache (c_awcache)  //   input,                           width = 4,                    .awcache
	);

...
#****************************************************************************
#
# This script updates the GHRD SYSID
...
set gitHash [exec git rev-parse --short HEAD]
puts "INFO: Generated System ID is $gitHash"
...
foreach sysid $found_sysid_ip_files {
    ...
    #puts [get_module_property GENERATION_ID]
    # set_component_parameter_value id {$gitHash}
    validate_system    
    save_system ${sysid}
}
...
proc do_create_qsys_top {} {
	...
	# add the components
	add_component L1_reset_pio ip/qsys_top/L1_reset_pio.ip altera_avalon_pio L1_reset_pio 19.2.1
	...
	save_instantiation
	add_component L1_reset_pio_0 ip/qsys_top/L1_reset_pio_0.ip altera_avalon_pio L1_reset_pio 19.2.1
	load_component L1_reset_pio_0
	set_component_parameter_value bitClearingEdgeCapReg {0}
	set_component_parameter_value bitModifyingOutReg {1}
	set_component_parameter_value captureEdge {0}
	set_component_parameter_value direction {Output}
	...
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation L1_reset_pio_0
	remove_instantiation_interfaces_and_ports
	set_instantiation_assignment_value embeddedsw.CMacro.BIT_CLEARING_EDGE_REGISTER {0}
	set_instantiation_assignment_value embeddedsw.CMacro.BIT_MODIFYING_OUTPUT_REGISTER {1}
	set_instantiation_assignment_value embeddedsw.CMacro.CAPTURE {0}
	...
	save_instantiation
	add_component axil_reg ip/qsys_top/axil_reg.ip axi_register_hw_0_hw axil_reg 2.0
	load_component axil_reg
	set_component_parameter_value ADDR_WIDTH {12}
	set_component_parameter_value AR_REG_TYPE {1}
	set_component_parameter_value AW_REG_TYPE {1}
	set_component_parameter_value B_REG_TYPE {1}
	set_component_parameter_value DATA_WIDTH {32}
	set_component_parameter_value R_REG_TYPE {1}
	set_component_parameter_value STRB_WIDTH {4}
	set_component_parameter_value W_REG_TYPE {1}
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation axil_reg
	remove_instantiation_interfaces_and_ports
	...
	add_instantiation_interface_port reset_sink rst reset 1 STD_LOGIC Input
	add_instantiation_interface m_axilite axi4lite OUTPUT
	set_instantiation_interface_parameter_value m_axilite associatedClock {clock}
	set_instantiation_interface_parameter_value m_axilite associatedReset {reset_sink}
	set_instantiation_interface_parameter_value m_axilite combinedIssuingCapability {1}
	set_instantiation_interface_parameter_value m_axilite maximumOutstandingReads {1}
	set_instantiation_interface_parameter_value m_axilite maximumOutstandingTransactions {1}
	set_instantiation_interface_parameter_value m_axilite maximumOutstandingWrites {1}
	set_instantiation_interface_parameter_value m_axilite readIssuingCapability {1}
	set_instantiation_interface_parameter_value m_axilite trustzoneAware {true}
	set_instantiation_interface_parameter_value m_axilite writeIssuingCapability {1}
	add_instantiation_interface_port m_axilite m_axil_awaddr awaddr 12 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port m_axilite m_axil_awprot awprot 3 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port m_axilite m_axil_awvalid awvalid 1 STD_LOGIC Output
	add_instantiation_interface_port m_axilite m_axil_awready awready 1 STD_LOGIC Input
	add_instantiation_interface_port m_axilite m_axil_wdata wdata 32 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port m_axilite m_axil_wstrb wstrb 4 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port m_axilite m_axil_wvalid wvalid 1 STD_LOGIC Output
	add_instantiation_interface_port m_axilite m_axil_wready wready 1 STD_LOGIC Input
	add_instantiation_interface_port m_axilite m_axil_bresp bresp 2 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port m_axilite m_axil_bvalid bvalid 1 STD_LOGIC Input
	add_instantiation_interface_port m_axilite m_axil_bready bready 1 STD_LOGIC Output
	add_instantiation_interface_port m_axilite m_axil_araddr araddr 12 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port m_axilite m_axil_arprot arprot 3 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port m_axilite m_axil_arvalid arvalid 1 STD_LOGIC Output
	add_instantiation_interface_port m_axilite m_axil_arready arready 1 STD_LOGIC Input
	add_instantiation_interface_port m_axilite m_axil_rdata rdata 32 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port m_axilite m_axil_rresp rresp 2 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port m_axilite m_axil_rvalid rvalid 1 STD_LOGIC Input
	add_instantiation_interface_port m_axilite m_axil_rready rready 1 STD_LOGIC Output
	add_instantiation_interface s_axilite axi4lite INPUT
	set_instantiation_interface_parameter_value s_axilite associatedClock {clock}
	set_instantiation_interface_parameter_value s_axilite associatedReset {reset_sink}
	set_instantiation_interface_parameter_value s_axilite bridgesToMaster {}
	set_instantiation_interface_parameter_value s_axilite combinedAcceptanceCapability {1}
	set_instantiation_interface_parameter_value s_axilite maximumOutstandingReads {1}
	set_instantiation_interface_parameter_value s_axilite maximumOutstandingTransactions {1}
	set_instantiation_interface_parameter_value s_axilite maximumOutstandingWrites {1}
	set_instantiation_interface_parameter_value s_axilite readAcceptanceCapability {1}
	set_instantiation_interface_parameter_value s_axilite readDataReorderingDepth {1}
	set_instantiation_interface_parameter_value s_axilite trustzoneAware {true}
	set_instantiation_interface_parameter_value s_axilite writeAcceptanceCapability {1}
	add_instantiation_interface_port s_axilite s_axil_awaddr awaddr 12 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port s_axilite s_axil_awprot awprot 3 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port s_axilite s_axil_awvalid awvalid 1 STD_LOGIC Input
	add_instantiation_interface_port s_axilite s_axil_awready awready 1 STD_LOGIC Output
	add_instantiation_interface_port s_axilite s_axil_wdata wdata 32 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port s_axilite s_axil_wstrb wstrb 4 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port s_axilite s_axil_wvalid wvalid 1 STD_LOGIC Input
	add_instantiation_interface_port s_axilite s_axil_wready wready 1 STD_LOGIC Output
	add_instantiation_interface_port s_axilite s_axil_bresp bresp 2 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port s_axilite s_axil_bvalid bvalid 1 STD_LOGIC Output
	add_instantiation_interface_port s_axilite s_axil_bready bready 1 STD_LOGIC Input
	add_instantiation_interface_port s_axilite s_axil_araddr araddr 12 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port s_axilite s_axil_arprot arprot 3 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port s_axilite s_axil_arvalid arvalid 1 STD_LOGIC Input
	add_instantiation_interface_port s_axilite s_axil_arready arready 1 STD_LOGIC Output
	add_instantiation_interface_port s_axilite s_axil_rdata rdata 32 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port s_axilite s_axil_rresp rresp 2 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port s_axilite s_axil_rvalid rvalid 1 STD_LOGIC Output
	add_instantiation_interface_port s_axilite s_axil_rready rready 1 STD_LOGIC Input
	save_instantiation
	...
	save_instantiation
	add_component emif_calbus_0 ip/qsys_top/emif_calbus_0.ip altera_emif_cal emif_calbus_0 2.7.0
	...
	save_instantiation
	add_component emif_hps ip/qsys_top/emif_hps.ip altera_emif_fm_hps emif_hps 2.7.0
	...
	save_instantiation
	add_component msgdma_mm2s ip/qsys_top/msgdma_mm2s.ip altera_msgdma msgdma_mm2s 19.2.3
	...
	save_instantiation
	add_component msgdma_s2mm ip/qsys_top/msgdma_s2mm.ip altera_msgdma msgdma_s2mm 19.2.3
	...
	save_instantiation
	add_component rst_in_1 ip/qsys_top/rst_in_1.ip altera_reset_bridge reset_in 19.2.0
	load_component rst_in_1
	set_component_parameter_value ACTIVE_LOW_RESET {1}
	set_component_parameter_value NUM_RESET_OUTPUTS {1}
	set_component_parameter_value SYNCHRONOUS_EDGES {deassert}
	set_component_parameter_value SYNC_RESET {0}
	...
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio.s1 addressMapSysInfo {<address-map><slave name='axil_reg.s_axilite' start='0x0' end='0x1000' datawidth='32' /><slave name='L1_reset_pio_0.s1' start='0x1000' end='0x1020' datawidth='32' /><slave name='L1_reset_pio.s1' start='0x1020' end='0x1040' datawidth='32' /><slave name='msgdma_s2mm.csr' start='0x1040' end='0x1060' datawidth='32' /><slave name='msgdma_mm2s.csr' start='0x1060' end='0x1080' datawidth='32' /><slave name='msgdma_s2mm.descriptor_slave' start='0x1080' end='0x1090' datawidth='128' /><slave name='msgdma_mm2s.descriptor_slave' start='0x1090' end='0x10A0' datawidth='128' /></address-map>}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio.s1 addressWidthSysInfo {13}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio.s1 arbitrationPriority {1}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio.s1 baseAddress {0x1020}
	...
	add_connection agilex_hps.h2f_axi_master/L1_reset_pio_0.s1
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 addressMapSysInfo {<address-map><slave name='axil_reg.s_axilite' start='0x0' end='0x1000' datawidth='32' /><slave name='L1_reset_pio_0.s1' start='0x1000' end='0x1020' datawidth='32' /><slave name='L1_reset_pio.s1' start='0x1020' end='0x1040' datawidth='32' /><slave name='msgdma_s2mm.csr' start='0x1040' end='0x1060' datawidth='32' /><slave name='msgdma_mm2s.csr' start='0x1060' end='0x1080' datawidth='32' /><slave name='msgdma_s2mm.descriptor_slave' start='0x1080' end='0x1090' datawidth='128' /><slave name='msgdma_mm2s.descriptor_slave' start='0x1090' end='0x10A0' datawidth='128' /></address-map>}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 addressWidthSysInfo {13}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 arbitrationPriority {1}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 baseAddress {0x1000}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 defaultConnection {0}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 domainAlias {}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value agilex_hps.h2f_axi_master/L1_reset_pio_0.s1 slaveDataWidthSysInfo {-1}
	add_connection agilex_hps.h2f_axi_master/axil_reg.s_axilite
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite addressMapSysInfo {<address-map><slave name='axil_reg.s_axilite' start='0x0' end='0x1000' datawidth='32' /><slave name='L1_reset_pio_0.s1' start='0x1000' end='0x1020' datawidth='32' /><slave name='L1_reset_pio.s1' start='0x1020' end='0x1040' datawidth='32' /><slave name='msgdma_s2mm.csr' start='0x1040' end='0x1060' datawidth='32' /><slave name='msgdma_mm2s.csr' start='0x1060' end='0x1080' datawidth='32' /><slave name='msgdma_s2mm.descriptor_slave' start='0x1080' end='0x1090' datawidth='128' /><slave name='msgdma_mm2s.descriptor_slave' start='0x1090' end='0x10A0' datawidth='128' /></address-map>}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite addressWidthSysInfo {13}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite arbitrationPriority {1}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite baseAddress {0x0000}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite defaultConnection {0}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite domainAlias {}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.syncResets {TRUE}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value agilex_hps.h2f_axi_master/axil_reg.s_axilite slaveDataWidthSysInfo {-1}
	add_connection agilex_hps.h2f_axi_master/msgdma_mm2s.csr
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_mm2s.csr addressMapSysInfo {<address-map><slave name='axil_reg.s_axilite' start='0x0' end='0x1000' datawidth='32' /><slave name='L1_reset_pio_0.s1' start='0x1000' end='0x1020' datawidth='32' /><slave name='L1_reset_pio.s1' start='0x1020' end='0x1040' datawidth='32' /><slave name='msgdma_s2mm.csr' start='0x1040' end='0x1060' datawidth='32' /><slave name='msgdma_mm2s.csr' start='0x1060' end='0x1080' datawidth='32' /><slave name='msgdma_s2mm.descriptor_slave' start='0x1080' end='0x1090' datawidth='128' /><slave name='msgdma_mm2s.descriptor_slave' start='0x1090' end='0x10A0' datawidth='128' /></address-map>}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_mm2s.csr addressWidthSysInfo {13}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_mm2s.csr arbitrationPriority {1}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_mm2s.csr baseAddress {0x1060}
	...
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_mm2s.descriptor_slave addressMapSysInfo {<address-map><slave name='axil_reg.s_axilite' start='0x0' end='0x1000' datawidth='32' /><slave name='L1_reset_pio_0.s1' start='0x1000' end='0x1020' datawidth='32' /><slave name='L1_reset_pio.s1' start='0x1020' end='0x1040' datawidth='32' /><slave name='msgdma_s2mm.csr' start='0x1040' end='0x1060' datawidth='32' /><slave name='msgdma_mm2s.csr' start='0x1060' end='0x1080' datawidth='32' /><slave name='msgdma_s2mm.descriptor_slave' start='0x1080' end='0x1090' datawidth='128' /><slave name='msgdma_mm2s.descriptor_slave' start='0x1090' end='0x10A0' datawidth='128' /></address-map>}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_mm2s.descriptor_slave addressWidthSysInfo {13}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_mm2s.descriptor_slave arbitrationPriority {1}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_mm2s.descriptor_slave baseAddress {0x1090}
	...
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_s2mm.csr addressMapSysInfo {<address-map><slave name='axil_reg.s_axilite' start='0x0' end='0x1000' datawidth='32' /><slave name='L1_reset_pio_0.s1' start='0x1000' end='0x1020' datawidth='32' /><slave name='L1_reset_pio.s1' start='0x1020' end='0x1040' datawidth='32' /><slave name='msgdma_s2mm.csr' start='0x1040' end='0x1060' datawidth='32' /><slave name='msgdma_mm2s.csr' start='0x1060' end='0x1080' datawidth='32' /><slave name='msgdma_s2mm.descriptor_slave' start='0x1080' end='0x1090' datawidth='128' /><slave name='msgdma_mm2s.descriptor_slave' start='0x1090' end='0x10A0' datawidth='128' /></address-map>}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_s2mm.csr addressWidthSysInfo {13}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_s2mm.csr arbitrationPriority {1}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_s2mm.csr baseAddress {0x1040}
	...
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_s2mm.descriptor_slave addressWidthSysInfo {13}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_s2mm.descriptor_slave arbitrationPriority {1}
	set_connection_parameter_value agilex_hps.h2f_axi_master/msgdma_s2mm.descriptor_slave baseAddress {0x1080}
	...
	add_connection clk_245p76.out_clk/L1_reset_pio_0.clk
	set_connection_parameter_value clk_245p76.out_clk/L1_reset_pio_0.clk clockDomainSysInfo {-1}
	set_connection_parameter_value clk_245p76.out_clk/L1_reset_pio_0.clk clockRateSysInfo {245760000.0}
	set_connection_parameter_value clk_245p76.out_clk/L1_reset_pio_0.clk clockResetSysInfo {}
	set_connection_parameter_value clk_245p76.out_clk/L1_reset_pio_0.clk resetDomainSysInfo {-1}
	...
	add_connection clk_245p76.out_clk/axil_reg.clock
	set_connection_parameter_value clk_245p76.out_clk/axil_reg.clock clockDomainSysInfo {-1}
	set_connection_parameter_value clk_245p76.out_clk/axil_reg.clock clockRateSysInfo {245760000.0}
	set_connection_parameter_value clk_245p76.out_clk/axil_reg.clock clockResetSysInfo {}
	set_connection_parameter_value clk_245p76.out_clk/axil_reg.clock resetDomainSysInfo {-1}
	...
	add_connection clk_245p76.out_clk/rst_in_1.clk
	set_connection_parameter_value clk_245p76.out_clk/rst_in_1.clk clockDomainSysInfo {-1}
	set_connection_parameter_value clk_245p76.out_clk/rst_in_1.clk clockRateSysInfo {245760000.0}
	set_connection_parameter_value clk_245p76.out_clk/rst_in_1.clk clockResetSysInfo {}
	set_connection_parameter_value clk_245p76.out_clk/rst_in_1.clk resetDomainSysInfo {-1}
	...
	add_connection rst_in.out_reset/L1_reset_pio_0.reset
	set_connection_parameter_value rst_in.out_reset/L1_reset_pio_0.reset clockDomainSysInfo {-1}
	set_connection_parameter_value rst_in.out_reset/L1_reset_pio_0.reset clockResetSysInfo {}
	set_connection_parameter_value rst_in.out_reset/L1_reset_pio_0.reset resetDomainSysInfo {-1}
	...
	add_connection rst_in.out_reset/axil_reg.reset_sink
	set_connection_parameter_value rst_in.out_reset/axil_reg.reset_sink clockDomainSysInfo {-1}
	set_connection_parameter_value rst_in.out_reset/axil_reg.reset_sink clockResetSysInfo {}
	set_connection_parameter_value rst_in.out_reset/axil_reg.reset_sink resetDomainSysInfo {-1}
	...
	set_interface_property l1_out_pio EXPORT_OF L1_reset_pio_0.external_connection
	...
	set_interface_property m_axilite EXPORT_OF axil_reg.m_axilite
	...
	set_interface_property l1_pspl_reset_n EXPORT_OF rst_in_1.in_reset
...
<bonusData>
 ...
 <element __value="L1_reset_pio.s1">
  <datum __value="baseAddress" value="4128" type="String" />
 </element>
 <element __value="L1_reset_pio_0">
  <datum __value="_sortIndex" value="10" type="int" />
 </element>
 <element __value="L1_reset_pio_0.s1">
 ...
 <element __value="axil_reg">
  <datum __value="_sortIndex" value="12" type="int" />
 </element>
 <element __value="axil_reg.s_axilite">
  <datum __value="baseAddress" value="0" type="String" />
 </element>
 ...
 <element __value="msgdma_mm2s.csr">
  <datum __value="baseAddress" value="4192" type="String" />
 </element>
 <element __value="msgdma_mm2s.descriptor_slave">
  <datum __value="baseAddress" value="4240" type="String" />
 </element>
 ...
 <element __value="msgdma_s2mm.csr">
  <datum __value="baseAddress" value="4160" type="String" />
 </element>
 <element __value="msgdma_s2mm.descriptor_slave">
  <datum __value="baseAddress" value="4224" type="String" />
 </element>
 <element __value="rst_in">
  <datum __value="_sortIndex" value="1" type="int" />
 </element>
 <element __value="rst_in_1">

	qsys_top u0 (
		...
		.axi_conduit_merger_0_conduit_end_awuser  (_connected_to_axi_conduit_merger_0_conduit_end_awuser_),  //   input,   width = 5, axi_conduit_merger_0_conduit_end.awuser
		.axi_conduit_merger_0_conduit_end_aruser  (_connected_to_axi_conduit_merger_0_conduit_end_aruser_),  //   input,   width = 5,                                 .aruser
		.axi_conduit_merger_0_conduit_end_arprot  (_connected_to_axi_conduit_merger_0_conduit_end_arprot_),  //   input,   width = 3,                                 .arprot
		.axi_conduit_merger_0_conduit_end_arcache (_connected_to_axi_conduit_merger_0_conduit_end_arcache_), //   input,   width = 4,                                 .arcache
		.axi_conduit_merger_0_conduit_end_awprot  (_connected_to_axi_conduit_merger_0_conduit_end_awprot_),  //   input,   width = 3,                                 .awprot
		.axi_conduit_merger_0_conduit_end_awcache (_connected_to_axi_conduit_merger_0_conduit_end_awcache_), //   input,   width = 4,                                 .awcache
		...
		.msgdma_0_st_source_data                  (_connected_to_msgdma_0_st_source_data_),                  //  output,  width = 32,               msgdma_0_st_source.data
		.msgdma_0_st_source_valid                 (_connected_to_msgdma_0_st_source_valid_),                 //  output,   width = 1,                                 .valid
		.msgdma_0_st_source_ready                 (_connected_to_msgdma_0_st_source_ready_),                 //   input,   width = 1,                                 .ready
		.msgdma_0_st_source_startofpacket         (_connected_to_msgdma_0_st_source_startofpacket_),         //  output,   width = 1,                                 .startofpacket
		.msgdma_0_st_source_endofpacket           (_connected_to_msgdma_0_st_source_endofpacket_),           //  output,   width = 1,                                 .endofpacket
		.msgdma_0_st_source_empty                 (_connected_to_msgdma_0_st_source_empty_),                 //  output,   width = 2,                                 .empty
		.fpga_led_pio_export                      (_connected_to_fpga_led_pio_export_),                      //  output,   width = 4,                     fpga_led_pio.export

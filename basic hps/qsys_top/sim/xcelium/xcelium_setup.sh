...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/sam-admin/intelFPGA_pro/23.4/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex7_io96.sv"          -work tennm_agilex7_io96
  xmvlog -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex7_io96_ncrypt.sv"   -work tennm_agilex7_io96
fi
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [qsys_top::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]

// qsys_top_altera_mm_interconnect_1920_zy6v73i.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_zy6v73i (
		...
		output wire [0:0]  axi_conduit_merger_0_altera_axi_slave_awid,    //  axi_conduit_merger_0_altera_axi_slave.awid
		...
		output wire [0:0]  axi_conduit_merger_0_altera_axi_slave_wid,     //                                       .wid
		...
		input  wire [0:0]  axi_conduit_merger_0_altera_axi_slave_bid,     //                                       .bid
		...
		output wire [0:0]  axi_conduit_merger_0_altera_axi_slave_arid,    //                                       .arid
		...
		input  wire [0:0]  axi_conduit_merger_0_altera_axi_slave_rid,     //                                       .rid
	...
	wire  [137:0] cmd_mux_src_data;                                                    // cmd_mux:src_data -> axi_conduit_merger_0_altera_axi_slave_agent:write_cp_data
	...
	wire  [137:0] cmd_mux_001_src_data;                                                // cmd_mux_001:src_data -> axi_conduit_merger_0_altera_axi_slave_agent:read_cp_data
	...
	wire  [137:0] msgdma_0_mm_read_agent_cp_data;                                      // msgdma_0_mm_read_agent:cp_data -> router:sink_data
	...
	wire  [137:0] axi_conduit_merger_0_altera_axi_slave_agent_write_rp_data;           // axi_conduit_merger_0_altera_axi_slave_agent:write_rp_data -> router_001:sink_data
	...
	wire  [137:0] router_001_src_data;                                                 // router_001:src_data -> rsp_demux:sink_data
	...
	wire  [137:0] axi_conduit_merger_0_altera_axi_slave_agent_read_rp_data;            // axi_conduit_merger_0_altera_axi_slave_agent:read_rp_data -> router_002:sink_data
	...
	wire  [137:0] router_002_src_data;                                                 // router_002:src_data -> rsp_demux_001:sink_data
	...
	wire  [137:0] router_src_data;                                                     // router:src_data -> msgdma_0_mm_read_limiter:cmd_sink_data
	...
	wire  [137:0] msgdma_0_mm_read_limiter_cmd_src_data;                               // msgdma_0_mm_read_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [137:0] rsp_mux_src_data;                                                    // rsp_mux:src_data -> msgdma_0_mm_read_limiter:rsp_sink_data
	...
	wire  [137:0] msgdma_0_mm_read_limiter_rsp_src_data;                               // msgdma_0_mm_read_limiter:rsp_src_data -> msgdma_0_mm_read_agent:rp_data
	...
	wire  [137:0] cmd_demux_src0_data;                                                 // cmd_demux:src0_data -> cmd_mux:sink0_data
	...
	wire  [137:0] cmd_demux_src1_data;                                                 // cmd_demux:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [137:0] rsp_demux_src0_data;                                                 // rsp_demux:src0_data -> rsp_mux:sink0_data
	...
	wire  [137:0] rsp_demux_001_src0_data;                                             // rsp_demux_001:src0_data -> rsp_mux:sink1_data
	...
	qsys_top_altera_merlin_master_translator_192_lykd4la #(
		...
		.uav_address            (msgdma_0_mm_read_translator_avalon_universal_master_0_address),       //  output,  width = 32, avalon_universal_master_0.address
		.uav_burstcount         (msgdma_0_mm_read_translator_avalon_universal_master_0_burstcount),    //  output,   width = 3,                          .burstcount
		.uav_read               (msgdma_0_mm_read_translator_avalon_universal_master_0_read),          //  output,   width = 1,                          .read
		.uav_write              (msgdma_0_mm_read_translator_avalon_universal_master_0_write),         //  output,   width = 1,                          .write
		.uav_waitrequest        (msgdma_0_mm_read_translator_avalon_universal_master_0_waitrequest),   //   input,   width = 1,                          .waitrequest
		.uav_readdatavalid      (msgdma_0_mm_read_translator_avalon_universal_master_0_readdatavalid), //   input,   width = 1,                          .readdatavalid
		.uav_byteenable         (msgdma_0_mm_read_translator_avalon_universal_master_0_byteenable),    //  output,   width = 4,                          .byteenable
		.uav_readdata           (msgdma_0_mm_read_translator_avalon_universal_master_0_readdata),      //   input,  width = 32,                          .readdata
		.uav_writedata          (msgdma_0_mm_read_translator_avalon_universal_master_0_writedata),     //  output,  width = 32,                          .writedata
		.uav_lock               (msgdma_0_mm_read_translator_avalon_universal_master_0_lock),          //  output,   width = 1,                          .lock
		.uav_debugaccess        (msgdma_0_mm_read_translator_avalon_universal_master_0_debugaccess),   //  output,   width = 1,                          .debugaccess
		.av_address             (msgdma_0_mm_read_address),                                            //   input,  width = 32,      avalon_anti_master_0.address
		.av_waitrequest         (msgdma_0_mm_read_waitrequest),                                        //  output,   width = 1,                          .waitrequest
		.av_byteenable          (msgdma_0_mm_read_byteenable),                                         //   input,   width = 4,                          .byteenable
		.av_read                (msgdma_0_mm_read_read),                                               //   input,   width = 1,                          .read
		.av_readdata            (msgdma_0_mm_read_readdata),                                           //  output,  width = 32,                          .readdata
		.av_readdatavalid       (msgdma_0_mm_read_readdatavalid),                                      //  output,   width = 1,                          .readdatavalid
	...
	qsys_top_altera_merlin_master_agent_1921_2inlndi #(
		...
		.av_address            (msgdma_0_mm_read_translator_avalon_universal_master_0_address),       //   input,   width = 32,        av.address
		.av_write              (msgdma_0_mm_read_translator_avalon_universal_master_0_write),         //   input,    width = 1,          .write
		.av_read               (msgdma_0_mm_read_translator_avalon_universal_master_0_read),          //   input,    width = 1,          .read
		.av_writedata          (msgdma_0_mm_read_translator_avalon_universal_master_0_writedata),     //   input,   width = 32,          .writedata
		.av_readdata           (msgdma_0_mm_read_translator_avalon_universal_master_0_readdata),      //  output,   width = 32,          .readdata
		.av_waitrequest        (msgdma_0_mm_read_translator_avalon_universal_master_0_waitrequest),   //  output,    width = 1,          .waitrequest
		.av_readdatavalid      (msgdma_0_mm_read_translator_avalon_universal_master_0_readdatavalid), //  output,    width = 1,          .readdatavalid
		.av_byteenable         (msgdma_0_mm_read_translator_avalon_universal_master_0_byteenable),    //   input,    width = 4,          .byteenable
		.av_burstcount         (msgdma_0_mm_read_translator_avalon_universal_master_0_burstcount),    //   input,    width = 3,          .burstcount
		.av_debugaccess        (msgdma_0_mm_read_translator_avalon_universal_master_0_debugaccess),   //   input,    width = 1,          .debugaccess
		.av_lock               (msgdma_0_mm_read_translator_avalon_universal_master_0_lock),          //   input,    width = 1,          .lock
		.cp_valid              (msgdma_0_mm_read_agent_cp_valid),                                     //  output,    width = 1,        cp.valid
		.cp_data               (msgdma_0_mm_read_agent_cp_data),                                      //  output,  width = 138,          .data
		.cp_startofpacket      (msgdma_0_mm_read_agent_cp_startofpacket),                             //  output,    width = 1,          .startofpacket
		.cp_endofpacket        (msgdma_0_mm_read_agent_cp_endofpacket),                               //  output,    width = 1,          .endofpacket
		.cp_ready              (msgdma_0_mm_read_agent_cp_ready),                                     //   input,    width = 1,          .ready
		.rp_valid              (msgdma_0_mm_read_limiter_rsp_src_valid),                              //   input,    width = 1,        rp.valid
		.rp_data               (msgdma_0_mm_read_limiter_rsp_src_data),                               //   input,  width = 138,          .data
		.rp_channel            (msgdma_0_mm_read_limiter_rsp_src_channel),                            //   input,    width = 2,          .channel
		.rp_startofpacket      (msgdma_0_mm_read_limiter_rsp_src_startofpacket),                      //   input,    width = 1,          .startofpacket
		.rp_endofpacket        (msgdma_0_mm_read_limiter_rsp_src_endofpacket),                        //   input,    width = 1,          .endofpacket
		.rp_ready              (msgdma_0_mm_read_limiter_rsp_src_ready),                              //  output,    width = 1,          .ready
		.av_response           (),                                                                    // (terminated),                         
		.av_writeresponsevalid ()                                                                     // (terminated),                         
	);

	qsys_top_altera_merlin_axi_slave_ni_1971_n6fpv4i #(
		.PKT_QOS_H                   (100),
		.PKT_QOS_L                   (100),
		.PKT_THREAD_ID_H             (103),
		.PKT_THREAD_ID_L             (103),
		...
		.aresetn                (~msgdma_0_reset_n_reset_bridge_in_reset_reset),                      //   input,    width = 1,        reset_sink.reset_n
		.read_cp_valid          (cmd_mux_001_src_valid),                                              //   input,    width = 1,           read_cp.valid
		.read_cp_ready          (cmd_mux_001_src_ready),                                              //  output,    width = 1,                  .ready
		.read_cp_data           (cmd_mux_001_src_data),                                               //   input,  width = 138,                  .data
		...
		.write_cp_data          (cmd_mux_src_data),                                                   //   input,  width = 138,                  .data
		...
		.read_rp_data           (axi_conduit_merger_0_altera_axi_slave_agent_read_rp_data),           //  output,  width = 138,                  .data
		...
		.write_rp_data          (axi_conduit_merger_0_altera_axi_slave_agent_write_rp_data),          //  output,  width = 138,                  .data
		...
		.awid                   (axi_conduit_merger_0_altera_axi_slave_awid),                         //  output,    width = 1, altera_axi_master.awid
		...
		.wid                    (axi_conduit_merger_0_altera_axi_slave_wid),                          //  output,    width = 1,                  .wid
		...
		.bid                    (axi_conduit_merger_0_altera_axi_slave_bid),                          //   input,    width = 1,                  .bid
		...
		.arid                   (axi_conduit_merger_0_altera_axi_slave_arid),                         //  output,    width = 1,                  .arid
		...
		.rid                    (axi_conduit_merger_0_altera_axi_slave_rid),                          //   input,    width = 1,                  .rid
	...
	qsys_top_altera_merlin_router_1921_3pcwyta router (
		.sink_ready         (msgdma_0_mm_read_agent_cp_ready),              //  output,    width = 1,      sink.ready
		.sink_valid         (msgdma_0_mm_read_agent_cp_valid),              //   input,    width = 1,          .valid
		.sink_data          (msgdma_0_mm_read_agent_cp_data),               //   input,  width = 138,          .data
		.sink_startofpacket (msgdma_0_mm_read_agent_cp_startofpacket),      //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (msgdma_0_mm_read_agent_cp_endofpacket),        //   input,    width = 1,          .endofpacket
		.clk                (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_router_1921_roc2kly router_001 (
		...
		.sink_data          (axi_conduit_merger_0_altera_axi_slave_agent_write_rp_data),          //   input,  width = 138,          .data
		...
		.src_data           (router_001_src_data),                                                //  output,  width = 138,          .data
		.src_channel        (router_001_src_channel),                                             //  output,    width = 2,          .channel
		.src_startofpacket  (router_001_src_startofpacket),                                       //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_001_src_endofpacket)                                          //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_router_1921_roc2kly router_002 (
		...
		.sink_data          (axi_conduit_merger_0_altera_axi_slave_agent_read_rp_data),          //   input,  width = 138,          .data
		...
		.src_data           (router_002_src_data),                                               //  output,  width = 138,          .data
		.src_channel        (router_002_src_channel),                                            //  output,    width = 2,          .channel
		.src_startofpacket  (router_002_src_startofpacket),                                      //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_002_src_endofpacket)                                         //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_traffic_limiter_1921_js7yfey #(
		.SYNC_RESET                           (1),
		.PKT_DEST_ID_H                        (102),
		.PKT_DEST_ID_L                        (102),
		.PKT_SRC_ID_H                         (101),
		...
		.cmd_src_ready          (msgdma_0_mm_read_limiter_cmd_src_ready),         //   input,    width = 1,   cmd_src.ready
		.cmd_src_data           (msgdma_0_mm_read_limiter_cmd_src_data),          //  output,  width = 138,          .data
		.cmd_src_channel        (msgdma_0_mm_read_limiter_cmd_src_channel),       //  output,    width = 2,          .channel
		.cmd_src_startofpacket  (msgdma_0_mm_read_limiter_cmd_src_startofpacket), //  output,    width = 1,          .startofpacket
		.cmd_src_endofpacket    (msgdma_0_mm_read_limiter_cmd_src_endofpacket),   //  output,    width = 1,          .endofpacket
		...
		.rsp_sink_data          (rsp_mux_src_data),                               //   input,  width = 138,          .data
		...
		.rsp_src_ready          (msgdma_0_mm_read_limiter_rsp_src_ready),         //   input,    width = 1,   rsp_src.ready
		.rsp_src_valid          (msgdma_0_mm_read_limiter_rsp_src_valid),         //  output,    width = 1,          .valid
		.rsp_src_data           (msgdma_0_mm_read_limiter_rsp_src_data),          //  output,  width = 138,          .data
		.rsp_src_channel        (msgdma_0_mm_read_limiter_rsp_src_channel),       //  output,    width = 2,          .channel
		.rsp_src_startofpacket  (msgdma_0_mm_read_limiter_rsp_src_startofpacket), //  output,    width = 1,          .startofpacket
		.rsp_src_endofpacket    (msgdma_0_mm_read_limiter_rsp_src_endofpacket),   //  output,    width = 1,          .endofpacket
		.cmd_src_valid          (msgdma_0_mm_read_limiter_cmd_valid_data)         //  output,    width = 2, cmd_valid.data
	);

	qsys_top_altera_merlin_demultiplexer_1921_vokj5ga cmd_demux (
		.clk                (clk_100_out_clk_clk),                            //   input,    width = 1,        clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset),   //   input,    width = 1,  clk_reset.reset
		.sink_ready         (msgdma_0_mm_read_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (msgdma_0_mm_read_limiter_cmd_src_channel),       //   input,    width = 2,           .channel
		.sink_data          (msgdma_0_mm_read_limiter_cmd_src_data),          //   input,  width = 138,           .data
		.sink_startofpacket (msgdma_0_mm_read_limiter_cmd_src_startofpacket), //   input,    width = 1,           .startofpacket
		.sink_endofpacket   (msgdma_0_mm_read_limiter_cmd_src_endofpacket),   //   input,    width = 1,           .endofpacket
		.sink_valid         (msgdma_0_mm_read_limiter_cmd_valid_data),        //   input,    width = 2, sink_valid.data
	...
	qsys_top_altera_merlin_multiplexer_1922_ta2va5i cmd_mux (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (cmd_demux_src0_data),                          //   input,  width = 138,          .data
		.sink0_startofpacket (cmd_demux_src0_startofpacket),                 //   input,    width = 1,          .startofpacket
		.sink0_endofpacket   (cmd_demux_src0_endofpacket)                    //   input,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_multiplexer_1922_ta2va5i cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (cmd_demux_src1_data),                          //   input,  width = 138,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_vhuwmza rsp_demux (
		.clk                (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_001_src_ready),                         //  output,    width = 1,      sink.ready
		.sink_channel       (router_001_src_channel),                       //   input,    width = 2,          .channel
		.sink_data          (router_001_src_data),                          //   input,  width = 138,          .data
	...
	qsys_top_altera_merlin_multiplexer_1922_oqxy4fy rsp_mux (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (rsp_demux_src0_data),                          //   input,  width = 138,          .data
		...
		.sink1_data          (rsp_demux_001_src0_data),                      //   input,  width = 138,          .data

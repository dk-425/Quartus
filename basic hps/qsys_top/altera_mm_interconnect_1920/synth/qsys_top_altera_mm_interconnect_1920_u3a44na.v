// qsys_top_altera_mm_interconnect_1920_u3a44na.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_u3a44na (
	...
	wire  [146:0] msgdma_0_csr_agent_rf_source_data;                             // msgdma_0_csr_agent:rf_source_data -> msgdma_0_csr_agent_rsp_fifo:in_data
	...
	wire  [146:0] msgdma_0_csr_agent_rsp_fifo_out_data;                          // msgdma_0_csr_agent_rsp_fifo:out_data -> msgdma_0_csr_agent:rf_sink_data
	...
	wire  [254:0] msgdma_0_descriptor_slave_agent_rf_source_data;                // msgdma_0_descriptor_slave_agent:rf_source_data -> msgdma_0_descriptor_slave_agent_rsp_fifo:in_data
	...
	wire  [254:0] msgdma_0_descriptor_slave_agent_rsp_fifo_out_data;             // msgdma_0_descriptor_slave_agent_rsp_fifo:out_data -> msgdma_0_descriptor_slave_agent:rf_sink_data
	...
	wire  [145:0] agilex_hps_h2f_axi_master_agent_write_cp_data;                 // agilex_hps_h2f_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [145:0] agilex_hps_h2f_axi_master_agent_read_cp_data;                  // agilex_hps_h2f_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [145:0] msgdma_0_csr_agent_rp_data;                                    // msgdma_0_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [253:0] msgdma_0_descriptor_slave_agent_rp_data;                       // msgdma_0_descriptor_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [145:0] onchip_memory2_0_s1_agent_rp_data;                             // onchip_memory2_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [145:0] router_004_src_data;                                           // router_004:src_data -> rsp_demux_002:sink_data
	...
	wire  [145:0] router_src_data;                                               // router:src_data -> agilex_hps_h2f_axi_master_wr_limiter:cmd_sink_data
	...
	wire  [145:0] agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data;             // agilex_hps_h2f_axi_master_wr_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [145:0] rsp_mux_src_data;                                              // rsp_mux:src_data -> agilex_hps_h2f_axi_master_wr_limiter:rsp_sink_data
	...
	wire  [145:0] agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data;             // agilex_hps_h2f_axi_master_wr_limiter:rsp_src_data -> agilex_hps_h2f_axi_master_agent:write_rp_data
	...
	wire  [145:0] router_001_src_data;                                           // router_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:cmd_sink_data
	...
	wire  [145:0] agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data;             // agilex_hps_h2f_axi_master_rd_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [145:0] rsp_mux_001_src_data;                                          // rsp_mux_001:src_data -> agilex_hps_h2f_axi_master_rd_limiter:rsp_sink_data
	...
	wire  [145:0] agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data;             // agilex_hps_h2f_axi_master_rd_limiter:rsp_src_data -> agilex_hps_h2f_axi_master_agent:read_rp_data
	...
	wire  [145:0] cmd_mux_src_data;                                              // cmd_mux:src_data -> msgdma_0_csr_burst_adapter:sink0_data
	...
	wire  [145:0] msgdma_0_csr_burst_adapter_source0_data;                       // msgdma_0_csr_burst_adapter:source0_data -> msgdma_0_csr_agent:cp_data
	...
	wire  [253:0] msgdma_0_descriptor_slave_burst_adapter_source0_data;          // msgdma_0_descriptor_slave_burst_adapter:source0_data -> msgdma_0_descriptor_slave_agent:cp_data
	...
	wire  [145:0] cmd_mux_002_src_data;                                          // cmd_mux_002:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [145:0] onchip_memory2_0_s1_burst_adapter_source0_data;                // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [145:0] cmd_demux_src1_data;                                           // cmd_demux:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [145:0] cmd_demux_src2_data;                                           // cmd_demux:src2_data -> cmd_mux_002:sink0_data
	...
	wire  [145:0] cmd_demux_001_src1_data;                                       // cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	wire  [145:0] cmd_demux_001_src2_data;                                       // cmd_demux_001:src2_data -> cmd_mux_002:sink1_data
	...
	wire  [145:0] rsp_demux_001_src0_data;                                       // rsp_demux_001:src0_data -> rsp_mux:sink1_data
	...
	wire  [145:0] rsp_demux_001_src1_data;                                       // rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	wire  [145:0] rsp_demux_002_src0_data;                                       // rsp_demux_002:src0_data -> rsp_mux:sink2_data
	...
	wire  [145:0] rsp_demux_002_src1_data;                                       // rsp_demux_002:src1_data -> rsp_mux_001:sink2_data
	...
	wire  [253:0] router_003_src_data;                                           // router_003:src_data -> msgdma_0_descriptor_slave_rsp_width_adapter:in_data
	...
	wire  [145:0] msgdma_0_descriptor_slave_rsp_width_adapter_src_data;          // msgdma_0_descriptor_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire  [145:0] cmd_mux_001_src_data;                                          // cmd_mux_001:src_data -> msgdma_0_descriptor_slave_cmd_width_adapter:in_data
	...
	wire  [253:0] msgdma_0_descriptor_slave_cmd_width_adapter_src_data;          // msgdma_0_descriptor_slave_cmd_width_adapter:out_data -> msgdma_0_descriptor_slave_burst_adapter:sink0_data
	...
	qsys_top_altera_merlin_axi_master_ni_1962_2kryw2a #(
		...
		.write_cp_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),              //  output,  width = 146,                 .data
		...
		.write_rp_data          (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data),          //   input,  width = 146,                 .data
		...
		.read_cp_data           (agilex_hps_h2f_axi_master_agent_read_cp_data),               //  output,  width = 146,                 .data
		...
		.read_rp_data           (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data),          //   input,  width = 146,                 .data
	...
	qsys_top_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (msgdma_0_csr_agent_rp_data),                       //  output,  width = 146,                .data
		...
		.cp_data                 (msgdma_0_csr_burst_adapter_source0_data),          //   input,  width = 146,                .data
		...
		.rf_sink_data            (msgdma_0_csr_agent_rsp_fifo_out_data),             //   input,  width = 147,                .data
		...
		.rf_source_data          (msgdma_0_csr_agent_rf_source_data),                //  output,  width = 147,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (msgdma_0_csr_agent_rf_source_data),                    //   input,  width = 147,        in.data
		...
		.out_data          (msgdma_0_csr_agent_rsp_fifo_out_data),                 //  output,  width = 147,       out.data
	...
	qsys_top_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (msgdma_0_descriptor_slave_agent_rp_data),                       //  output,  width = 254,                .data
		...
		.cp_data                 (msgdma_0_descriptor_slave_burst_adapter_source0_data),          //   input,  width = 254,                .data
		...
		.rf_sink_data            (msgdma_0_descriptor_slave_agent_rsp_fifo_out_data),             //   input,  width = 255,                .data
		...
		.rf_source_data          (msgdma_0_descriptor_slave_agent_rf_source_data),                //  output,  width = 255,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, clk_reset.reset
		.in_data           (msgdma_0_descriptor_slave_agent_rf_source_data),             //   input,  width = 255,        in.data
		...
		.out_data          (msgdma_0_descriptor_slave_agent_rsp_fifo_out_data),          //  output,  width = 255,       out.data
	...
	qsys_top_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                       //  output,  width = 146,                .data
		...
		.cp_data                 (onchip_memory2_0_s1_burst_adapter_source0_data),          //   input,  width = 146,                .data
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),             //   input,  width = 147,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),                //  output,  width = 147,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.clk               (clk_100_out_clk_clk),                                  //   input,    width = 1,       clk.clk
		.reset             (agilex_hps_h2f_axi_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),             //   input,  width = 147,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),          //  output,  width = 147,       out.data
	...
	qsys_top_altera_merlin_router_1921_vokcw7a router (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),          //   input,  width = 146,          .data
	...
	qsys_top_altera_merlin_router_1921_vokcw7a router_001 (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_read_cp_data),          //   input,  width = 146,          .data
	...
	qsys_top_altera_merlin_router_1921_6cyvm7a router_002 (
		...
		.sink_data          (msgdma_0_csr_agent_rp_data),                   //   input,  width = 146,          .data
		...
		.src_data           (router_002_src_data),                          //  output,  width = 146,          .data
		.src_channel        (router_002_src_channel),                       //  output,    width = 3,          .channel
		.src_startofpacket  (router_002_src_startofpacket),                 //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_002_src_endofpacket)                    //  output,    width = 1,          .endofpacket
	);

	qsys_top_altera_merlin_router_1921_ixfswma router_003 (
		...
		.sink_data          (msgdma_0_descriptor_slave_agent_rp_data),          //   input,  width = 254,          .data
		...
		.src_data           (router_003_src_data),                              //  output,  width = 254,          .data
	...
	qsys_top_altera_merlin_router_1921_6cyvm7a router_004 (
		...
		.sink_data          (onchip_memory2_0_s1_agent_rp_data),            //   input,  width = 146,          .data
		...
		.src_data           (router_004_src_data),                          //  output,  width = 146,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_1921_3arxeiq #(
		.SYNC_RESET                           (1),
		.PKT_DEST_ID_H                        (109),
		.PKT_DEST_ID_L                        (108),
		.PKT_SRC_ID_H                         (107),
		...
		.cmd_sink_data          (router_src_data),                                            //   input,  width = 146,          .data
		...
		.cmd_src_data           (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),          //  output,  width = 146,          .data
		...
		.rsp_sink_data          (rsp_mux_src_data),                                           //   input,  width = 146,          .data
		...
		.rsp_src_data           (agilex_hps_h2f_axi_master_wr_limiter_rsp_src_data),          //  output,  width = 146,          .data
	...
	qsys_top_altera_merlin_traffic_limiter_1921_3arxeiq #(
		...
		.cmd_sink_data          (router_001_src_data),                                        //   input,  width = 146,          .data
		...
		.cmd_src_data           (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),          //  output,  width = 146,          .data
		...
		.rsp_sink_data          (rsp_mux_001_src_data),                                       //   input,  width = 146,          .data
		...
		.rsp_src_data           (agilex_hps_h2f_axi_master_rd_limiter_rsp_src_data),          //  output,  width = 146,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1931_nbgl3xq #(
		.PKT_ADDR_H                (67),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (101),
		.PKT_BYTE_CNT_H            (86),
		...
		.sink0_data            (cmd_mux_src_data),                                 //   input,  width = 146,          .data
		...
		.source0_data          (msgdma_0_csr_burst_adapter_source0_data),          //  output,  width = 146,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1931_l6hsn5i #(
		.PKT_ADDR_H                (175),
		.PKT_ADDR_L                (144),
		.PKT_BEGIN_BURST           (209),
		.PKT_BYTE_CNT_H            (194),
		...
		.sink0_data            (msgdma_0_descriptor_slave_cmd_width_adapter_src_data),          //   input,  width = 254,          .data
		...
		.source0_data          (msgdma_0_descriptor_slave_burst_adapter_source0_data),          //  output,  width = 254,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1931_nbgl3xq #(
		...
		.sink0_data            (cmd_mux_002_src_data),                                    //   input,  width = 146,          .data
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),          //  output,  width = 146,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_o33udvq cmd_demux (
		.clk                (clk_100_out_clk_clk),                                        //   input,    width = 1,        clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset),               //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (agilex_hps_h2f_axi_master_wr_limiter_cmd_src_data),          //   input,  width = 146,           .data
		...
		.src1_data          (cmd_demux_src1_data),                                        //  output,  width = 146,           .data
		...
		.src2_data          (cmd_demux_src2_data),                                        //  output,  width = 146,           .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_o33udvq cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                        //   input,    width = 1,        clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset),               //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (agilex_hps_h2f_axi_master_rd_limiter_cmd_src_data),          //   input,  width = 146,           .data
		...
		.src0_data          (cmd_demux_001_src0_data),                                    //  output,  width = 146,           .data
		...
		.src1_data          (cmd_demux_001_src1_data),                                    //  output,  width = 146,           .data
		...
		.src2_data          (cmd_demux_001_src2_data),                                    //  output,  width = 146,           .data
	...
	qsys_top_altera_merlin_multiplexer_1922_6vegfhy cmd_mux (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (cmd_demux_src0_data),                          //   input,  width = 146,          .data
		...
		.sink1_data          (cmd_demux_001_src0_data),                      //   input,  width = 146,          .data
	...
	qsys_top_altera_merlin_multiplexer_1922_6vegfhy cmd_mux_001 (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_001_src_ready),                        //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_001_src_valid),                        //  output,    width = 1,          .valid
		.src_data            (cmd_mux_001_src_data),                         //  output,  width = 146,          .data
		...
		.sink0_data          (cmd_demux_src1_data),                          //   input,  width = 146,          .data
		...
		.sink1_data          (cmd_demux_001_src1_data),                      //   input,  width = 146,          .data
	...
	qsys_top_altera_merlin_multiplexer_1922_6vegfhy cmd_mux_002 (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_002_src_ready),                        //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_002_src_valid),                        //  output,    width = 1,          .valid
		.src_data            (cmd_mux_002_src_data),                         //  output,  width = 146,          .data
		...
		.sink0_data          (cmd_demux_src2_data),                          //   input,  width = 146,          .data
		...
		.sink1_data          (cmd_demux_001_src2_data),                      //   input,  width = 146,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_322hjly rsp_demux (
		...
		.src1_data          (rsp_demux_src1_data),                          //  output,  width = 146,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_322hjly rsp_demux_001 (
		.clk                (clk_100_out_clk_clk),                                           //   input,    width = 1,       clk.clk
		.reset              (msgdma_0_reset_n_reset_bridge_in_reset_reset),                  //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (msgdma_0_descriptor_slave_rsp_width_adapter_src_data),          //   input,  width = 146,          .data
		...
		.src0_data          (rsp_demux_001_src0_data),                                       //  output,  width = 146,          .data
		...
		.src1_data          (rsp_demux_001_src1_data),                                       //  output,  width = 146,          .data
	...
	qsys_top_altera_merlin_demultiplexer_1921_322hjly rsp_demux_002 (
		...
		.src0_data          (rsp_demux_002_src0_data),                      //  output,  width = 146,          .data
		...
		.src1_data          (rsp_demux_002_src1_data),                      //  output,  width = 146,          .data
	...
	qsys_top_altera_merlin_multiplexer_1922_x3npxai rsp_mux (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_data          (rsp_demux_src0_data),                          //   input,  width = 146,          .data
		...
		.sink1_data          (rsp_demux_001_src0_data),                      //   input,  width = 146,          .data
		...
		.sink2_data          (rsp_demux_002_src0_data),                      //   input,  width = 146,          .data
	...
	qsys_top_altera_merlin_multiplexer_1922_x3npxai rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset               (msgdma_0_reset_n_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_001_src_ready),                        //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_001_src_valid),                        //  output,    width = 1,          .valid
		.src_data            (rsp_mux_001_src_data),                         //  output,  width = 146,          .data
		...
		.sink0_data          (rsp_demux_src1_data),                          //   input,  width = 146,          .data
		...
		.sink1_data          (rsp_demux_001_src1_data),                      //   input,  width = 146,          .data
		...
		.sink2_data          (rsp_demux_002_src1_data),                      //   input,  width = 146,          .data
	...
	qsys_top_altera_merlin_width_adapter_1933_l5douty #(
		.IN_PKT_ADDR_H                 (175),
		.IN_PKT_ADDR_L                 (144),
		.IN_PKT_DATA_H                 (127),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (router_003_src_data),                                           //   input,  width = 254,          .data
		.out_endofpacket      (msgdma_0_descriptor_slave_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (msgdma_0_descriptor_slave_rsp_width_adapter_src_data),          //  output,  width = 146,          .data
	...
	qsys_top_altera_merlin_width_adapter_1933_kdlousi #(
		.IN_PKT_ADDR_H                 (67),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (cmd_mux_001_src_data),                                          //   input,  width = 146,          .data
		.out_endofpacket      (msgdma_0_descriptor_slave_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (msgdma_0_descriptor_slave_cmd_width_adapter_src_data),          //  output,  width = 254,          .data

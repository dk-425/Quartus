// qsys_top_altera_mm_interconnect_1920_yigfcli.v
...
`timescale 1 ps / 1 ps
module qsys_top_altera_mm_interconnect_1920_yigfcli (
	...
	wire  [141:0] rsp_mux_src_data;                                        // rsp_mux:src_data -> agilex_hps_h2f_axi_master_agent:write_rp_data
	...
	wire  [141:0] rsp_mux_001_src_data;                                    // rsp_mux_001:src_data -> agilex_hps_h2f_axi_master_agent:read_rp_data
	...
	wire  [142:0] onchip_memory2_0_s1_agent_rf_source_data;                // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [142:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;             // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire  [141:0] agilex_hps_h2f_axi_master_agent_write_cp_data;           // agilex_hps_h2f_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [141:0] agilex_hps_h2f_axi_master_agent_read_cp_data;            // agilex_hps_h2f_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [141:0] onchip_memory2_0_s1_agent_rp_data;                       // onchip_memory2_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [141:0] router_002_src_data;                                     // router_002:src_data -> rsp_demux:sink_data
	...
	wire  [141:0] cmd_mux_src_data;                                        // cmd_mux:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [141:0] onchip_memory2_0_s1_burst_adapter_source0_data;          // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	qsys_top_altera_merlin_axi_master_ni_1962_2kryw2a #(
		...
		.write_cp_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),                               //  output,  width = 142,                 .data
		...
		.read_cp_data           (agilex_hps_h2f_axi_master_agent_read_cp_data),                                //  output,  width = 142,                 .data
	...
	qsys_top_altera_merlin_slave_agent_1921_b6r3djy #(
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                                          //  output,  width = 142,                .data
		...
		.cp_data                 (onchip_memory2_0_s1_burst_adapter_source0_data),                             //   input,  width = 142,                .data
		...
		.cp_channel              (onchip_memory2_0_s1_burst_adapter_source0_channel),                          //   input,    width = 2,                .channel
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),                                //   input,  width = 143,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),                                   //  output,  width = 143,                .data
	...
	qsys_top_altera_avalon_sc_fifo_1931_vhmcgqy #(
		...
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),             //   input,  width = 143,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),          //  output,  width = 143,       out.data
	...
	qsys_top_altera_merlin_router_1921_xjikzeq router (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_write_cp_data),                              //   input,  width = 142,          .data
	...
	qsys_top_altera_merlin_router_1921_xjikzeq router_001 (
		...
		.sink_data          (agilex_hps_h2f_axi_master_agent_read_cp_data),                               //   input,  width = 142,          .data
	...
	qsys_top_altera_merlin_router_1921_4q6uyiq router_002 (
		...
		.sink_data          (onchip_memory2_0_s1_agent_rp_data),                                          //   input,  width = 142,          .data
	...
	qsys_top_altera_merlin_burst_adapter_1931_iirrl6i #(
		.PKT_ADDR_H                (67),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (99),
		.PKT_BYTE_CNT_H            (84),
		...
		.sink0_data            (cmd_mux_src_data),                                                           //   input,  width = 142,          .data
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),                             //  output,  width = 142,          .data
		.source0_channel       (onchip_memory2_0_s1_burst_adapter_source0_channel),                          //  output,    width = 2,          .channel
	...
	qsys_top_altera_merlin_demultiplexer_1921_7w2ffaa cmd_demux (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_demultiplexer_1921_7w2ffaa cmd_demux_001 (
		.clk                (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset              (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1922_m7v5tgi cmd_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1922_pvrwnty rsp_mux (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	qsys_top_altera_merlin_multiplexer_1922_pvrwnty rsp_mux_001 (
		.clk                 (clk_100_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset               (agilex_hps_h2f_axi_master_translator_clk_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
